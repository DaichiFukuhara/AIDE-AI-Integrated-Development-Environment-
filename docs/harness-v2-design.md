...
`docs/meta-design/**/index.md` は、ハーネス自身を設計した既存メタツリーである。
...
- 全体構造とスコープ: この `harness-v2-design.md`
- ハーネスのメタ設計: [meta-design/index.md](meta-design/index.md) と、その current な子
- 実行手順と成果物テンプレート: [../harness-v2/](../harness-v2/README.md)
- 過去の検討材料: [旧レーン](../archive/design-v2/lanes/)、[旧プール履歴](../archive/design-v2/pool-archive.md)、Git 履歴（非規範）
