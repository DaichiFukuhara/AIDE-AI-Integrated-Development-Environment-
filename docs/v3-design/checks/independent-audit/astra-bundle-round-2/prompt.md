...
前回Astraの監査回答4件を添付しています。修正の解消条件を満たしたか、回帰や新しい重大欠陥がないか再監査してください。README中の過去pass、自己レビュー記録を正しさの根拠にせず、実文書と契約を直接照合してください。
...
v2のcriteria/README.mdとroles/review.mdを基準に、10ノード全20文書とtree-state tree_revision 49の3system閉包・handoffを照合してください。正常・初回開始・失敗・取消・再送・再開・競合・周期監査を読んでください。
...
追加確認: changesの影響・失効・再公開、checks/correctionsの訂正入力と旧公開との関係を確認してください。旧manifestや旧監査のfail/passは歴史です。現在の10ノードとtree 49の3閉包、および訂正検査で今回の判定を行ってください。旧4件はclosed/openを明示してください。
...
<file path="docs/v3-design/changes/events/EV-ASTRA-20260922-01.md" sha256="217c7886b802dfc2a8a334a96388b13df258fcaf4ead71f59e1c95ddcd14b8df">
0001: ---
0002: event_id: EV-ASTRA-20260922-01
0003: processing: complete
0004: tree_revision: 18
0005: source: new-evidence
0006: target_nodes:
0007: - G-V3
0008: - SG-MODEL
0009: - SG-LEARN
...
0017: - id: SG-MODEL
0018:   design_revision: 3
0019: - id: SG-LEARN
0020:   design_revision: 3
0021: - id: SG-ASSURE
0022:   design_revision: 3
0023: - id: S-RECORD
0024:   design_revision: 2
0025: - id: S-CYCLE
0026:   design_revision: 2
0027: - id: S-AUDIT
0028:   design_revision: 2
0029: changed_conditions:
0030: - G4
0031: - G6
0032: - Q1
0033: - SR3
...
0043: - S-AUDIT-INPUT
0044: - S-AUDIT-RESULT
0045: proposed_change: 監査対象の版固定、周期監査の起動、取消の識別を公開契約へ補い、過去閉包の不足を訂正記録で扱う。
0046: reason: GPT-6 Astraの独立監査がmajor 4件を指摘した。
0047: evidence_ref: checks/independent-audit/astra-bundle-round-1/report.md
0048: finding_ids:
0049: - AV3-001
0050: - AV3-002
0051: - AV3-003
0052: - AV3-004
0053: next_action: 独立Astra再監査。自己レビューと設計入力の機械照合だけでは独立合格としない。
0054: resolved_tree_revision: 49
0055: ---
0056: 
0057: # Astra監査で判明した不足
0058: 
0059: これは指摘の受領記録であり、修正完了の記録ではない。各指摘はopenのまま。変更する条件・seamは影響調査の候補で、意味変更を反映済みという意味ではない。
0060: 
0061: | ID | 修正先の責任 | 解消する状態 |
0062: | --- | --- | --- |
0063: | AV3-001 | G-V3の公開契約、S-RECORD・S-CYCLE・S-AUDIT | 監査対象の仕様・実装・証拠が不変な版集合で特定でき、更新時の旧判定の利用可否が一意に決まる |
0064: | AV3-002 | G-V3の公開契約、S-CYCLE・S-RECORD・S-AUDIT | 採用・不採用・取消と中断を区別し、終了を記録する担当と周期監査を起動する担当・受渡しが明確になる |
0065: | AV3-003 | G-V3の公開契約、S-RECORD・S-CYCLE・S-AUDIT | 取消要求のIDと対象operationが区別され、遅延結果・再送・反映との前後関係の扱いが一意になる |
0066: | AV3-004 | v2検査記録。対象はSG-MODEL・SG-LEARN・SG-ASSURE | 過去manifestを変更せず、不足する入力を固定した新しい訂正検査と旧公開記録の関係を説明できる |
0067: 
0068: [監査回答原文](../../checks/independent-audit/astra-bundle-round-1/report.md) が指摘の証拠と基準IDの正本。現在の3system closureには参加側snapshotが含まれており、AV3-004は過去authoring閉包に関する不足である。
0069: 
0070: 設計の正本、意味版、immutable closureはまだ変更していない。次の実行ではv2の変更手順に従って影響集合を計算する。未処理の本イベントがある間、過去のhandoff passを理由に引渡しを進めない。
0071: 
0072: 
0073: 変更処理は完了。10ノードを親から順に再設計し、新規閉包の構造・自己意味検査で再公開した。独立Astraの判定は再監査結果で確定する。
</file>

<file path="docs/v3-design/changes/events/EV-ASTRA-20260922-02-PUBLICATION.md" sha256="7e269d15cc18399ab6f47e9ed6af00147d23d9acc2f3ec16c3afe94a28d90ca9">
0001: ---
0002: event_id: EV-ASTRA-20260922-02-PUBLICATION
0003: processing: complete
0004: tree_revision: 49
0005: source: node-publication
0006: target_nodes:
0007: - G-V3
0008: - SG-MODEL
0009: - A-MODEL
...
0017: before:
0018: - id: G-V3
0019:   design_revision: 3
0020: - id: SG-MODEL
0021:   design_revision: 3
0022: - id: A-MODEL
0023:   design_revision: 3
0024: - id: S-RECORD
0025:   design_revision: 2
0026: - id: SG-LEARN
0027:   design_revision: 3
0028: - id: A-LEARN
0029:   design_revision: 3
0030: - id: S-CYCLE
0031:   design_revision: 2
0032: - id: SG-ASSURE
0033:   design_revision: 3
0034: - id: A-ASSURE
0035:   design_revision: 3
0036: - id: S-AUDIT
0037:   design_revision: 2
0038: changed_seams:
0039: - S-CONTEXT
0040: - S-PROPOSAL
0041: - S-AUDIT-INPUT
0042: - S-AUDIT-RESULT
0043: changed_conditions:
0044: - G4
0045: - G6
0046: - Q1
0047: - SR3
...
0052: - SA2
0053: - SA5
0054: proposed_change: 10ノードの再公開差分の追加影響確認
0055: reason: 元イベントで全継承先を再設計済みか検査
0056: ---
0057: 
0058: # 公開差分の伝播
0059: 
0060: 親版・契約版2・条件割当を全子孫へ照合済み。元イベントの10ノード以外の利用側なし。追加のstale集合は空、旧閉包は履歴として失効を維持。
</file>

<file path="docs/v3-design/changes/impacts/EV-ASTRA-20260922-01.md" sha256="d05287990e8bcd5a9241fdb77729e287e159d8a9a4871db2b93cafaf1fdf8833">
0001: ---
0002: event_id: EV-ASTRA-20260922-01
0003: based_on_tree_revision: 18
0004: stale_nodes:
0005: - id: G-V3
0006:   design_revision: 3
0007:   reason: rootの監査対象・終了・取消契約の改訂。条件継承・両端・祖先統合を閉包計算した。
0008: - id: SG-MODEL
0009:   design_revision: 3
0010:   reason: rootの監査対象・終了・取消契約の改訂。条件継承・両端・祖先統合を閉包計算した。
0011: - id: A-MODEL
0012:   design_revision: 3
0013:   reason: rootの監査対象・終了・取消契約の改訂。条件継承・両端・祖先統合を閉包計算した。
0014: - id: S-RECORD
0015:   design_revision: 2
0016:   reason: rootの監査対象・終了・取消契約の改訂。条件継承・両端・祖先統合を閉包計算した。
0017: - id: SG-LEARN
0018:   design_revision: 3
0019:   reason: rootの監査対象・終了・取消契約の改訂。条件継承・両端・祖先統合を閉包計算した。
0020: - id: A-LEARN
0021:   design_revision: 3
0022:   reason: rootの監査対象・終了・取消契約の改訂。条件継承・両端・祖先統合を閉包計算した。
0023: - id: S-CYCLE
0024:   design_revision: 2
0025:   reason: rootの監査対象・終了・取消契約の改訂。条件継承・両端・祖先統合を閉包計算した。
0026: - id: SG-ASSURE
0027:   design_revision: 3
0028:   reason: rootの監査対象・終了・取消契約の改訂。条件継承・両端・祖先統合を閉包計算した。
0029: - id: A-ASSURE
0030:   design_revision: 3
0031:   reason: rootの監査対象・終了・取消契約の改訂。条件継承・両端・祖先統合を閉包計算した。
0032: - id: S-AUDIT
0033:   design_revision: 2
0034:   reason: rootの監査対象・終了・取消契約の改訂。条件継承・両端・祖先統合を閉包計算した。
0035: invalid_closures:
0036: - CL-S-RECORD-d2-t18-6e01a5cbdfd8
0037: - CL-S-CYCLE-d2-t18-b7cdb3460c3b
0038: - CL-S-AUDIT-d2-t18-c95c7c0db2f3
0039: unaffected_evidence: []
0040: ---
0041: 
0042: # 変更影響
0043: 
0044: 直接対象と3枝の子孫・契約両端・統合祖先を加え、10ノードで固定点。旧閉包の履歴は保存する。
</file>

<file path="docs/v3-design/changes/impacts/EV-ASTRA-20260922-02-PUBLICATION.md" sha256="5525e115efe8b789bd998dad30a5db34a00d581207604ca3300ee4b3a65b9a1a">
0001: ---
0002: event_id: EV-ASTRA-20260922-02-PUBLICATION
0003: based_on_tree_revision: 49
0004: stale_nodes: []
0005: invalid_closures: []
0006: unaffected_evidence:
0007: - target: G-V3
0008:   reason: 改訂済み親意味版と契約版2を参照。対応する新規検査を通過。
0009: - target: SG-MODEL
0010:   reason: 改訂済み親意味版と契約版2を参照。対応する新規検査を通過。
0011: - target: A-MODEL
0012:   reason: 改訂済み親意味版と契約版2を参照。対応する新規検査を通過。
0013: - target: S-RECORD
0014:   reason: 改訂済み親意味版と契約版2を参照。対応する新規検査を通過。
0015: - target: SG-LEARN
0016:   reason: 改訂済み親意味版と契約版2を参照。対応する新規検査を通過。
0017: - target: A-LEARN
0018:   reason: 改訂済み親意味版と契約版2を参照。対応する新規検査を通過。
0019: - target: S-CYCLE
0020:   reason: 改訂済み親意味版と契約版2を参照。対応する新規検査を通過。
0021: - target: SG-ASSURE
0022:   reason: 改訂済み親意味版と契約版2を参照。対応する新規検査を通過。
0023: - target: A-ASSURE
0024:   reason: 改訂済み親意味版と契約版2を参照。対応する新規検査を通過。
0025: - target: S-AUDIT
0026:   reason: 改訂済み親意味版と契約版2を参照。対応する新規検査を通過。
0027: ---
0028: 
0029: # 追加影響の固定点
0030: 
0031: 元イベントで必要な意味変更を全件処理し、追加の再設計対象はない。
</file>

<file path="docs/v3-design/changes/invalidations/INV-ASTRA-A-ASSURE.md" sha256="aae73ee88b00ee770c22cd0bdb02cde01cdf1e84f70054a5796291f64eb9343f">
0001: ---
0002: invalidation_id: INV-ASTRA-A-ASSURE
0003: source_event: EV-ASTRA-20260922-01
0004: based_on_tree_revision: 18
0005: stale_nodes:
0006: - id: A-ASSURE
0007:   design_revision: 3
0008: invalid_closures:
0009: - CL-S-RECORD-d2-t18-6e01a5cbdfd8
0010: - CL-S-CYCLE-d2-t18-b7cdb3460c3b
0011: - CL-S-AUDIT-d2-t18-c95c7c0db2f3
0012: next_action: stale → draft。親公開後に再設計・再検査。
0013: status: resolved
0014: replacement_design_revision: 5
0015: replacement_authoring_closure: CL-A-ASSURE-d5-t38-d90cae846f29
0016: ---
0017: 
0018: # 意味版を指定した失効
0019: 
0020: この失効は列挙した旧意味版と、それを参照する閉包を覆う。再設計した新意味版の入力は別閉包で検査する。旧版は再有効化しない。
0021: 
0022: 
0023: 新意味版の公開で再設計作業を解消。旧閉包の失効は維持する。
</file>

<file path="docs/v3-design/changes/invalidations/INV-ASTRA-A-LEARN.md" sha256="c8d2c12cb61ad3aca15783731521e22a4da648a7aa300d36b6c8ca1fc585c314">
0001: ---
0002: invalidation_id: INV-ASTRA-A-LEARN
0003: source_event: EV-ASTRA-20260922-01
0004: based_on_tree_revision: 18
0005: stale_nodes:
0006: - id: A-LEARN
...
0013: status: resolved
0014: replacement_design_revision: 5
0015: replacement_authoring_closure: CL-A-LEARN-d5-t35-79fa252445ec
0016: ---
0017: 
0018: # 意味版を指定した失効
0019: 
...
<file path="docs/v3-design/changes/invalidations/INV-ASTRA-A-MODEL.md" sha256="1def9c5b2364c0d7dd5912614cd46845c888af455ddf45def54c05fe02ffccb2">
0001: ---
0002: invalidation_id: INV-ASTRA-A-MODEL
0003: source_event: EV-ASTRA-20260922-01
0004: based_on_tree_revision: 18
0005: stale_nodes:
0006: - id: A-MODEL
...
0013: status: resolved
0014: replacement_design_revision: 5
0015: replacement_authoring_closure: CL-A-MODEL-d5-t32-802c638670d1
0016: ---
0017: 
0018: # 意味版を指定した失効
0019: 
...
<file path="docs/v3-design/changes/invalidations/INV-ASTRA-G-V3.md" sha256="59e25ae1626f14efadcdc5c7100355ad1170f5ce9fba5aeeb270ba07f4df25d3">
0001: ---
0002: invalidation_id: INV-ASTRA-G-V3
0003: source_event: EV-ASTRA-20260922-01
0004: based_on_tree_revision: 18
0005: stale_nodes:
0006: - id: G-V3
...
0012: next_action: stale → draft。親公開後に再設計・再検査。
0013: status: resolved
0014: replacement_design_revision: 4
0015: replacement_authoring_closure: CL-G-V3-d4-t20-29130abf5b62
0016: ---
0017: 
0018: # 意味版を指定した失効
0019: 
...
<file path="docs/v3-design/changes/invalidations/INV-ASTRA-S-AUDIT.md" sha256="7d9a8cba3b7ee585deb06e7a26962b4d1f5a9e221e2f50e2671888e66fce7ee5">
0001: ---
0002: invalidation_id: INV-ASTRA-S-AUDIT
0003: source_event: EV-ASTRA-20260922-01
0004: based_on_tree_revision: 18
0005: stale_nodes:
0006: - id: S-AUDIT
0007:   design_revision: 2
0008: invalid_closures:
0009: - CL-S-RECORD-d2-t18-6e01a5cbdfd8
0010: - CL-S-CYCLE-d2-t18-b7cdb3460c3b
0011: - CL-S-AUDIT-d2-t18-c95c7c0db2f3
...
0013: status: resolved
0014: replacement_design_revision: 4
0015: replacement_authoring_closure: CL-S-AUDIT-d4-t47-49843fea3a9a
0016: ---
0017: 
0018: # 意味版を指定した失効
0019: 
...
<file path="docs/v3-design/changes/invalidations/INV-ASTRA-S-CYCLE.md" sha256="0d53f8d28a80f528f87ddaa51edd6dfc0fce3ec3037f8ef3026b3c2b3465545b">
0001: ---
0002: invalidation_id: INV-ASTRA-S-CYCLE
0003: source_event: EV-ASTRA-20260922-01
0004: based_on_tree_revision: 18
0005: stale_nodes:
0006: - id: S-CYCLE
...
0013: status: resolved
0014: replacement_design_revision: 4
0015: replacement_authoring_closure: CL-S-CYCLE-d4-t44-50f46ca77b3f
0016: ---
0017: 
0018: # 意味版を指定した失効
0019: 
...
<file path="docs/v3-design/changes/invalidations/INV-ASTRA-S-RECORD.md" sha256="592789789c6dc8c125cb72c6b3fb748ad2b410c68b4c3700f53c482882dec408">
0001: ---
0002: invalidation_id: INV-ASTRA-S-RECORD
0003: source_event: EV-ASTRA-20260922-01
0004: based_on_tree_revision: 18
0005: stale_nodes:
0006: - id: S-RECORD
...
0013: status: resolved
0014: replacement_design_revision: 4
0015: replacement_authoring_closure: CL-S-RECORD-d4-t41-f26915a13939
0016: ---
0017: 
0018: # 意味版を指定した失効
0019: 
...
<file path="docs/v3-design/changes/invalidations/INV-ASTRA-SG-ASSURE.md" sha256="06d354bbc414ba48197b13563b686aa33112527e43cd9f94c73e5d0c400403af">
0001: ---
0002: invalidation_id: INV-ASTRA-SG-ASSURE
0003: source_event: EV-ASTRA-20260922-01
0004: based_on_tree_revision: 18
0005: stale_nodes:
0006: - id: SG-ASSURE
...
0013: status: resolved
0014: replacement_design_revision: 5
0015: replacement_authoring_closure: CL-SG-ASSURE-d5-t29-8778a28db93a
0016: ---
0017: 
0018: # 意味版を指定した失効
0019: 
...
<file path="docs/v3-design/changes/invalidations/INV-ASTRA-SG-LEARN.md" sha256="4ecb9633dd3f48be4114c40d7e6f39f4d9345a8da19c75993f9adbad99f2676d">
0001: ---
0002: invalidation_id: INV-ASTRA-SG-LEARN
0003: source_event: EV-ASTRA-20260922-01
0004: based_on_tree_revision: 18
0005: stale_nodes:
0006: - id: SG-LEARN
...
0013: status: resolved
0014: replacement_design_revision: 5
0015: replacement_authoring_closure: CL-SG-LEARN-d5-t26-a98c842af2a4
0016: ---
0017: 
0018: # 意味版を指定した失効
0019: 
...
<file path="docs/v3-design/changes/invalidations/INV-ASTRA-SG-MODEL.md" sha256="1ffbd590d48dda380268211af0e1de767e64385e5576941eb585bd573248044c">
0001: ---
0002: invalidation_id: INV-ASTRA-SG-MODEL
0003: source_event: EV-ASTRA-20260922-01
0004: based_on_tree_revision: 18
0005: stale_nodes:
0006: - id: SG-MODEL
...
0013: status: resolved
0014: replacement_design_revision: 5
0015: replacement_authoring_closure: CL-SG-MODEL-d5-t23-dca8e5ace808
0016: ---
0017: 
0018: # 意味版を指定した失効
0019: 
...
<file path="docs/v3-design/checks/astra-repair-verification.md" sha256="f0edc8a5d7cfc3b0b6dd702a41ce78571e7706111f531bec8556bfb89c787c80">
0001: ---
0002: result: pass
0003: tree_revision: 49
0004: checked_at: '2026-09-22T20:55:28+09:00'
0005: independent_audit: pending
0006: unchanged_historical_files: 123
0007: nodes: 10
0008: ---
0009: 
0010: # Astra指摘修正後の文書照合
0011: 
0012: 10ノードの文書対、親版、条件割当、契約版2の両端、全manifestとsnapshotのhash、現行3system閉包とhandoff、構造・自己意味検査の同一対象、未処理イベント・失効・stagedが空であることを照合した。旧closures、旧CL検査記録、過去独立監査の全バイトは修正前と一致する。
0013: 
0014: AV3-001: G-V3 §5と各systemでsubjectを固定。AV3-002: S-CYCLE → S-PROPOSAL → S-RECORD → S-AUDIT-INPUTの終了通知経路。AV3-003: 新しい取消IDとtarget_operation_id、先着取消と反映先着の分岐。AV3-004: checks/correctionsの3固定検査単位。
0015: 
0016: これは設計文書の照合であり、製品テストや独立監査の合格ではない。実装、運用効果の検証は後続工程。
</file>
...
<file path="docs/v3-design/checks/CL-A-ASSURE-d5-t38-d90cae846f29-publication.md" sha256="1613118da6e1c3e02c40d1bc4b60a6de0a18c8dcb3546b98076d94dd81907a00">
0001: ---
0002: node_id: A-ASSURE
0003: closure_id: CL-A-ASSURE-d5-t38-d90cae846f29
0004: result: published
0005: design_revision: 5
0006: checked_tree_revision: 38
0007: after_tree_revision: 39
0008: activated_children:
0009: - S-AUDIT
0010: at: '2026-09-22T20:55:15+09:00'
0011: ---
0012: 
0013: # 正本化
0014: 
...
<file path="docs/v3-design/checks/CL-A-ASSURE-d5-t38-d90cae846f29-semantic.md" sha256="ad40e27dab727a3d3c714d121c29ce3750cd584db36ab59e51f78931c26e8294">
0001: ---
0002: node_id: A-ASSURE
0003: closure_id: CL-A-ASSURE-d5-t38-d90cae846f29
0004: result: pass
0005: checked_design_revision: 5
0006: checked_parent_design_revision: 5
0007: checked_at: '2026-09-22T20:55:15+09:00'
0008: reviewer: 主担当（起草後にreview役割として確認）
0009: independence: self-review
0010: finding_ids: []
0011: ---
...
0013: # 意味検査
0014: 
0015: 改訂レビュー: G-V3 §5の不変subject、サイクル終了からperiodicへの永続受渡し、取消IDとtombstoneを、当該ノードの責任・親条件・契約両端へ照合した。仕様不変でも実装Bは新subjectとなり、旧Aの合格は受理されない。daily-pass反映後のcycle_closedは反映後差分を含む。取消先着は旧要求を止め、反映先着はalready-appliedとなる。parent版の更新を継承し、内部保存方式だけを委任する。AV3-004は別の訂正単位と現行閉包の参加入力を確認した。これらは設計上の経路照合であり製品テストではない。独立Astraの確認は別工程で実施する。
0016: 
0017: | 観点 | 確認したこと |
0018: | --- | --- |
0019: | 1 目的適合 | §1・9の成果が親の条件を具体化し、役割そのものを目標にしていない。 |
...
<file path="docs/v3-design/checks/CL-A-ASSURE-d5-t38-d90cae846f29-structural.md" sha256="e4c56f80e5afcf71c51401f94dcda3d58513948fe27d2bf0cea435241248b76e">
0001: ---
0002: node_id: A-ASSURE
0003: closure_id: CL-A-ASSURE-d5-t38-d90cae846f29
0004: result: pass
0005: checked_design_revision: 5
0006: checked_parent_design_revision: 5
0007: checked_at: '2026-09-22T20:55:14+09:00'
0008: finding_ids: []
0009: ---
0010: 
0011: # 構造検査
...
0032: | F-01 | pass | 形式・版・配置・正本・親子条件・契約参照と本文の必須節を検査。意味の妥当性はreviewで確認する。 |
0033: | F-02 | precondition-pass | 公開前の同一版再読とstaged childの一括active化はpublish時に再確認する。 |
0034: | F-03 | pass | EV-ASTRA-20260922-01の影響集合、旧意味版の失効、新規閉包と親からの改訂を照合。 |
0035: | G | pass | 形式・版・配置・正本・親子条件・契約参照と本文の必須節を検査。意味の妥当性はreviewで確認する。 |
0036: 
0037: 実行者: 主担当の文書検査補助処理。製品テストではない。
</file>
...
<file path="docs/v3-design/checks/CL-A-LEARN-d5-t35-79fa252445ec-publication.md" sha256="246618ae24601701fba09bfe337939f61c01b37505acfb3de3f123e1ccaebb50">
0001: ---
0002: node_id: A-LEARN
0003: closure_id: CL-A-LEARN-d5-t35-79fa252445ec
0004: result: published
0005: design_revision: 5
0006: checked_tree_revision: 35
0007: after_tree_revision: 36
0008: activated_children:
0009: - S-CYCLE
0010: at: '2026-09-22T20:55:13+09:00'
0011: ---
0012: 
0013: # 正本化
0014: 
...
<file path="docs/v3-design/checks/CL-A-LEARN-d5-t35-79fa252445ec-semantic.md" sha256="d77b0479d1cc1331c0b5ea37ea441db507fc114bc40b7d4e0586272e1df72eae">
0001: ---
0002: node_id: A-LEARN
0003: closure_id: CL-A-LEARN-d5-t35-79fa252445ec
0004: result: pass
0005: checked_design_revision: 5
0006: checked_parent_design_revision: 5
0007: checked_at: '2026-09-22T20:55:12+09:00'
0008: reviewer: 主担当（起草後にreview役割として確認）
0009: independence: self-review
0010: finding_ids: []
0011: ---
...
<file path="docs/v3-design/checks/CL-A-LEARN-d5-t35-79fa252445ec-structural.md" sha256="ac307b429c98dfbd83f9bfdf3a3d01ab9baed892b574caabd919b24d2795ab91">
0001: ---
0002: node_id: A-LEARN
0003: closure_id: CL-A-LEARN-d5-t35-79fa252445ec
0004: result: pass
...
<file path="docs/v3-design/checks/CL-A-MODEL-d5-t32-802c638670d1-publication.md" sha256="81833eb96954a9535f2b100d6ad520492383640d9ffc6b878073b852b4830fb2">
0001: ---
0002: node_id: A-MODEL
0003: closure_id: CL-A-MODEL-d5-t32-802c638670d1
0004: result: published
0005: design_revision: 5
0006: checked_tree_revision: 32
0007: after_tree_revision: 33
0008: activated_children:
0009: - S-RECORD
0010: at: '2026-09-22T20:55:11+09:00'
0011: ---
0012: 
0013: # 正本化
0014: 
...
<file path="docs/v3-design/checks/CL-A-MODEL-d5-t32-802c638670d1-semantic.md" sha256="81dd822dc4e7ea6397f322053e691ca9fed81896a630a68020987af863d5314f">
0001: ---
0002: node_id: A-MODEL
0003: closure_id: CL-A-MODEL-d5-t32-802c638670d1
0004: result: pass
0005: checked_design_revision: 5
0006: checked_parent_design_revision: 5
0007: checked_at: '2026-09-22T20:55:11+09:00'
0008: reviewer: 主担当（起草後にreview役割として確認）
0009: independence: self-review
0010: finding_ids: []
0011: ---
...
<file path="docs/v3-design/checks/CL-A-MODEL-d5-t32-802c638670d1-structural.md" sha256="73b7f6e4bf3e728dae90141704d24c18b2207324daa6723f7097c757a69fc776">
0001: ---
0002: node_id: A-MODEL
0003: closure_id: CL-A-MODEL-d5-t32-802c638670d1
0004: result: pass
0005: checked_design_revision: 5
0006: checked_parent_design_revision: 5
0007: checked_at: '2026-09-22T20:55:10+09:00'
0008: finding_ids: []
0009: ---
0010: 
0011: # 構造検査
...
<file path="docs/v3-design/checks/CL-G-V3-d4-t20-29130abf5b62-publication.md" sha256="863dcd53afdbe3787bbd6aabbdce408ec1310e0c5630ebac6cf13d4c98b3f5d4">
0001: ---
0002: node_id: G-V3
0003: closure_id: CL-G-V3-d4-t20-29130abf5b62
0004: result: published
0005: design_revision: 4
0006: checked_tree_revision: 20
0007: after_tree_revision: 21
0008: activated_children:
0009: - SG-MODEL
0010: - SG-LEARN
0011: - SG-ASSURE
0012: at: '2026-09-22T20:55:02+09:00'
0013: ---
0014: 
0015: # 正本化
0016: 
...
<file path="docs/v3-design/checks/CL-G-V3-d4-t20-29130abf5b62-semantic.md" sha256="4cd2d14ef08aeef236be423f37086b31c83e5882e0ae82d2f26149221d8979ad">
0001: ---
0002: node_id: G-V3
0003: closure_id: CL-G-V3-d4-t20-29130abf5b62
0004: result: pass
0005: checked_design_revision: 4
0006: checked_parent_design_revision: null
0007: checked_at: '2026-09-22T20:55:02+09:00'
0008: reviewer: 主担当（起草後にreview役割として確認）
0009: independence: self-review
0010: finding_ids: []
0011: ---
...
<file path="docs/v3-design/checks/CL-G-V3-d4-t20-29130abf5b62-structural.md" sha256="a46e9b2307a3f3a8a45def6762d8bec22ff0fde7a7701e0c3d0c1ca8a0c2de67">
0001: ---
0002: node_id: G-V3
0003: closure_id: CL-G-V3-d4-t20-29130abf5b62
0004: result: pass
0005: checked_design_revision: 4
0006: checked_parent_design_revision: null
0007: checked_at: '2026-09-22T20:55:01+09:00'
0008: finding_ids: []
0009: ---
0010: 
0011: # 構造検査
...
<file path="docs/v3-design/checks/CL-S-AUDIT-d4-t47-49843fea3a9a-publication.md" sha256="ee35bb9a4e8a77a5ac555ca146e1fd4bf1c8000bb2000daff9eba20cc75ef71b">
0001: ---
0002: node_id: S-AUDIT
0003: closure_id: CL-S-AUDIT-d4-t47-49843fea3a9a
0004: result: published
0005: design_revision: 4
0006: checked_tree_revision: 47
0007: after_tree_revision: 48
0008: activated_children: []
0009: at: '2026-09-22T20:55:21+09:00'
0010: ---
0011: 
0012: # 正本化
0013: 
...
<file path="docs/v3-design/checks/CL-S-AUDIT-d4-t47-49843fea3a9a-semantic.md" sha256="83d2baa1eb2cdde0b8d760d7b9c2a00151ebf1e377d2450f3209b422b1f05299">
0001: ---
0002: node_id: S-AUDIT
0003: closure_id: CL-S-AUDIT-d4-t47-49843fea3a9a
0004: result: pass
0005: checked_design_revision: 4
0006: checked_parent_design_revision: 5
0007: checked_at: '2026-09-22T20:55:21+09:00'
0008: reviewer: 主担当（起草後にreview役割として確認）
0009: independence: self-review
0010: finding_ids: []
0011: ---
...
<file path="docs/v3-design/checks/CL-S-AUDIT-d4-t47-49843fea3a9a-structural.md" sha256="296616c00f296bf8d3c17c138803522b0e72dd3eee91d898afbe119b1fea3f53">
0001: ---
0002: node_id: S-AUDIT
0003: closure_id: CL-S-AUDIT-d4-t47-49843fea3a9a
0004: result: pass
...
<file path="docs/v3-design/checks/CL-S-CYCLE-d4-t44-50f46ca77b3f-publication.md" sha256="b3cd29e0da0ce478df3a3cb5f4521e1f80d647b165c61fd8d788f53b4446b241">
0001: ---
0002: node_id: S-CYCLE
0003: closure_id: CL-S-CYCLE-d4-t44-50f46ca77b3f
0004: result: published
0005: design_revision: 4
0006: checked_tree_revision: 44
0007: after_tree_revision: 45
0008: activated_children: []
0009: at: '2026-09-22T20:55:19+09:00'
0010: ---
0011: 
0012: # 正本化
0013: 
...
<file path="docs/v3-design/checks/CL-S-CYCLE-d4-t44-50f46ca77b3f-semantic.md" sha256="e68ccc3a6fef8c4c0ed28fe4a7e403ffb15b2131bbb49a658d8d8ff9e58c299b">
0001: ---
0002: node_id: S-CYCLE
0003: closure_id: CL-S-CYCLE-d4-t44-50f46ca77b3f
0004: result: pass
0005: checked_design_revision: 4
0006: checked_parent_design_revision: 5
0007: checked_at: '2026-09-22T20:55:19+09:00'
0008: reviewer: 主担当（起草後にreview役割として確認）
0009: independence: self-review
0010: finding_ids: []
0011: ---
...
<file path="docs/v3-design/checks/CL-S-CYCLE-d4-t44-50f46ca77b3f-structural.md" sha256="5b5fa93101ca361d339586760ff9a8cb71cfa987ea2f9399d9022dd9ae347da8">
0001: ---
0002: node_id: S-CYCLE
0003: closure_id: CL-S-CYCLE-d4-t44-50f46ca77b3f
0004: result: pass
0005: checked_design_revision: 4
0006: checked_parent_design_revision: 5
0007: checked_at: '2026-09-22T20:55:18+09:00'
0008: finding_ids: []
0009: ---
0010: 
0011: # 構造検査
...
<file path="docs/v3-design/checks/CL-S-RECORD-d4-t41-f26915a13939-publication.md" sha256="cbe1ac75c64454f19bb0a207af191ca457cdebfd85426377a0f554c5f97cb5b2">
0001: ---
0002: node_id: S-RECORD
0003: closure_id: CL-S-RECORD-d4-t41-f26915a13939
0004: result: published
0005: design_revision: 4
0006: checked_tree_revision: 41
0007: after_tree_revision: 42
0008: activated_children: []
0009: at: '2026-09-22T20:55:17+09:00'
0010: ---
0011: 
0012: # 正本化
0013: 
...
<file path="docs/v3-design/checks/CL-S-RECORD-d4-t41-f26915a13939-semantic.md" sha256="71dba381a0b09b6aebbd885e7365328956a5e8285c3df59b49f582b0ee2be17f">
0001: ---
0002: node_id: S-RECORD
0003: closure_id: CL-S-RECORD-d4-t41-f26915a13939
0004: result: pass
0005: checked_design_revision: 4
0006: checked_parent_design_revision: 5
0007: checked_at: '2026-09-22T20:55:16+09:00'
0008: reviewer: 主担当（起草後にreview役割として確認）
0009: independence: self-review
0010: finding_ids: []
0011: ---
...
<file path="docs/v3-design/checks/CL-S-RECORD-d4-t41-f26915a13939-structural.md" sha256="35fe33daa9cb8ccc39d319a5ccd76db172949d5a07bf1395d311a8c93d98258e">
0001: ---
0002: node_id: S-RECORD
0003: closure_id: CL-S-RECORD-d4-t41-f26915a13939
0004: result: pass
...
<file path="docs/v3-design/checks/CL-SG-ASSURE-d5-t29-8778a28db93a-publication.md" sha256="fa13d63688938855f447af46b39b6c491308dc77cfe1e8db85e8dfdffa7779dc">
0001: ---
0002: node_id: SG-ASSURE
0003: closure_id: CL-SG-ASSURE-d5-t29-8778a28db93a
0004: result: published
0005: design_revision: 5
0006: checked_tree_revision: 29
0007: after_tree_revision: 30
0008: activated_children:
0009: - A-ASSURE
0010: at: '2026-09-22T20:55:08+09:00'
0011: ---
0012: 
0013: # 正本化
0014: 
...
<file path="docs/v3-design/checks/CL-SG-ASSURE-d5-t29-8778a28db93a-semantic.md" sha256="4899cbc91f69379ad5b4ebd642677eb7dbf64eed149d6c5ba784d0d027c1c040">
0001: ---
0002: node_id: SG-ASSURE
0003: closure_id: CL-SG-ASSURE-d5-t29-8778a28db93a
0004: result: pass
0005: checked_design_revision: 5
0006: checked_parent_design_revision: 4
0007: checked_at: '2026-09-22T20:55:08+09:00'
0008: reviewer: 主担当（起草後にreview役割として確認）
0009: independence: self-review
0010: finding_ids: []
0011: ---
...
<file path="docs/v3-design/checks/CL-SG-ASSURE-d5-t29-8778a28db93a-structural.md" sha256="8711cfa66bae189193819ff972b78100f0484dcd7928e6d6f3cc8adf5e3f4c49">
0001: ---
0002: node_id: SG-ASSURE
0003: closure_id: CL-SG-ASSURE-d5-t29-8778a28db93a
0004: result: pass
...
<file path="docs/v3-design/checks/CL-SG-LEARN-d5-t26-a98c842af2a4-publication.md" sha256="d49d53c62e0023704bb996b7c0096dc3a20f9bd188bc33048019f6a5a7db5a6d">
0001: ---
0002: node_id: SG-LEARN
0003: closure_id: CL-SG-LEARN-d5-t26-a98c842af2a4
0004: result: published
0005: design_revision: 5
0006: checked_tree_revision: 26
0007: after_tree_revision: 27
0008: activated_children:
0009: - A-LEARN
0010: at: '2026-09-22T20:55:06+09:00'
0011: ---
0012: 
0013: # 正本化
0014: 
...
<file path="docs/v3-design/checks/CL-SG-LEARN-d5-t26-a98c842af2a4-semantic.md" sha256="f20ab073a1e48d6a87300f0cd25711ed6fe2506d97a2b36b012f11b2f717d695">
0001: ---
0002: node_id: SG-LEARN
0003: closure_id: CL-SG-LEARN-d5-t26-a98c842af2a4
0004: result: pass
0005: checked_design_revision: 5
0006: checked_parent_design_revision: 4
0007: checked_at: '2026-09-22T20:55:06+09:00'
0008: reviewer: 主担当（起草後にreview役割として確認）
0009: independence: self-review
0010: finding_ids: []
0011: ---
...
<file path="docs/v3-design/checks/CL-SG-LEARN-d5-t26-a98c842af2a4-structural.md" sha256="baf5e970a4acfd812c44ccd183b829837d73b148f49ed21ca36cb5d85962cf49">
0001: ---
0002: node_id: SG-LEARN
0003: closure_id: CL-SG-LEARN-d5-t26-a98c842af2a4
0004: result: pass
...
<file path="docs/v3-design/checks/CL-SG-MODEL-d5-t23-dca8e5ace808-publication.md" sha256="9cb7fec83ed4a78b2aaf3a2807c75593931183d9ee676e00741733d5e7f9129a">
0001: ---
0002: node_id: SG-MODEL
0003: closure_id: CL-SG-MODEL-d5-t23-dca8e5ace808
0004: result: published
0005: design_revision: 5
0006: checked_tree_revision: 23
0007: after_tree_revision: 24
0008: activated_children:
0009: - A-MODEL
0010: at: '2026-09-22T20:55:05+09:00'
0011: ---
0012: 
0013: # 正本化
0014: 
...
<file path="docs/v3-design/checks/CL-SG-MODEL-d5-t23-dca8e5ace808-semantic.md" sha256="b81446503d985470e72f9e4ddb0fe5e4948a8959ee7397d3c2a0b972734067cb">
0001: ---
0002: node_id: SG-MODEL
0003: closure_id: CL-SG-MODEL-d5-t23-dca8e5ace808
0004: result: pass
0005: checked_design_revision: 5
0006: checked_parent_design_revision: 4
0007: checked_at: '2026-09-22T20:55:04+09:00'
0008: reviewer: 主担当（起草後にreview役割として確認）
0009: independence: self-review
0010: finding_ids: []
0011: ---
...
<file path="docs/v3-design/checks/CL-SG-MODEL-d5-t23-dca8e5ace808-structural.md" sha256="3c323e0ca503668daf89276f30f2273d5eab6ea831fffb983bd44b0f04153da3">
0001: ---
0002: node_id: SG-MODEL
0003: closure_id: CL-SG-MODEL-d5-t23-dca8e5ace808
0004: result: pass
0005: checked_design_revision: 5
0006: checked_parent_design_revision: 4
0007: checked_at: '2026-09-22T20:55:03+09:00'
0008: finding_ids: []
0009: ---
0010: 
0011: # 構造検査
...
<file path="docs/v3-design/checks/corrections/CORR-CL-SG-ASSURE-d3-t8-36f75939e7a4-67cdd94537a5.md" sha256="eac5dd96fb20fbb1a186099ce83dc4eb2e29e5099916b789e74d379d229fbb94">
0001: ---
0002: correction_id: CORR-CL-SG-ASSURE-d3-t8-36f75939e7a4-67cdd94537a5
0003: unit_digest: 67cdd94537a527b90ea67cea7654caf414042e6c9a01326f855cbbf13ac96bf4
0004: kind: retrospective-correction
0005: source_finding: AV3-004
0006: original_closure_id: CL-SG-ASSURE-d3-t8-36f75939e7a4
0007: original_manifest_digest: 36f75939e7a491891967da2af4a357892094a8e866baf2568a9168d6b5fe184a
0008: original_publication_path: checks/CL-SG-ASSURE-d3-t8-36f75939e7a4-publication.md
0009: root_authoring_closure_id: CL-G-V3-d3-t2-84ada73f2f64
0010: root_manifest_digest: 84ada73f2f645bec526687152a08388f168887780ed43434f1f62e3a47c90c98
0011: seam_participants:
0012: - node_id: SG-MODEL
0013:   semantic_digest: 95f331c96c749a5666c8ebd38ce0fa43826d7eb0fa77d759de9f816edae56ea6
0014:   snapshot_path: closures/inputs/SI-95f331c96c749a5666c8ebd38ce0fa43826d7eb0fa77d759de9f816edae56ea6.md
0015:   derived_from:
0016:     path: root/subgoals/sg-model/design.md
0017:     node_id: SG-MODEL
0018:     design_revision: 1
0019:     semantic_digest: 15ea7073aba45d99ce7bdb52c9e8c51ef4bc0a6ae3a850e56bb3697f725a111e
0020:     snapshot_path: closures/inputs/SI-15ea7073aba45d99ce7bdb52c9e8c51ef4bc0a6ae3a850e56bb3697f725a111e.md
0021: - node_id: SG-LEARN
0022:   semantic_digest: c9972bbfe6141c31704c7b8d4f11c7c480cd80bac9a482b31771a62b6c6f273d
0023:   snapshot_path: closures/inputs/SI-c9972bbfe6141c31704c7b8d4f11c7c480cd80bac9a482b31771a62b6c6f273d.md
0024:   derived_from:
0025:     path: root/subgoals/sg-learn/design.md
0026:     node_id: SG-LEARN
0027:     design_revision: 1
0028:     semantic_digest: 9329b098d0a27ecaf35915293b445f310a9d84fd41786d5682c01c1847a36fe2
0029:     snapshot_path: closures/inputs/SI-9329b098d0a27ecaf35915293b445f310a9d84fd41786d5682c01c1847a36fe2.md
0030: - node_id: SG-ASSURE
0031:   semantic_digest: 23272ef84f1717229ef95d93dd9c6ae36436a44be9e912c12ee549299d3a07a3
0032:   snapshot_path: closures/inputs/SI-23272ef84f1717229ef95d93dd9c6ae36436a44be9e912c12ee549299d3a07a3.md
0033:   derived_from:
0034:     path: root/subgoals/sg-assure/design.md
0035:     node_id: SG-ASSURE
0036:     design_revision: 1
0037:     semantic_digest: 1788417ff75137bc0b684eeaa5921bb3046a96c231038e10806c45fa905c4a1a
0038:     snapshot_path: closures/inputs/SI-1788417ff75137bc0b684eeaa5921bb3046a96c231038e10806c45fa905c4a1a.md
0039: files:
0040: - path: root/design.md
0041:   node_id: G-V3
0042:   design_revision: 3
0043:   semantic_digest: 8965df0a0a828a4ab3de9cfe53e1320df96bd970f7f030704873e586cb089e15
0044:   snapshot_path: closures/inputs/SI-8965df0a0a828a4ab3de9cfe53e1320df96bd970f7f030704873e586cb089e15.md
0045: - path: root/rationale.md
0046:   node_id: G-V3
0047:   design_revision: 3
0048:   semantic_digest: beac8b62e15dee389d4945dd4a2b7ce715a9aa7849a623f54a141063d3eadc20
0049:   snapshot_path: closures/inputs/SI-beac8b62e15dee389d4945dd4a2b7ce715a9aa7849a623f54a141063d3eadc20.md
0050: - path: root/subgoals/sg-assure/design.md
0051:   node_id: SG-ASSURE
0052:   design_revision: 3
0053:   semantic_digest: 2e7080e8d5c5eb3f9755bd4a8ca4532324b87d407f2a16ad2503c4d60d2fa618
0054:   snapshot_path: closures/inputs/SI-2e7080e8d5c5eb3f9755bd4a8ca4532324b87d407f2a16ad2503c4d60d2fa618.md
0055: - path: root/subgoals/sg-assure/rationale.md
0056:   node_id: SG-ASSURE
0057:   design_revision: 3
0058:   semantic_digest: da276749252459a7d5cf9d7a03f59d4182380fc2438c9c9d0fccbb2432ceb375
0059:   snapshot_path: closures/inputs/SI-da276749252459a7d5cf9d7a03f59d4182380fc2438c9c9d0fccbb2432ceb375.md
0060: - path: root/subgoals/sg-assure/approaches/a-assure/design.md
0061:   node_id: A-ASSURE
0062:   design_revision: 1
0063:   semantic_digest: 47d416067df5d50c721729090ac1a177a4c913bb2138ebd59e34761498019c4d
0064:   snapshot_path: closures/inputs/SI-47d416067df5d50c721729090ac1a177a4c913bb2138ebd59e34761498019c4d.md
0065: - path: root/subgoals/sg-assure/approaches/a-assure/rationale.md
0066:   node_id: A-ASSURE
0067:   design_revision: 1
0068:   semantic_digest: 7228a0a6f5e8d05e458c8cedfee89900eba671c86b4cf73fcf81d9018db830e7
0069:   snapshot_path: closures/inputs/SI-7228a0a6f5e8d05e458c8cedfee89900eba671c86b4cf73fcf81d9018db830e7.md
0070: seams:
0071: - id: S-CONTEXT
0072:   owner: G-V3
0073:   revision: 1
...
0079: - id: S-AUDIT-INPUT
0080:   owner: G-V3
0081:   revision: 1
0082:   canonical_path: root/design.md
0083: - id: S-AUDIT-RESULT
0084:   owner: G-V3
0085:   revision: 1
0086:   canonical_path: root/design.md
0087: sources:
...
0091: ---
0092: 
0093: # 過去の公開入力に対する訂正検査
0094: 
0095: 検査日: 2026-09-22T20:54:59+09:00
0096: 
0097: 結果: 今回固定した合成入力で4契約のowner・revision 1・producer/consumer参照は一致する。元の公開記録との関係はoriginal_publication_path、元の閉包と不足入力の出所は上記の固定ID/hashを参照。
0098: 
0099: 限界: 元の3subgoal閉包は参加側入力を含まず不完全だった。別のroot authoring閉包で保存された当時のstubと当該subgoalの保存入力を今回組み合わせて再検査した。当時の監査者が実際に両端を読んだことや、各公開時刻の未保存の通常状態を証明するものではない。旧manifest・旧pass記録を完全だったと再認定しない。現行版の公開・引渡しは別の新規閉包で再検査する。
</file>

<file path="docs/v3-design/checks/corrections/CORR-CL-SG-LEARN-d3-t6-0710d62352da-4ad8e2167f2b.md" sha256="9b8bd0ceabdccfd11b9b0365c0db78c798a21768f222949161627d2120d865b0">
0001: ---
0002: correction_id: CORR-CL-SG-LEARN-d3-t6-0710d62352da-4ad8e2167f2b
0003: unit_digest: 4ad8e2167f2b0f1e07fbbb19df3e09b34d18330e1802aebbc2df257b010cc0a2
0004: kind: retrospective-correction
0005: source_finding: AV3-004
0006: original_closure_id: CL-SG-LEARN-d3-t6-0710d62352da
0007: original_manifest_digest: 0710d62352daec59eabda26f43632d5a5300a3596be10bc25731680d46761c07
0008: original_publication_path: checks/CL-SG-LEARN-d3-t6-0710d62352da-publication.md
0009: root_authoring_closure_id: CL-G-V3-d3-t2-84ada73f2f64
0010: root_manifest_digest: 84ada73f2f645bec526687152a08388f168887780ed43434f1f62e3a47c90c98
0011: seam_participants:
0012: - node_id: SG-MODEL
...
0048:   semantic_digest: beac8b62e15dee389d4945dd4a2b7ce715a9aa7849a623f54a141063d3eadc20
0049:   snapshot_path: closures/inputs/SI-beac8b62e15dee389d4945dd4a2b7ce715a9aa7849a623f54a141063d3eadc20.md
0050: - path: root/subgoals/sg-learn/design.md
0051:   node_id: SG-LEARN
0052:   design_revision: 3
0053:   semantic_digest: 8f941c9de750bbb7a95ec138aefdab5cb82fffec16a20b0a486262ec20da1c9d
0054:   snapshot_path: closures/inputs/SI-8f941c9de750bbb7a95ec138aefdab5cb82fffec16a20b0a486262ec20da1c9d.md
0055: - path: root/subgoals/sg-learn/rationale.md
0056:   node_id: SG-LEARN
0057:   design_revision: 3
0058:   semantic_digest: e768e0cb505d1c3f430c80a2b017e5dacf7844dd76a8910b5e060b380a69c475
0059:   snapshot_path: closures/inputs/SI-e768e0cb505d1c3f430c80a2b017e5dacf7844dd76a8910b5e060b380a69c475.md
0060: - path: root/subgoals/sg-learn/approaches/a-learn/design.md
0061:   node_id: A-LEARN
0062:   design_revision: 1
0063:   semantic_digest: 6f864fe094dcd1510b6a966b5b8a6cefefc14463bc973cfdddcd79a7ffe5cfbd
0064:   snapshot_path: closures/inputs/SI-6f864fe094dcd1510b6a966b5b8a6cefefc14463bc973cfdddcd79a7ffe5cfbd.md
0065: - path: root/subgoals/sg-learn/approaches/a-learn/rationale.md
0066:   node_id: A-LEARN
0067:   design_revision: 1
0068:   semantic_digest: e51299cadb2660c4acbbd251e449c4c5d2e7b635bda3f80d4d8122eb676f9611
0069:   snapshot_path: closures/inputs/SI-e51299cadb2660c4acbbd251e449c4c5d2e7b635bda3f80d4d8122eb676f9611.md
0070: seams:
0071: - id: S-CONTEXT
0072:   owner: G-V3
0073:   revision: 1
...
<file path="docs/v3-design/checks/corrections/CORR-CL-SG-MODEL-d3-t4-25d6868dd8cc-45f8ce6e70e0.md" sha256="832c067718a7c623eb91ce7656343765ea5aaaa5ed62c9e4afb206e44b91850f">
0001: ---
0002: correction_id: CORR-CL-SG-MODEL-d3-t4-25d6868dd8cc-45f8ce6e70e0
0003: unit_digest: 45f8ce6e70e0d168e176f37087b0b74be72de6189616aff5a39aa5c5a6aa246c
0004: kind: retrospective-correction
0005: source_finding: AV3-004
0006: original_closure_id: CL-SG-MODEL-d3-t4-25d6868dd8cc
0007: original_manifest_digest: 25d6868dd8cc20a3252f952ae777ef7f54348ccd4c5bce8129aa781235ffafce
0008: original_publication_path: checks/CL-SG-MODEL-d3-t4-25d6868dd8cc-publication.md
0009: root_authoring_closure_id: CL-G-V3-d3-t2-84ada73f2f64
0010: root_manifest_digest: 84ada73f2f645bec526687152a08388f168887780ed43434f1f62e3a47c90c98
0011: seam_participants:
0012: - node_id: SG-MODEL
...
0048:   semantic_digest: beac8b62e15dee389d4945dd4a2b7ce715a9aa7849a623f54a141063d3eadc20
0049:   snapshot_path: closures/inputs/SI-beac8b62e15dee389d4945dd4a2b7ce715a9aa7849a623f54a141063d3eadc20.md
0050: - path: root/subgoals/sg-model/design.md
0051:   node_id: SG-MODEL
0052:   design_revision: 3
0053:   semantic_digest: 5a6852f67d39372aaeeac5622982c256c9ba6ed40dd6e971d221564d324fa0f5
0054:   snapshot_path: closures/inputs/SI-5a6852f67d39372aaeeac5622982c256c9ba6ed40dd6e971d221564d324fa0f5.md
0055: - path: root/subgoals/sg-model/rationale.md
0056:   node_id: SG-MODEL
0057:   design_revision: 3
0058:   semantic_digest: 1368ac924bc61bb529ee52dfdb15a050f609351faf496375323e14ac71446865
0059:   snapshot_path: closures/inputs/SI-1368ac924bc61bb529ee52dfdb15a050f609351faf496375323e14ac71446865.md
0060: - path: root/subgoals/sg-model/approaches/a-model/design.md
0061:   node_id: A-MODEL
0062:   design_revision: 1
0063:   semantic_digest: 45d7a19053e9ed62f3949269bd1965698ea264248253356c56b3abf36627d0c8
0064:   snapshot_path: closures/inputs/SI-45d7a19053e9ed62f3949269bd1965698ea264248253356c56b3abf36627d0c8.md
0065: - path: root/subgoals/sg-model/approaches/a-model/rationale.md
0066:   node_id: A-MODEL
0067:   design_revision: 1
0068:   semantic_digest: c52f10067500a1e3142756876ac58356b91212df712eee373da8778039d07748
0069:   snapshot_path: closures/inputs/SI-c52f10067500a1e3142756876ac58356b91212df712eee373da8778039d07748.md
0070: seams:
0071: - id: S-CONTEXT
0072:   owner: G-V3
0073:   revision: 1
...
<file path="docs/v3-design/checks/corrections/README.md" sha256="6929d996532c7bf7984213334f35bdc254aac2df86b65ec46b2ba004dbc6e00c">
0001: # AV3-004 訂正検査
0002: 
0003: 旧3subgoalの検査入力が不完全だったことを明記し、root authoring時の保存済み参加側入力を固定した新しい検査単位を作った。旧manifest・公開・pass記録は上書きしない。今回の合成入力から両端の版と役割は確認できるが、当時の監査者が実際に読んだことは証明できない。
0004: 
0005: - [CORR-CL-SG-ASSURE-d3-t8-36f75939e7a4-67cdd94537a5](CORR-CL-SG-ASSURE-d3-t8-36f75939e7a4-67cdd94537a5.md)
0006: - [CORR-CL-SG-LEARN-d3-t6-0710d62352da-4ad8e2167f2b](CORR-CL-SG-LEARN-d3-t6-0710d62352da-4ad8e2167f2b.md)
0007: - [CORR-CL-SG-MODEL-d3-t4-25d6868dd8cc-45f8ce6e70e0](CORR-CL-SG-MODEL-d3-t4-25d6868dd8cc-45f8ce6e70e0.md)
0008: 
0009: unit_digestはcorrection_idとunit_digest自身を除いたfrontmatterの規約化SHA-256。参照元manifestはIDと完全hash、参加側情報はsnapshotと完全hashで固定した。
</file>
...
<file path="docs/v3-design/checks/README.md" sha256="4f9be5b70be1a8df7f15fef29abfd0ec6ee0a38d6ee5861032474a6fb5f36af9">
0001: # 検査記録の読み方
0002: 
...
0010: - [completion.md](completion.md): tree 18に対する初回の設計完了検査（履歴）。
0011: - [astra-repair-verification.md](astra-repair-verification.md): tree 49の修正後の文書照合。独立再監査は別記録。
0012: - [final-verification.md](final-verification.md): 保存後のファイル、参照、ハッシュの最終照合。
0013: - [input-provenance.md](input-provenance.md): 参照したv2規約と既存資料のファイルハッシュ。
0014: - [independent-audit/README.md](independent-audit/README.md): 最新のCodex CLI / GPT-6 Astra監査はtree revision 18に対してfail、major 4件。GPT-5.5のpassは過去の判定として保持する。
0015: 
0016: 役割ごとの処理は逐次実行した。今回の補助処理で並行書込みや故障注入の動作を試験したという意味ではない。
0017: 
0018: ## immutable closureと意味ハッシュ
0019: 
0020: closureは、どの入力を検査したかを再構成するための固定記録である。ファイルの通常revision、status、検査結果の追記では意味ハッシュを変えない。
0021: 
0022: 規約化は、JSONのキーを辞書順、空白区切りなし、UnicodeをエスケープせずUTF-8にしたバイト列のSHA-256とする。配列順は保存順を維持する。文字列内容はUnicode正規化しない。
0023: 
0024: ノード文書は次のオブジェクトへ規約化する。
0025: 
0026: 1. YAML frontmatterから `id, kind, title, parent, depth, design_revision, parent_revision, children, depends_on, owned_seams, seam_refs, source_refs, unit_test_id, subgoal_integration_id, final_integration_id` の存在する項目をmetadataへ取り出す。
0027: 2. 本文の改行をLFに統一し、前後の空白を除く。rationaleでは `## 7. finding`、`## 8. 検査結果`、`## 10. 現在の作業状態` の見出しから次のレベル2見出し直前までを除外する。各節を除く際、直後のレベル2見出しの手前の改行は保持する。
0028: 3. `metadata` と `body` の2項目から意味ハッシュを算出する。
0029: 
0030: 入力根拠はLFの本文全体を `text` に格納する。seam参加側の公開情報は `id` と `seam_refs` だけを固定し、兄弟の内部設計を引渡しへ取り込まない。
0031: 
0032: snapshotは `closures/inputs/SI-<完全なハッシュ>.md` 内のJSONオブジェクトとして保存する。既存snapshotは上書きせず、同じ内容は同じファイルを参照する。snapshotは検査対象の保存物で、更新する仕様の正本ではない。
0033: 
0034: manifestはYAMLをオブジェクトへ読み込み、`closure_id` と `manifest_digest` の2項目だけを除いて規約化する。IDの末尾12桁がmanifestのハッシュ先頭12桁と一致することを照合する。
0035: 
0036: ## 照合の順序
0037: 
0038: 1. manifestの完全ハッシュとIDを照合する。
0039: 2. files / sources / seam_participantsから参照したsnapshotを読み、各意味ハッシュとファイル名を照合する。
0040: 3. 現在の引渡しでは、現行文書を同じ方法で規約化し、snapshotとの一致を確認する。
0041: 4. tree-stateが指す3件について、全体版、対象systemの意味版、目標チェーン、契約両端、受入条件、3種類の将来検証ID、handoff passを照合する。
0042: 5. 文書対の版、親版、条件割当、正本owner、候補・未処理変更の有無を照合する。
0043: 
0044: 初期のroot authoring manifestにはstaged childの公開参照があるが、初期3subgoalのauthoring manifestはそれを明示的に固定しておらず不完全だった（AV3-004）。[訂正検査](corrections/README.md)で旧入力を合成して再確認した。当時の検査実施を遡って証明するものではない。新規authoringと現行systemのmanifestには `seam_participants` を直接含める。現在の契約版は2で、旧版1の記録を上書きしていない。
0045: 
0046: 過去のauthoring closureのtree版やstaged childは公開当時の状態である。現在の子の本文と一致させるために過去snapshotを更新してはならない。現在の意味が変わる場合はv2の変更手順で影響先を再検査する。
0047: 
0048: ## 起草時に解消した曖昧さ
0049: 
0050: - plan確認とadoption反映を分け、試作仮説が現在仕様へ先に入ることを防いだ。
0051: - plan確認に未実装部分のテスト成功を要求しないことを明示した。
0052: - domain/contextの記録を4階層の追加階層と区別し、systemの主親の保存項目を一つにした。
0053: - 反映前の取消と反映済み仕様の変更を区別した。
0054: - 正式監査と日常の自己点検の独立性を明記した。
0055: 
0056: これらは各対象ノードの検査版を固定する前の起草で反映した。公開後の仕様を無検査で書き換えたものではない。
</file>
...
<file path="docs/v3-design/closures/handoffs/CL-S-AUDIT-d4-t48-767d441a53a1.md" sha256="10ac3869728cd79bde97d5a46561a9224c917159688db36bffd53e0bdb82245d">
0001: ---
0002: handoff_id: HO-CL-S-AUDIT-d4-t48-767d441a53a1
0003: closure_id: CL-S-AUDIT-d4-t48-767d441a53a1
0004: result: pass
0005: checked_system_design_revision: 4
0006: checked_tree_revision: 48
0007: finding_ids: []
0008: checked_at: '2026-09-22T20:55:22+09:00'
0009: ---
0010: 
0011: # 引渡し検査
0012: 
...
<file path="docs/v3-design/closures/handoffs/CL-S-AUDIT-d4-t49-9fc049759e19.md" sha256="8b92e9f79028f4c426659d9b3607110a5a5ed609ba403bbf59bc09b5838ff070">
0001: ---
0002: handoff_id: HO-CL-S-AUDIT-d4-t49-9fc049759e19
0003: closure_id: CL-S-AUDIT-d4-t49-9fc049759e19
0004: result: pass
0005: checked_system_design_revision: 4
0006: checked_tree_revision: 49
0007: finding_ids: []
0008: checked_at: '2026-09-22T20:55:23+09:00'
0009: ---
0010: 
0011: # 引渡し検査
0012: 
...
<file path="docs/v3-design/closures/handoffs/CL-S-CYCLE-d4-t45-8395894f3ce4.md" sha256="12bbe1559420577b550ac38a03ee0270888ccddf1f8205b91c4c98edc88c251f">
0001: ---
0002: handoff_id: HO-CL-S-CYCLE-d4-t45-8395894f3ce4
0003: closure_id: CL-S-CYCLE-d4-t45-8395894f3ce4
0004: result: pass
0005: checked_system_design_revision: 4
0006: checked_tree_revision: 45
0007: finding_ids: []
0008: checked_at: '2026-09-22T20:55:19+09:00'
0009: ---
0010: 
0011: # 引渡し検査
0012: 
...
<file path="docs/v3-design/closures/handoffs/CL-S-CYCLE-d4-t49-9d46a3ae144b.md" sha256="373470cc2cb13d22ba813c11f204a6972b06e9df4ac24933543a1dc9deb55b72">
0001: ---
0002: handoff_id: HO-CL-S-CYCLE-d4-t49-9d46a3ae144b
0003: closure_id: CL-S-CYCLE-d4-t49-9d46a3ae144b
0004: result: pass
0005: checked_system_design_revision: 4
0006: checked_tree_revision: 49
0007: finding_ids: []
...
<file path="docs/v3-design/closures/handoffs/CL-S-RECORD-d4-t42-b9c06d70cb12.md" sha256="8a7c22a75c66655e46788eb7b92ac38a62005fd57233a2b24203b7f0fb89f137">
0001: ---
0002: handoff_id: HO-CL-S-RECORD-d4-t42-b9c06d70cb12
0003: closure_id: CL-S-RECORD-d4-t42-b9c06d70cb12
0004: result: pass
0005: checked_system_design_revision: 4
0006: checked_tree_revision: 42
0007: finding_ids: []
0008: checked_at: '2026-09-22T20:55:18+09:00'
0009: ---
0010: 
0011: # 引渡し検査
0012: 
...
<file path="docs/v3-design/closures/handoffs/CL-S-RECORD-d4-t49-c65a3a86187d.md" sha256="3e41fe4cd2e369f254715297a0cf6f12d35a41551c29f9fd7e7a025a20f9e2bf">
0001: ---
0002: handoff_id: HO-CL-S-RECORD-d4-t49-c65a3a86187d
0003: closure_id: CL-S-RECORD-d4-t49-c65a3a86187d
0004: result: pass
0005: checked_system_design_revision: 4
0006: checked_tree_revision: 49
0007: finding_ids: []
...
0074:     "depends_on": [],
0075:     "depth": 0,
0076:     "design_revision": 4,
0077:     "final_integration_id": "FIT-G-V3",
0078:     "id": "G-V3",
0079:     "kind": "root_goal",
0080:     "owned_seams": [
0081:       {
0082:         "contract": "要求operation_idと対象goal/systemに対しbundle_id、spec意味版と契約版集合、委任、subjectとscope/phase別audit_baseline、未監査差分、進行判定を返す。proposal/withdrawal/cycle_closedの結果は要求IDで照合し、対象ID・現在の確定状態・反映bundleまたはperiodic要求ID/skip理由を返す。取得は読取り専用。",
...
<file path="docs/v3-design/closures/inputs/SI-0d9270dced4babfff3d616238f00fabcdff8fc1dd70750fb7d5d8eecd6e65744.md" sha256="f780a864997858c83441731657a8fde989c1c68c62df96c389a746906dc51064">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
0008:     "depends_on": [],
0009:     "depth": 2,
0010:     "design_revision": 4,
0011:     "final_integration_id": "FIT-G-V3",
0012:     "id": "A-ASSURE",
0013:     "kind": "approach",
0014:     "owned_seams": [],
0015:     "parent": "SG-ASSURE",
0016:     "parent_revision": 5,
0017:     "seam_refs": [],
0018:     "source_refs": [
0019:       "sources/requirements.md"
0020:     ],
...
<file path="docs/v3-design/closures/inputs/SI-12d76a11670d50ead29a3d1dc0adce7246d2b3dbe6a8ddb2cc3bd723d1e64699.md" sha256="af729cefa1e22625bac5b2fd751c09a13f0ce8e58a4c2578d09a76a899056b3b">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-1466928b6716f1ec969584ae03cb68910896ca802e4476e7ac5ada8a80b86319.md" sha256="584b7736bb66e41b66bb37878dbd19a99538a827c16ffc98e10e90f5ed45696b">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-1b060eb91aaa23b0511dabd23c7a69491c378c44d48d3de81c5bff3b264bfc62.md" sha256="05fc7d682b48ae3f527b4db56c5d7939ee22bf2cf3107bcbf3e2ec69b78fd241">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-24df4ae2d1d896a9b1140b87c13d455b160156c2f03eb32bacd1a3ce587edfbc.md" sha256="e319144391477748d430f60fc1b32bb14cd9ababf14b2be763bbea37f84b971f">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-26adf79ec41667c96f4ac931f0d1b815e2c382692890f080a442ec8884d97554.md" sha256="e7627c96db5d161e3d5fcef99c7d989cc3a2a11cc605f1f2384f0089be5557f4">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
0031:     "depends_on": [],
0032:     "depth": 2,
0033:     "design_revision": 5,
0034:     "final_integration_id": "FIT-G-V3",
0035:     "id": "A-ASSURE",
0036:     "kind": "approach",
0037:     "owned_seams": [],
0038:     "parent": "SG-ASSURE",
0039:     "parent_revision": 5,
0040:     "seam_refs": [],
0041:     "source_refs": [
0042:       "sources/requirements.md"
0043:     ],
...
<file path="docs/v3-design/closures/inputs/SI-2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7.md" sha256="e66283901e1e33837ccc0c807d9be720c343ec07ce4d76089c28fec3786752fd">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-2e61df4f4c27e00372aab20ddb44c5e78acea6f4df84c2a762c6e608538eb811.md" sha256="9d6e78fb9e428859c751e6f2f9d84ff3a5682110c57df51b94072fd161001344">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-34fb99868ab2b79189846d7cecfe68ba372be047f807ee5f36de50e162ec9cb5.md" sha256="18a880ba1e0ab3125d0665d0fee03f1b854a5dff8cc21646fdea92a38c1e6c67">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-38c073777200e159167e149cf203d15f3be61474e18f53a7a6023d79861d68e4.md" sha256="791e472db2e1511d321757ade120435769a56b57a960af2c67346de88cd579bd">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-45b5d0e158f03d26e47bb7bbc1640185453c5989e9c373ba3303020e74d40bd5.md" sha256="9d137a7d8f0e14450b918cf7ec120a4b962e512c64ec9dc651dab0666c1490c1">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-4c93e23c8c9a918615b0961dfbaaa806ec64eea8c490efd167ad33affd4e9087.md" sha256="5f3b8e73af0d50758eb8360444f6b350ac319cc51283cb4561a3919427aeffbb">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-53d52fc7158e44c2f7df4f6ba9c68391f88d5030a660ef0bcdfb9e3d7c144ed2.md" sha256="63c6bc32a3c10e751254aee8cd5448b22b8f208070a0b323b78e52060a9208ff">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
0032:     "depends_on": [],
0033:     "depth": 1,
0034:     "design_revision": 5,
0035:     "final_integration_id": "FIT-G-V3",
0036:     "id": "SG-ASSURE",
0037:     "kind": "subgoal",
0038:     "owned_seams": [],
0039:     "parent": "G-V3",
0040:     "parent_revision": 4,
0041:     "seam_refs": [
0042:       {
0043:         "id": "S-AUDIT-INPUT",
0044:         "owner": "G-V3",
...
<file path="docs/v3-design/closures/inputs/SI-54fcd157afc7fabe1b435b015b9fef2b70f8d68a28209a17814d66167ea31fa2.md" sha256="5e37eb463a24d028acc98c6d16c0de3a85275afa0bd3a126030b5c5b5b913236">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-622d0d59c04e9f49ec7998cb6bb480e27f1d901868d68110313a60fcee37f9b4.md" sha256="42cefbc2b8d025369f8ae9d84c7d0e9cccb0ffa2aee9db2f34239c50fa95a88e">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-62deb641d31b6d9c863f11472fa8823a1ea6f8a005a0693b33966d6e6a6ea40f.md" sha256="173c2ee913848989a6ccb55eb80004bff83add63d949547172ca3820ddce3174">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-632e0a18b128b8cfeca70718be4dca8c03795ab525459d01fb85b7824f3d724c.md" sha256="631eff51cb4ab1b4ea31825615b4e69380cc8317ba9bed733c64f2951552e209">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-6451a2bb6992073c7a1d087c3b955b1d5d96db4f9056d1e0ab03fe9b7124feda.md" sha256="c9ae85c3c753f23c17de15785f871d486fa264159bc6d0c2ed5ed353a5187dae">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-65f0c9f20af7b546d5853c2e69144475d597b58733519dbc0c310c73f71c343f.md" sha256="8fc70138d3abe097da787d7ba7cd0a8d81cdfcb551cfd92e2df2dabec9543469">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-66444a6e7861118592400f40e22b683782e66fa97e882dfb2b25bac3c42de372.md" sha256="c8683ef0ee9aaf627f07eb0d15d2e6b8c223608708dc300f8dca8da04616a429">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-6902bcb5f2c4bffb85f8811edbb7a19e5ad96807566dd22488b8e7ce5d0febf3.md" sha256="495156a0d528467afb16e12c354cabf9f275c116f7f825895d5766b766334099">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-69a4c8cf7b1fd17f9580f3c906076fa4941b353a27c0f819db26ae8614a41ac6.md" sha256="cda2ecdfa29c1903e304fbfdf5c59623fefc755370714a90245cc3bc442f285a">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410.md" sha256="9e005e7b6259de6bea094558c1f42d63d802d67d9fe697631eaa045fdb3fb7ba">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-70269c69f98ade1f7d70b65015775d59974b78dba9a7591242dc5935320e5708.md" sha256="e191067e980463ba050a41dfc2a2c281a3e038bb5fe11f0cae50239360c5b536">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-7a14d20be98a6fb874866021d32d5230bb327c921444703c353e2ada3df110db.md" sha256="b5464f1a3606c224842c8fcebbd3db5a89e9b05160c22a29382488ae92af9b45">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-832b850dc4f05c512825d05c2d2c4411bd77ba2b26930c9c6f2989b32584b833.md" sha256="bcd50f7fc5d2621da813171b80d39ed31aad77c85373f0300a88ab842ccae538">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-85cc84b97d79a1c6f3031af77866ed46b98715cea1b7d4a63a89dd71a3a75afb.md" sha256="d1f3a3f2f0d32e8e5932f49ff0ac975a78c0b354dc14e2066a0b4ec301c2e0d7">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-91a4301b582727a3d638371b82a86f805648e8db5f25ab05ad8f519d51bd60c1.md" sha256="187f26d745708c466d1b854fac9c47b1367a2247a28a83f44c1b9942204ad1b1">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-92a73a3e0296584e56a768fa126a2059d41bf4d040dd1e944cccafd725ba89f6.md" sha256="b26e2ad36c344cf4a1c93b3a913afaa2b6846f6fd62a0b15a9ce16fdb135a02a">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-9addcb28218d3d4c244d0f3da0fa8c471ee7a937537e72884bb78769a37875fa.md" sha256="bd90df4ad927e02cb29e25d15b6c6276bd9a5774721c31f4425316b87e30939e">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-a10bad434f158ae0bf8172676b3e6cea089198115a81d642c8936ebe25595b6e.md" sha256="ac813038472e5e9070497ec3f115cb53832a1fbf345bdbb877af2c5bda201c6e">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-a4cc50e710716cb0d103c486658d9878fdc15e643348e8ea9ebcf43efdf99e2e.md" sha256="e0ca7a931a1ca48193b7716eb478edc2bb2126be2c0a38acb4e65b28b1b0896c">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-ae4041fe12f7f36df1fd7a38612c4a79de569eab5d8e040baac097ee8c757a18.md" sha256="46127bed29a3a116d1e25ff180f78a9feb76da47f225c883d1c9edd6d63ecf3a">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c.md" sha256="456c5c2ce8d39fafa7f12fd39d2a9519c9cd86b08309b6453ef5ff18227f6d78">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-b992eadfbdd4994b143cdbd3e77389b71824356a692af3f1e4dcdb7a2a63a9c9.md" sha256="f5f3cb7e2ca643db3d36fc977389999dd865652b44c3cf982a19548aef20e12b">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-cb82d9a38bcd59478b18785f7c4b749a46b5490a3858c2bf3b4ddef21e727e69.md" sha256="e6a4884ae7c1ce86f5b17466732b6f94047123e6794621be6442d744a6ffe1de">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-cc9b58628bcd49086646f9957243a0ef465cb8eb3a186a4c68fd3e9b8740db8e.md" sha256="ab216188adea14a2b0bd3fd9612ceb93f2cc9dc18bee7ae4f5b3f65ff0f6b4b9">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac.md" sha256="aaee8c36c6586a17281ceafe260a2452689f2cb09efa1f7f68db0186c98d052c">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-f39f7e60835bdddee20900e793e0ccd8a619e7a6dc775de823aa33b877887878.md" sha256="83e5d20776182d6bea4741d228084cd2880a53fa46706864262f67ff8e033f74">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/inputs/SI-f6fce35306b9e978e1d30003ff637d8a14ab99f21ed745ebc8dd807a69599c4f.md" sha256="18a3b83018014892f047b6a22c55ec480c92208286e2218667e6743449035380">
0001: # Immutable semantic input
0002: 
0003: ```json
0004: {
...
<file path="docs/v3-design/closures/manifests/CL-A-ASSURE-d5-t38-d90cae846f29.md" sha256="79d20d1f0a4aa88b6e8d11c5a24a0de42c36750e81c509ab8e28341903f58d51">
0001: ---
0002: closure_id: CL-A-ASSURE-d5-t38-d90cae846f29
0003: manifest_digest: d90cae846f298c9ca60a1009f335fc81f3d423444d6b3c96f736277ea37af010
0004: closure_kind: authoring
0005: based_on_tree_revision: 38
0006: target:
0007:   id: A-ASSURE
0008:   design_revision: 5
0009:   parent_design_revision: 5
0010: goal_chain:
0011:   root_goal: G-V3
0012:   subgoal: SG-ASSURE
0013:   approach: A-ASSURE
...
0049: - path: root/design.md
0050:   node_id: G-V3
0051:   design_revision: 4
0052:   semantic_digest: 02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd
0053:   snapshot_path: closures/inputs/SI-02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd.md
0054: - path: root/rationale.md
0055:   node_id: G-V3
0056:   design_revision: 4
0057:   semantic_digest: b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c
0058:   snapshot_path: closures/inputs/SI-b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c.md
0059: - path: root/subgoals/sg-assure/design.md
0060:   node_id: SG-ASSURE
0061:   design_revision: 5
0062:   semantic_digest: 65f0c9f20af7b546d5853c2e69144475d597b58733519dbc0c310c73f71c343f
0063:   snapshot_path: closures/inputs/SI-65f0c9f20af7b546d5853c2e69144475d597b58733519dbc0c310c73f71c343f.md
0064: - path: root/subgoals/sg-assure/rationale.md
0065:   node_id: SG-ASSURE
0066:   design_revision: 5
0067:   semantic_digest: 53d52fc7158e44c2f7df4f6ba9c68391f88d5030a660ef0bcdfb9e3d7c144ed2
0068:   snapshot_path: closures/inputs/SI-53d52fc7158e44c2f7df4f6ba9c68391f88d5030a660ef0bcdfb9e3d7c144ed2.md
0069: - path: root/subgoals/sg-assure/approaches/a-assure/design.md
0070:   node_id: A-ASSURE
0071:   design_revision: 5
0072:   semantic_digest: 9addcb28218d3d4c244d0f3da0fa8c471ee7a937537e72884bb78769a37875fa
0073:   snapshot_path: closures/inputs/SI-9addcb28218d3d4c244d0f3da0fa8c471ee7a937537e72884bb78769a37875fa.md
0074: - path: root/subgoals/sg-assure/approaches/a-assure/rationale.md
0075:   node_id: A-ASSURE
0076:   design_revision: 5
0077:   semantic_digest: 26adf79ec41667c96f4ac931f0d1b815e2c382692890f080a442ec8884d97554
0078:   snapshot_path: closures/inputs/SI-26adf79ec41667c96f4ac931f0d1b815e2c382692890f080a442ec8884d97554.md
0079: - path: root/subgoals/sg-assure/approaches/a-assure/systems/s-audit/design.md
0080:   node_id: S-AUDIT
0081:   design_revision: 3
0082:   semantic_digest: 12d76a11670d50ead29a3d1dc0adce7246d2b3dbe6a8ddb2cc3bd723d1e64699
0083:   snapshot_path: closures/inputs/SI-12d76a11670d50ead29a3d1dc0adce7246d2b3dbe6a8ddb2cc3bd723d1e64699.md
0084: - path: root/subgoals/sg-assure/approaches/a-assure/systems/s-audit/rationale.md
0085:   node_id: S-AUDIT
0086:   design_revision: 3
0087:   semantic_digest: 6451a2bb6992073c7a1d087c3b955b1d5d96db4f9056d1e0ab03fe9b7124feda
0088:   snapshot_path: closures/inputs/SI-6451a2bb6992073c7a1d087c3b955b1d5d96db4f9056d1e0ab03fe9b7124feda.md
0089: dependencies: []
0090: seams:
0091: - id: S-CONTEXT
0092:   owner: G-V3
...
0117:   snapshot_path: closures/inputs/SI-e0cb261c6d94faf15f113363cee173fe21c265ee71971fc05394e3b3e78af3c8.md
0118: active_invalidations:
0119: - INV-ASTRA-S-RECORD
0120: - INV-ASTRA-S-CYCLE
0121: - INV-ASTRA-A-ASSURE
0122: - INV-ASTRA-S-AUDIT
0123: staged_children:
0124: - parent_id: A-ASSURE
0125:   candidate_ref: A-ASSURE-decomposition-2
0126:   child_ids:
0127:   - S-AUDIT
0128: seam_participants:
0129: - node_id: SG-ASSURE
0130:   canonical_path: root/subgoals/sg-assure/design.md
0131:   semantic_digest: 6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410
0132:   snapshot_path: closures/inputs/SI-6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410.md
0133: - node_id: SG-LEARN
0134:   canonical_path: root/subgoals/sg-learn/design.md
0135:   semantic_digest: 2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7
0136:   snapshot_path: closures/inputs/SI-2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7.md
0137: - node_id: SG-MODEL
0138:   canonical_path: root/subgoals/sg-model/design.md
0139:   semantic_digest: ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac
0140:   snapshot_path: closures/inputs/SI-ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac.md
0141: ---
0142: 
0143: # 固定した設計入力
0144: 
0145: 意味snapshotはfilesとsourcesから参照する。正規化はREADMEの記載に従う。結果は別記録に保存する。
</file>
...
<file path="docs/v3-design/closures/manifests/CL-A-LEARN-d5-t35-79fa252445ec.md" sha256="5762ad0764914f1d827e52c53666055d22a52722ff2b96dc8c11311b70ab1d2f">
0001: ---
0002: closure_id: CL-A-LEARN-d5-t35-79fa252445ec
0003: manifest_digest: 79fa252445ec8839ad070c92ce7432c8bf00d8ced8e42a5ac815302a1634d9c6
0004: closure_kind: authoring
0005: based_on_tree_revision: 35
0006: target:
0007:   id: A-LEARN
0008:   design_revision: 5
0009:   parent_design_revision: 5
...
0048: - path: root/design.md
0049:   node_id: G-V3
0050:   design_revision: 4
0051:   semantic_digest: 02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd
0052:   snapshot_path: closures/inputs/SI-02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd.md
0053: - path: root/rationale.md
0054:   node_id: G-V3
0055:   design_revision: 4
0056:   semantic_digest: b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c
0057:   snapshot_path: closures/inputs/SI-b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c.md
0058: - path: root/subgoals/sg-learn/design.md
0059:   node_id: SG-LEARN
0060:   design_revision: 5
0061:   semantic_digest: a4cc50e710716cb0d103c486658d9878fdc15e643348e8ea9ebcf43efdf99e2e
0062:   snapshot_path: closures/inputs/SI-a4cc50e710716cb0d103c486658d9878fdc15e643348e8ea9ebcf43efdf99e2e.md
0063: - path: root/subgoals/sg-learn/rationale.md
0064:   node_id: SG-LEARN
0065:   design_revision: 5
0066:   semantic_digest: ae4041fe12f7f36df1fd7a38612c4a79de569eab5d8e040baac097ee8c757a18
0067:   snapshot_path: closures/inputs/SI-ae4041fe12f7f36df1fd7a38612c4a79de569eab5d8e040baac097ee8c757a18.md
0068: - path: root/subgoals/sg-learn/approaches/a-learn/design.md
0069:   node_id: A-LEARN
0070:   design_revision: 5
0071:   semantic_digest: cc9b58628bcd49086646f9957243a0ef465cb8eb3a186a4c68fd3e9b8740db8e
0072:   snapshot_path: closures/inputs/SI-cc9b58628bcd49086646f9957243a0ef465cb8eb3a186a4c68fd3e9b8740db8e.md
0073: - path: root/subgoals/sg-learn/approaches/a-learn/rationale.md
0074:   node_id: A-LEARN
0075:   design_revision: 5
0076:   semantic_digest: b992eadfbdd4994b143cdbd3e77389b71824356a692af3f1e4dcdb7a2a63a9c9
0077:   snapshot_path: closures/inputs/SI-b992eadfbdd4994b143cdbd3e77389b71824356a692af3f1e4dcdb7a2a63a9c9.md
0078: - path: root/subgoals/sg-learn/approaches/a-learn/systems/s-cycle/design.md
0079:   node_id: S-CYCLE
0080:   design_revision: 3
0081:   semantic_digest: 69a4c8cf7b1fd17f9580f3c906076fa4941b353a27c0f819db26ae8614a41ac6
0082:   snapshot_path: closures/inputs/SI-69a4c8cf7b1fd17f9580f3c906076fa4941b353a27c0f819db26ae8614a41ac6.md
0083: - path: root/subgoals/sg-learn/approaches/a-learn/systems/s-cycle/rationale.md
0084:   node_id: S-CYCLE
0085:   design_revision: 3
0086:   semantic_digest: 832b850dc4f05c512825d05c2d2c4411bd77ba2b26930c9c6f2989b32584b833
0087:   snapshot_path: closures/inputs/SI-832b850dc4f05c512825d05c2d2c4411bd77ba2b26930c9c6f2989b32584b833.md
0088: dependencies: []
0089: seams:
0090: - id: S-CONTEXT
0091:   owner: G-V3
...
0116:   snapshot_path: closures/inputs/SI-e0cb261c6d94faf15f113363cee173fe21c265ee71971fc05394e3b3e78af3c8.md
0117: active_invalidations:
0118: - INV-ASTRA-S-RECORD
0119: - INV-ASTRA-A-LEARN
0120: - INV-ASTRA-S-CYCLE
0121: - INV-ASTRA-A-ASSURE
0122: - INV-ASTRA-S-AUDIT
0123: staged_children:
0124: - parent_id: A-LEARN
0125:   candidate_ref: A-LEARN-decomposition-2
0126:   child_ids:
0127:   - S-CYCLE
0128: seam_participants:
0129: - node_id: SG-ASSURE
...
<file path="docs/v3-design/closures/manifests/CL-A-MODEL-d5-t32-802c638670d1.md" sha256="dd84d73fda957df53016e6afd7f0bd6f7028a79602b612e12ea7513415d2285b">
0001: ---
0002: closure_id: CL-A-MODEL-d5-t32-802c638670d1
0003: manifest_digest: 802c638670d15887d86fc0831fa482b49f8919e14e2c2eb8817ef10d3a606387
0004: closure_kind: authoring
0005: based_on_tree_revision: 32
0006: target:
0007:   id: A-MODEL
0008:   design_revision: 5
0009:   parent_design_revision: 5
...
0060:   node_id: SG-MODEL
0061:   design_revision: 5
0062:   semantic_digest: 6902bcb5f2c4bffb85f8811edbb7a19e5ad96807566dd22488b8e7ce5d0febf3
0063:   snapshot_path: closures/inputs/SI-6902bcb5f2c4bffb85f8811edbb7a19e5ad96807566dd22488b8e7ce5d0febf3.md
0064: - path: root/subgoals/sg-model/rationale.md
0065:   node_id: SG-MODEL
0066:   design_revision: 5
0067:   semantic_digest: 54fcd157afc7fabe1b435b015b9fef2b70f8d68a28209a17814d66167ea31fa2
0068:   snapshot_path: closures/inputs/SI-54fcd157afc7fabe1b435b015b9fef2b70f8d68a28209a17814d66167ea31fa2.md
0069: - path: root/subgoals/sg-model/approaches/a-model/design.md
0070:   node_id: A-MODEL
0071:   design_revision: 5
0072:   semantic_digest: 91a4301b582727a3d638371b82a86f805648e8db5f25ab05ad8f519d51bd60c1
0073:   snapshot_path: closures/inputs/SI-91a4301b582727a3d638371b82a86f805648e8db5f25ab05ad8f519d51bd60c1.md
0074: - path: root/subgoals/sg-model/approaches/a-model/rationale.md
0075:   node_id: A-MODEL
0076:   design_revision: 5
0077:   semantic_digest: f39f7e60835bdddee20900e793e0ccd8a619e7a6dc775de823aa33b877887878
0078:   snapshot_path: closures/inputs/SI-f39f7e60835bdddee20900e793e0ccd8a619e7a6dc775de823aa33b877887878.md
0079: - path: root/subgoals/sg-model/approaches/a-model/systems/s-record/design.md
0080:   node_id: S-RECORD
0081:   design_revision: 3
0082:   semantic_digest: 24df4ae2d1d896a9b1140b87c13d455b160156c2f03eb32bacd1a3ce587edfbc
0083:   snapshot_path: closures/inputs/SI-24df4ae2d1d896a9b1140b87c13d455b160156c2f03eb32bacd1a3ce587edfbc.md
0084: - path: root/subgoals/sg-model/approaches/a-model/systems/s-record/rationale.md
0085:   node_id: S-RECORD
0086:   design_revision: 3
0087:   semantic_digest: 70269c69f98ade1f7d70b65015775d59974b78dba9a7591242dc5935320e5708
0088:   snapshot_path: closures/inputs/SI-70269c69f98ade1f7d70b65015775d59974b78dba9a7591242dc5935320e5708.md
0089: dependencies: []
0090: seams:
0091: - id: S-CONTEXT
0092:   owner: G-V3
...
0117:   snapshot_path: closures/inputs/SI-e0cb261c6d94faf15f113363cee173fe21c265ee71971fc05394e3b3e78af3c8.md
0118: active_invalidations:
0119: - INV-ASTRA-A-MODEL
0120: - INV-ASTRA-S-RECORD
0121: - INV-ASTRA-A-LEARN
0122: - INV-ASTRA-S-CYCLE
0123: - INV-ASTRA-A-ASSURE
0124: - INV-ASTRA-S-AUDIT
0125: staged_children:
0126: - parent_id: A-MODEL
0127:   candidate_ref: A-MODEL-decomposition-2
0128:   child_ids:
0129:   - S-RECORD
0130: seam_participants:
0131: - node_id: SG-ASSURE
0132:   canonical_path: root/subgoals/sg-assure/design.md
0133:   semantic_digest: 6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410
0134:   snapshot_path: closures/inputs/SI-6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410.md
0135: - node_id: SG-LEARN
0136:   canonical_path: root/subgoals/sg-learn/design.md
0137:   semantic_digest: 2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7
0138:   snapshot_path: closures/inputs/SI-2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7.md
0139: - node_id: SG-MODEL
0140:   canonical_path: root/subgoals/sg-model/design.md
0141:   semantic_digest: ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac
0142:   snapshot_path: closures/inputs/SI-ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac.md
0143: ---
0144: 
0145: # 固定した設計入力
0146: 
0147: 意味snapshotはfilesとsourcesから参照する。正規化はREADMEの記載に従う。結果は別記録に保存する。
</file>
...
<file path="docs/v3-design/closures/manifests/CL-G-V3-d4-t20-29130abf5b62.md" sha256="9d075f5987099f6b97647526bef620fc38b69fc987275e206154c648af24b6c6">
0001: ---
0002: closure_id: CL-G-V3-d4-t20-29130abf5b62
0003: manifest_digest: 29130abf5b623e803039d731aa6ec6e11a761d8b8fe87da1e1067e99e12c8a08
0004: closure_kind: authoring
0005: based_on_tree_revision: 20
0006: target:
0007:   id: G-V3
0008:   design_revision: 4
0009:   parent_design_revision: null
0010: goal_chain:
0011:   root_goal: G-V3
0012: edges: []
...
0014: - path: root/design.md
0015:   node_id: G-V3
0016:   design_revision: 4
0017:   semantic_digest: 02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd
0018:   snapshot_path: closures/inputs/SI-02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd.md
0019: - path: root/rationale.md
0020:   node_id: G-V3
0021:   design_revision: 4
0022:   semantic_digest: b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c
0023:   snapshot_path: closures/inputs/SI-b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c.md
0024: - path: root/subgoals/sg-model/design.md
0025:   node_id: SG-MODEL
0026:   design_revision: 4
0027:   semantic_digest: 632e0a18b128b8cfeca70718be4dca8c03795ab525459d01fb85b7824f3d724c
0028:   snapshot_path: closures/inputs/SI-632e0a18b128b8cfeca70718be4dca8c03795ab525459d01fb85b7824f3d724c.md
0029: - path: root/subgoals/sg-model/rationale.md
0030:   node_id: SG-MODEL
0031:   design_revision: 4
0032:   semantic_digest: 34fb99868ab2b79189846d7cecfe68ba372be047f807ee5f36de50e162ec9cb5
0033:   snapshot_path: closures/inputs/SI-34fb99868ab2b79189846d7cecfe68ba372be047f807ee5f36de50e162ec9cb5.md
0034: - path: root/subgoals/sg-learn/design.md
0035:   node_id: SG-LEARN
0036:   design_revision: 4
0037:   semantic_digest: 622d0d59c04e9f49ec7998cb6bb480e27f1d901868d68110313a60fcee37f9b4
0038:   snapshot_path: closures/inputs/SI-622d0d59c04e9f49ec7998cb6bb480e27f1d901868d68110313a60fcee37f9b4.md
0039: - path: root/subgoals/sg-learn/rationale.md
0040:   node_id: SG-LEARN
0041:   design_revision: 4
0042:   semantic_digest: 92a73a3e0296584e56a768fa126a2059d41bf4d040dd1e944cccafd725ba89f6
0043:   snapshot_path: closures/inputs/SI-92a73a3e0296584e56a768fa126a2059d41bf4d040dd1e944cccafd725ba89f6.md
0044: - path: root/subgoals/sg-assure/design.md
0045:   node_id: SG-ASSURE
0046:   design_revision: 4
0047:   semantic_digest: f6fce35306b9e978e1d30003ff637d8a14ab99f21ed745ebc8dd807a69599c4f
0048:   snapshot_path: closures/inputs/SI-f6fce35306b9e978e1d30003ff637d8a14ab99f21ed745ebc8dd807a69599c4f.md
0049: - path: root/subgoals/sg-assure/rationale.md
0050:   node_id: SG-ASSURE
0051:   design_revision: 4
0052:   semantic_digest: 2e61df4f4c27e00372aab20ddb44c5e78acea6f4df84c2a762c6e608538eb811
0053:   snapshot_path: closures/inputs/SI-2e61df4f4c27e00372aab20ddb44c5e78acea6f4df84c2a762c6e608538eb811.md
0054: dependencies: []
0055: seams:
0056: - id: S-CONTEXT
0057:   owner: G-V3
...
0087: active_invalidations:
0088: - INV-ASTRA-G-V3
0089: - INV-ASTRA-SG-MODEL
0090: - INV-ASTRA-A-MODEL
0091: - INV-ASTRA-S-RECORD
0092: - INV-ASTRA-SG-LEARN
0093: - INV-ASTRA-A-LEARN
0094: - INV-ASTRA-S-CYCLE
0095: - INV-ASTRA-SG-ASSURE
0096: - INV-ASTRA-A-ASSURE
0097: - INV-ASTRA-S-AUDIT
0098: staged_children:
0099: - parent_id: G-V3
0100:   candidate_ref: G-V3-decomposition-2
0101:   child_ids:
0102:   - SG-MODEL
0103:   - SG-LEARN
0104:   - SG-ASSURE
0105: seam_participants:
0106: - node_id: SG-ASSURE
0107:   canonical_path: root/subgoals/sg-assure/design.md
0108:   semantic_digest: 6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410
0109:   snapshot_path: closures/inputs/SI-6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410.md
0110: - node_id: SG-LEARN
0111:   canonical_path: root/subgoals/sg-learn/design.md
0112:   semantic_digest: 2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7
0113:   snapshot_path: closures/inputs/SI-2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7.md
0114: - node_id: SG-MODEL
0115:   canonical_path: root/subgoals/sg-model/design.md
0116:   semantic_digest: ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac
0117:   snapshot_path: closures/inputs/SI-ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac.md
0118: ---
0119: 
0120: # 固定した設計入力
0121: 
0122: 意味snapshotはfilesとsourcesから参照する。正規化はREADMEの記載に従う。結果は別記録に保存する。
</file>
...
<file path="docs/v3-design/closures/manifests/CL-S-AUDIT-d4-t47-49843fea3a9a.md" sha256="db0a1026429b9a3973ed7c03572bc0bb2948c05a1cf5ff84c07c9ae1b27ebf56">
0001: ---
0002: closure_id: CL-S-AUDIT-d4-t47-49843fea3a9a
0003: manifest_digest: 49843fea3a9a13ee5a84a1ee5a6cd7deef351842c3f8eb9acb98bce3951d7938
0004: closure_kind: authoring
0005: based_on_tree_revision: 47
0006: target:
0007:   id: S-AUDIT
0008:   design_revision: 4
0009:   parent_design_revision: 5
...
0066: - path: root/design.md
0067:   node_id: G-V3
0068:   design_revision: 4
0069:   semantic_digest: 02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd
0070:   snapshot_path: closures/inputs/SI-02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd.md
0071: - path: root/rationale.md
0072:   node_id: G-V3
0073:   design_revision: 4
0074:   semantic_digest: b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c
0075:   snapshot_path: closures/inputs/SI-b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c.md
0076: - path: root/subgoals/sg-assure/design.md
0077:   node_id: SG-ASSURE
0078:   design_revision: 5
0079:   semantic_digest: 65f0c9f20af7b546d5853c2e69144475d597b58733519dbc0c310c73f71c343f
0080:   snapshot_path: closures/inputs/SI-65f0c9f20af7b546d5853c2e69144475d597b58733519dbc0c310c73f71c343f.md
0081: - path: root/subgoals/sg-assure/rationale.md
0082:   node_id: SG-ASSURE
0083:   design_revision: 5
0084:   semantic_digest: 53d52fc7158e44c2f7df4f6ba9c68391f88d5030a660ef0bcdfb9e3d7c144ed2
0085:   snapshot_path: closures/inputs/SI-53d52fc7158e44c2f7df4f6ba9c68391f88d5030a660ef0bcdfb9e3d7c144ed2.md
0086: - path: root/subgoals/sg-assure/approaches/a-assure/design.md
0087:   node_id: A-ASSURE
0088:   design_revision: 5
0089:   semantic_digest: 9addcb28218d3d4c244d0f3da0fa8c471ee7a937537e72884bb78769a37875fa
0090:   snapshot_path: closures/inputs/SI-9addcb28218d3d4c244d0f3da0fa8c471ee7a937537e72884bb78769a37875fa.md
0091: - path: root/subgoals/sg-assure/approaches/a-assure/rationale.md
0092:   node_id: A-ASSURE
0093:   design_revision: 5
0094:   semantic_digest: 26adf79ec41667c96f4ac931f0d1b815e2c382692890f080a442ec8884d97554
0095:   snapshot_path: closures/inputs/SI-26adf79ec41667c96f4ac931f0d1b815e2c382692890f080a442ec8884d97554.md
0096: - path: root/subgoals/sg-assure/approaches/a-assure/systems/s-audit/design.md
0097:   node_id: S-AUDIT
0098:   design_revision: 4
0099:   semantic_digest: 45b5d0e158f03d26e47bb7bbc1640185453c5989e9c373ba3303020e74d40bd5
0100:   snapshot_path: closures/inputs/SI-45b5d0e158f03d26e47bb7bbc1640185453c5989e9c373ba3303020e74d40bd5.md
0101: - path: root/subgoals/sg-assure/approaches/a-assure/systems/s-audit/rationale.md
0102:   node_id: S-AUDIT
0103:   design_revision: 4
0104:   semantic_digest: 62deb641d31b6d9c863f11472fa8823a1ea6f8a005a0693b33966d6e6a6ea40f
0105:   snapshot_path: closures/inputs/SI-62deb641d31b6d9c863f11472fa8823a1ea6f8a005a0693b33966d6e6a6ea40f.md
0106: dependencies: []
0107: seams:
0108: - id: S-CONTEXT
0109:   owner: G-V3
...
0137:   snapshot_path: closures/inputs/SI-e0cb261c6d94faf15f113363cee173fe21c265ee71971fc05394e3b3e78af3c8.md
0138: active_invalidations:
0139: - INV-ASTRA-S-AUDIT
0140: staged_children: []
0141: seam_participants:
0142: - node_id: SG-ASSURE
0143:   canonical_path: root/subgoals/sg-assure/design.md
0144:   semantic_digest: 6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410
0145:   snapshot_path: closures/inputs/SI-6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410.md
0146: - node_id: SG-LEARN
0147:   canonical_path: root/subgoals/sg-learn/design.md
0148:   semantic_digest: 2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7
0149:   snapshot_path: closures/inputs/SI-2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7.md
0150: - node_id: SG-MODEL
0151:   canonical_path: root/subgoals/sg-model/design.md
0152:   semantic_digest: ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac
0153:   snapshot_path: closures/inputs/SI-ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac.md
0154: ---
0155: 
0156: # 固定した設計入力
0157: 
0158: 意味snapshotはfilesとsourcesから参照する。正規化はREADMEの記載に従う。結果は別記録に保存する。
</file>

<file path="docs/v3-design/closures/manifests/CL-S-AUDIT-d4-t48-767d441a53a1.md" sha256="a2adc22cc0cc3b7fdc66fed011f304c857a91430a948fbe18ec906dbd6f37f19">
0001: ---
0002: closure_id: CL-S-AUDIT-d4-t48-767d441a53a1
0003: manifest_digest: 767d441a53a115d56e3419bbfbeacfc0c75a1e98156d138df2a862fdcd2becd5
0004: closure_kind: system
0005: based_on_tree_revision: 48
0006: target:
0007:   id: S-AUDIT
0008:   design_revision: 4
0009:   parent_design_revision: 5
...
<file path="docs/v3-design/closures/manifests/CL-S-AUDIT-d4-t49-9fc049759e19.md" sha256="74f53f5e69aaf9fb34852d8219d3662add01173c3279395ced83e39c3b0a4993">
0001: ---
0002: closure_id: CL-S-AUDIT-d4-t49-9fc049759e19
0003: manifest_digest: 9fc049759e196b918af6c67779808e33ee81a0a8f64144253c235fb2841913a3
0004: closure_kind: system
0005: based_on_tree_revision: 49
0006: target:
0007:   id: S-AUDIT
0008:   design_revision: 4
0009:   parent_design_revision: 5
...
0141: - node_id: SG-ASSURE
0142:   canonical_path: root/subgoals/sg-assure/design.md
0143:   semantic_digest: 6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410
0144:   snapshot_path: closures/inputs/SI-6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410.md
0145: - node_id: SG-LEARN
0146:   canonical_path: root/subgoals/sg-learn/design.md
0147:   semantic_digest: 2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7
0148:   snapshot_path: closures/inputs/SI-2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7.md
0149: - node_id: SG-MODEL
0150:   canonical_path: root/subgoals/sg-model/design.md
0151:   semantic_digest: ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac
0152:   snapshot_path: closures/inputs/SI-ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac.md
0153: ---
0154: 
0155: # 固定した設計入力
0156: 
...
<file path="docs/v3-design/closures/manifests/CL-S-CYCLE-d4-t44-50f46ca77b3f.md" sha256="875b6db920037f374fa08b133d862947d0bc136035afe636e034df521e874535">
0001: ---
0002: closure_id: CL-S-CYCLE-d4-t44-50f46ca77b3f
0003: manifest_digest: 50f46ca77b3fbf6c22a71dc2fb3997122d75e0585635c59819fb08dff956c540
0004: closure_kind: authoring
0005: based_on_tree_revision: 44
0006: target:
0007:   id: S-CYCLE
0008:   design_revision: 4
0009:   parent_design_revision: 5
...
0065: - path: root/design.md
0066:   node_id: G-V3
0067:   design_revision: 4
0068:   semantic_digest: 02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd
0069:   snapshot_path: closures/inputs/SI-02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd.md
0070: - path: root/rationale.md
0071:   node_id: G-V3
0072:   design_revision: 4
0073:   semantic_digest: b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c
0074:   snapshot_path: closures/inputs/SI-b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c.md
0075: - path: root/subgoals/sg-learn/design.md
0076:   node_id: SG-LEARN
0077:   design_revision: 5
0078:   semantic_digest: a4cc50e710716cb0d103c486658d9878fdc15e643348e8ea9ebcf43efdf99e2e
0079:   snapshot_path: closures/inputs/SI-a4cc50e710716cb0d103c486658d9878fdc15e643348e8ea9ebcf43efdf99e2e.md
0080: - path: root/subgoals/sg-learn/rationale.md
0081:   node_id: SG-LEARN
0082:   design_revision: 5
0083:   semantic_digest: ae4041fe12f7f36df1fd7a38612c4a79de569eab5d8e040baac097ee8c757a18
0084:   snapshot_path: closures/inputs/SI-ae4041fe12f7f36df1fd7a38612c4a79de569eab5d8e040baac097ee8c757a18.md
0085: - path: root/subgoals/sg-learn/approaches/a-learn/design.md
0086:   node_id: A-LEARN
0087:   design_revision: 5
0088:   semantic_digest: cc9b58628bcd49086646f9957243a0ef465cb8eb3a186a4c68fd3e9b8740db8e
0089:   snapshot_path: closures/inputs/SI-cc9b58628bcd49086646f9957243a0ef465cb8eb3a186a4c68fd3e9b8740db8e.md
0090: - path: root/subgoals/sg-learn/approaches/a-learn/rationale.md
0091:   node_id: A-LEARN
0092:   design_revision: 5
0093:   semantic_digest: b992eadfbdd4994b143cdbd3e77389b71824356a692af3f1e4dcdb7a2a63a9c9
0094:   snapshot_path: closures/inputs/SI-b992eadfbdd4994b143cdbd3e77389b71824356a692af3f1e4dcdb7a2a63a9c9.md
0095: - path: root/subgoals/sg-learn/approaches/a-learn/systems/s-cycle/design.md
0096:   node_id: S-CYCLE
0097:   design_revision: 4
0098:   semantic_digest: 85cc84b97d79a1c6f3031af77866ed46b98715cea1b7d4a63a89dd71a3a75afb
0099:   snapshot_path: closures/inputs/SI-85cc84b97d79a1c6f3031af77866ed46b98715cea1b7d4a63a89dd71a3a75afb.md
0100: - path: root/subgoals/sg-learn/approaches/a-learn/systems/s-cycle/rationale.md
0101:   node_id: S-CYCLE
0102:   design_revision: 4
0103:   semantic_digest: 7a14d20be98a6fb874866021d32d5230bb327c921444703c353e2ada3df110db
0104:   snapshot_path: closures/inputs/SI-7a14d20be98a6fb874866021d32d5230bb327c921444703c353e2ada3df110db.md
0105: dependencies: []
0106: seams:
0107: - id: S-CONTEXT
0108:   owner: G-V3
...
<file path="docs/v3-design/closures/manifests/CL-S-CYCLE-d4-t45-8395894f3ce4.md" sha256="c51cec5bb3684e22345163a91d6900e7a6be57e662b8501aeb87a84ea191e04b">
0001: ---
0002: closure_id: CL-S-CYCLE-d4-t45-8395894f3ce4
0003: manifest_digest: 8395894f3ce44c7fbdffe09d405a58a58ece9ce2df3ac6f766f680779bc32aa6
0004: closure_kind: system
0005: based_on_tree_revision: 45
0006: target:
0007:   id: S-CYCLE
0008:   design_revision: 4
0009:   parent_design_revision: 5
...
<file path="docs/v3-design/closures/manifests/CL-S-CYCLE-d4-t49-9d46a3ae144b.md" sha256="50a6ea1ce20de283c4be048fe43ac6ef264a779940a334723cdb4a9f37c2e4f4">
0001: ---
0002: closure_id: CL-S-CYCLE-d4-t49-9d46a3ae144b
0003: manifest_digest: 9d46a3ae144b1e8d0d135b3d03d1c92783b34371c6240ecbf50fbacc0872ba0d
0004: closure_kind: system
0005: based_on_tree_revision: 49
0006: target:
0007:   id: S-CYCLE
...
0140: - node_id: SG-ASSURE
0141:   canonical_path: root/subgoals/sg-assure/design.md
0142:   semantic_digest: 6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410
0143:   snapshot_path: closures/inputs/SI-6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410.md
0144: - node_id: SG-LEARN
0145:   canonical_path: root/subgoals/sg-learn/design.md
0146:   semantic_digest: 2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7
0147:   snapshot_path: closures/inputs/SI-2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7.md
0148: - node_id: SG-MODEL
0149:   canonical_path: root/subgoals/sg-model/design.md
0150:   semantic_digest: ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac
0151:   snapshot_path: closures/inputs/SI-ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac.md
0152: ---
0153: 
0154: # 固定した設計入力
0155: 
...
<file path="docs/v3-design/closures/manifests/CL-S-RECORD-d4-t41-f26915a13939.md" sha256="fd7b148f78916852464fd27ce230ddc3d2a9764595f7ce051cbad427b73ab709">
0001: ---
0002: closure_id: CL-S-RECORD-d4-t41-f26915a13939
0003: manifest_digest: f26915a139391be4c9b581c0281144992d7f8ffffc5d72f9406acef4bae30309
0004: closure_kind: authoring
0005: based_on_tree_revision: 41
0006: target:
0007:   id: S-RECORD
0008:   design_revision: 4
0009:   parent_design_revision: 5
...
0077:   node_id: SG-MODEL
0078:   design_revision: 5
0079:   semantic_digest: 6902bcb5f2c4bffb85f8811edbb7a19e5ad96807566dd22488b8e7ce5d0febf3
0080:   snapshot_path: closures/inputs/SI-6902bcb5f2c4bffb85f8811edbb7a19e5ad96807566dd22488b8e7ce5d0febf3.md
0081: - path: root/subgoals/sg-model/rationale.md
0082:   node_id: SG-MODEL
0083:   design_revision: 5
0084:   semantic_digest: 54fcd157afc7fabe1b435b015b9fef2b70f8d68a28209a17814d66167ea31fa2
0085:   snapshot_path: closures/inputs/SI-54fcd157afc7fabe1b435b015b9fef2b70f8d68a28209a17814d66167ea31fa2.md
0086: - path: root/subgoals/sg-model/approaches/a-model/design.md
0087:   node_id: A-MODEL
0088:   design_revision: 5
0089:   semantic_digest: 91a4301b582727a3d638371b82a86f805648e8db5f25ab05ad8f519d51bd60c1
0090:   snapshot_path: closures/inputs/SI-91a4301b582727a3d638371b82a86f805648e8db5f25ab05ad8f519d51bd60c1.md
0091: - path: root/subgoals/sg-model/approaches/a-model/rationale.md
0092:   node_id: A-MODEL
0093:   design_revision: 5
0094:   semantic_digest: f39f7e60835bdddee20900e793e0ccd8a619e7a6dc775de823aa33b877887878
0095:   snapshot_path: closures/inputs/SI-f39f7e60835bdddee20900e793e0ccd8a619e7a6dc775de823aa33b877887878.md
0096: - path: root/subgoals/sg-model/approaches/a-model/systems/s-record/design.md
0097:   node_id: S-RECORD
0098:   design_revision: 4
0099:   semantic_digest: a10bad434f158ae0bf8172676b3e6cea089198115a81d642c8936ebe25595b6e
0100:   snapshot_path: closures/inputs/SI-a10bad434f158ae0bf8172676b3e6cea089198115a81d642c8936ebe25595b6e.md
0101: - path: root/subgoals/sg-model/approaches/a-model/systems/s-record/rationale.md
0102:   node_id: S-RECORD
0103:   design_revision: 4
0104:   semantic_digest: 66444a6e7861118592400f40e22b683782e66fa97e882dfb2b25bac3c42de372
0105:   snapshot_path: closures/inputs/SI-66444a6e7861118592400f40e22b683782e66fa97e882dfb2b25bac3c42de372.md
0106: dependencies: []
0107: seams:
0108: - id: S-CONTEXT
0109:   owner: G-V3
...
0137:   snapshot_path: closures/inputs/SI-e0cb261c6d94faf15f113363cee173fe21c265ee71971fc05394e3b3e78af3c8.md
0138: active_invalidations:
0139: - INV-ASTRA-S-RECORD
0140: - INV-ASTRA-S-CYCLE
0141: - INV-ASTRA-S-AUDIT
0142: staged_children: []
0143: seam_participants:
0144: - node_id: SG-ASSURE
0145:   canonical_path: root/subgoals/sg-assure/design.md
0146:   semantic_digest: 6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410
0147:   snapshot_path: closures/inputs/SI-6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410.md
0148: - node_id: SG-LEARN
0149:   canonical_path: root/subgoals/sg-learn/design.md
0150:   semantic_digest: 2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7
0151:   snapshot_path: closures/inputs/SI-2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7.md
0152: - node_id: SG-MODEL
0153:   canonical_path: root/subgoals/sg-model/design.md
0154:   semantic_digest: ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac
0155:   snapshot_path: closures/inputs/SI-ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac.md
0156: ---
0157: 
0158: # 固定した設計入力
0159: 
0160: 意味snapshotはfilesとsourcesから参照する。正規化はREADMEの記載に従う。結果は別記録に保存する。
</file>

<file path="docs/v3-design/closures/manifests/CL-S-RECORD-d4-t42-b9c06d70cb12.md" sha256="f8680f2cd52e677027c4b873b77c747da4a37ee27cfc1321c28951c55e8bf371">
0001: ---
0002: closure_id: CL-S-RECORD-d4-t42-b9c06d70cb12
0003: manifest_digest: b9c06d70cb12c4f043a6113d6807695b6b6da61013cfb30a513da8c8e8d180e8
0004: closure_kind: system
0005: based_on_tree_revision: 42
0006: target:
0007:   id: S-RECORD
0008:   design_revision: 4
0009:   parent_design_revision: 5
...
<file path="docs/v3-design/closures/manifests/CL-S-RECORD-d4-t49-c65a3a86187d.md" sha256="e1fec09e1c595289a0e898f17310209ecda57a33476c7482f3dabeed6c1222bb">
0001: ---
0002: closure_id: CL-S-RECORD-d4-t49-c65a3a86187d
0003: manifest_digest: c65a3a86187d62715bed6fe3c127891adcd320ffd79ad720f63f6039c1767532
0004: closure_kind: system
0005: based_on_tree_revision: 49
0006: target:
0007:   id: S-RECORD
...
<file path="docs/v3-design/closures/manifests/CL-SG-ASSURE-d5-t29-8778a28db93a.md" sha256="d2201e5e144dfbbdba9fdc175a075a01cf8f7060cfcfe2f5b2e3168d2334a2a9">
0001: ---
0002: closure_id: CL-SG-ASSURE-d5-t29-8778a28db93a
0003: manifest_digest: 8778a28db93a57c7c3f268cf168ccf8645f3abca088e646fe82f44bc1f092f9b
0004: closure_kind: authoring
0005: based_on_tree_revision: 29
0006: target:
0007:   id: SG-ASSURE
0008:   design_revision: 5
0009:   parent_design_revision: 4
0010: goal_chain:
0011:   root_goal: G-V3
0012:   subgoal: SG-ASSURE
0013: edges:
...
0031: - path: root/design.md
0032:   node_id: G-V3
0033:   design_revision: 4
0034:   semantic_digest: 02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd
0035:   snapshot_path: closures/inputs/SI-02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd.md
0036: - path: root/rationale.md
0037:   node_id: G-V3
0038:   design_revision: 4
0039:   semantic_digest: b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c
0040:   snapshot_path: closures/inputs/SI-b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c.md
0041: - path: root/subgoals/sg-assure/design.md
0042:   node_id: SG-ASSURE
0043:   design_revision: 5
0044:   semantic_digest: 65f0c9f20af7b546d5853c2e69144475d597b58733519dbc0c310c73f71c343f
0045:   snapshot_path: closures/inputs/SI-65f0c9f20af7b546d5853c2e69144475d597b58733519dbc0c310c73f71c343f.md
0046: - path: root/subgoals/sg-assure/rationale.md
0047:   node_id: SG-ASSURE
0048:   design_revision: 5
0049:   semantic_digest: 53d52fc7158e44c2f7df4f6ba9c68391f88d5030a660ef0bcdfb9e3d7c144ed2
0050:   snapshot_path: closures/inputs/SI-53d52fc7158e44c2f7df4f6ba9c68391f88d5030a660ef0bcdfb9e3d7c144ed2.md
0051: - path: root/subgoals/sg-assure/approaches/a-assure/design.md
0052:   node_id: A-ASSURE
0053:   design_revision: 4
0054:   semantic_digest: 0d9270dced4babfff3d616238f00fabcdff8fc1dd70750fb7d5d8eecd6e65744
0055:   snapshot_path: closures/inputs/SI-0d9270dced4babfff3d616238f00fabcdff8fc1dd70750fb7d5d8eecd6e65744.md
0056: - path: root/subgoals/sg-assure/approaches/a-assure/rationale.md
0057:   node_id: A-ASSURE
0058:   design_revision: 4
0059:   semantic_digest: cb82d9a38bcd59478b18785f7c4b749a46b5490a3858c2bf3b4ddef21e727e69
0060:   snapshot_path: closures/inputs/SI-cb82d9a38bcd59478b18785f7c4b749a46b5490a3858c2bf3b4ddef21e727e69.md
0061: dependencies: []
0062: seams:
0063: - id: S-CONTEXT
0064:   owner: G-V3
...
0090:   snapshot_path: closures/inputs/SI-e0cb261c6d94faf15f113363cee173fe21c265ee71971fc05394e3b3e78af3c8.md
0091: active_invalidations:
0092: - INV-ASTRA-A-MODEL
0093: - INV-ASTRA-S-RECORD
0094: - INV-ASTRA-A-LEARN
0095: - INV-ASTRA-S-CYCLE
0096: - INV-ASTRA-SG-ASSURE
0097: - INV-ASTRA-A-ASSURE
0098: - INV-ASTRA-S-AUDIT
0099: staged_children:
0100: - parent_id: SG-ASSURE
0101:   candidate_ref: SG-ASSURE-decomposition-2
0102:   child_ids:
0103:   - A-ASSURE
0104: seam_participants:
0105: - node_id: SG-ASSURE
0106:   canonical_path: root/subgoals/sg-assure/design.md
0107:   semantic_digest: 6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410
0108:   snapshot_path: closures/inputs/SI-6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410.md
0109: - node_id: SG-LEARN
0110:   canonical_path: root/subgoals/sg-learn/design.md
0111:   semantic_digest: 2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7
0112:   snapshot_path: closures/inputs/SI-2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7.md
0113: - node_id: SG-MODEL
0114:   canonical_path: root/subgoals/sg-model/design.md
0115:   semantic_digest: ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac
0116:   snapshot_path: closures/inputs/SI-ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac.md
0117: ---
0118: 
0119: # 固定した設計入力
0120: 
0121: 意味snapshotはfilesとsourcesから参照する。正規化はREADMEの記載に従う。結果は別記録に保存する。
</file>
...
<file path="docs/v3-design/closures/manifests/CL-SG-LEARN-d5-t26-a98c842af2a4.md" sha256="df3f7dd89b9c0329ba14d699060a47c750c5fc9d35d53aef3ef26981da367b7f">
0001: ---
0002: closure_id: CL-SG-LEARN-d5-t26-a98c842af2a4
0003: manifest_digest: a98c842af2a42b3af1c99ce7f0c0a23bb5c103b1bdba83c3c55747794ef17f7f
0004: closure_kind: authoring
0005: based_on_tree_revision: 26
0006: target:
0007:   id: SG-LEARN
0008:   design_revision: 5
0009:   parent_design_revision: 4
...
0030: - path: root/design.md
0031:   node_id: G-V3
0032:   design_revision: 4
0033:   semantic_digest: 02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd
0034:   snapshot_path: closures/inputs/SI-02dac707bde155ddd3fc7b7a294b2649dd6cef118dd94bf7ff5f4bf4278608cd.md
0035: - path: root/rationale.md
0036:   node_id: G-V3
0037:   design_revision: 4
0038:   semantic_digest: b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c
0039:   snapshot_path: closures/inputs/SI-b6f84bf78c81aace60249aede5a969dc4e359159bb836993cc200c352dd3f92c.md
0040: - path: root/subgoals/sg-learn/design.md
0041:   node_id: SG-LEARN
0042:   design_revision: 5
0043:   semantic_digest: a4cc50e710716cb0d103c486658d9878fdc15e643348e8ea9ebcf43efdf99e2e
0044:   snapshot_path: closures/inputs/SI-a4cc50e710716cb0d103c486658d9878fdc15e643348e8ea9ebcf43efdf99e2e.md
0045: - path: root/subgoals/sg-learn/rationale.md
0046:   node_id: SG-LEARN
0047:   design_revision: 5
0048:   semantic_digest: ae4041fe12f7f36df1fd7a38612c4a79de569eab5d8e040baac097ee8c757a18
0049:   snapshot_path: closures/inputs/SI-ae4041fe12f7f36df1fd7a38612c4a79de569eab5d8e040baac097ee8c757a18.md
0050: - path: root/subgoals/sg-learn/approaches/a-learn/design.md
0051:   node_id: A-LEARN
0052:   design_revision: 4
0053:   semantic_digest: 1b060eb91aaa23b0511dabd23c7a69491c378c44d48d3de81c5bff3b264bfc62
0054:   snapshot_path: closures/inputs/SI-1b060eb91aaa23b0511dabd23c7a69491c378c44d48d3de81c5bff3b264bfc62.md
0055: - path: root/subgoals/sg-learn/approaches/a-learn/rationale.md
0056:   node_id: A-LEARN
0057:   design_revision: 4
0058:   semantic_digest: 38c073777200e159167e149cf203d15f3be61474e18f53a7a6023d79861d68e4
0059:   snapshot_path: closures/inputs/SI-38c073777200e159167e149cf203d15f3be61474e18f53a7a6023d79861d68e4.md
0060: dependencies: []
0061: seams:
0062: - id: S-CONTEXT
0063:   owner: G-V3
...
0089:   snapshot_path: closures/inputs/SI-e0cb261c6d94faf15f113363cee173fe21c265ee71971fc05394e3b3e78af3c8.md
0090: active_invalidations:
0091: - INV-ASTRA-A-MODEL
0092: - INV-ASTRA-S-RECORD
0093: - INV-ASTRA-SG-LEARN
0094: - INV-ASTRA-A-LEARN
0095: - INV-ASTRA-S-CYCLE
0096: - INV-ASTRA-SG-ASSURE
0097: - INV-ASTRA-A-ASSURE
0098: - INV-ASTRA-S-AUDIT
0099: staged_children:
0100: - parent_id: SG-LEARN
0101:   candidate_ref: SG-LEARN-decomposition-2
0102:   child_ids:
0103:   - A-LEARN
0104: seam_participants:
0105: - node_id: SG-ASSURE
...
<file path="docs/v3-design/closures/manifests/CL-SG-MODEL-d5-t23-dca8e5ace808.md" sha256="84b62ec7d1e258d228d145e92e4cbc5194322363e94f40e51ac2df9def38adb2">
0001: ---
0002: closure_id: CL-SG-MODEL-d5-t23-dca8e5ace808
0003: manifest_digest: dca8e5ace808434ea94abdb76ab9e8ce517938f55028c1efc1c85b2e0ec557c1
0004: closure_kind: authoring
0005: based_on_tree_revision: 23
0006: target:
0007:   id: SG-MODEL
0008:   design_revision: 5
0009:   parent_design_revision: 4
...
0042:   node_id: SG-MODEL
0043:   design_revision: 5
0044:   semantic_digest: 6902bcb5f2c4bffb85f8811edbb7a19e5ad96807566dd22488b8e7ce5d0febf3
0045:   snapshot_path: closures/inputs/SI-6902bcb5f2c4bffb85f8811edbb7a19e5ad96807566dd22488b8e7ce5d0febf3.md
0046: - path: root/subgoals/sg-model/rationale.md
0047:   node_id: SG-MODEL
0048:   design_revision: 5
0049:   semantic_digest: 54fcd157afc7fabe1b435b015b9fef2b70f8d68a28209a17814d66167ea31fa2
0050:   snapshot_path: closures/inputs/SI-54fcd157afc7fabe1b435b015b9fef2b70f8d68a28209a17814d66167ea31fa2.md
0051: - path: root/subgoals/sg-model/approaches/a-model/design.md
0052:   node_id: A-MODEL
0053:   design_revision: 4
0054:   semantic_digest: 4c93e23c8c9a918615b0961dfbaaa806ec64eea8c490efd167ad33affd4e9087
0055:   snapshot_path: closures/inputs/SI-4c93e23c8c9a918615b0961dfbaaa806ec64eea8c490efd167ad33affd4e9087.md
0056: - path: root/subgoals/sg-model/approaches/a-model/rationale.md
0057:   node_id: A-MODEL
0058:   design_revision: 4
0059:   semantic_digest: 1466928b6716f1ec969584ae03cb68910896ca802e4476e7ac5ada8a80b86319
0060:   snapshot_path: closures/inputs/SI-1466928b6716f1ec969584ae03cb68910896ca802e4476e7ac5ada8a80b86319.md
0061: dependencies: []
0062: seams:
0063: - id: S-CONTEXT
0064:   owner: G-V3
...
0090:   snapshot_path: closures/inputs/SI-e0cb261c6d94faf15f113363cee173fe21c265ee71971fc05394e3b3e78af3c8.md
0091: active_invalidations:
0092: - INV-ASTRA-SG-MODEL
0093: - INV-ASTRA-A-MODEL
0094: - INV-ASTRA-S-RECORD
0095: - INV-ASTRA-SG-LEARN
0096: - INV-ASTRA-A-LEARN
0097: - INV-ASTRA-S-CYCLE
0098: - INV-ASTRA-SG-ASSURE
0099: - INV-ASTRA-A-ASSURE
0100: - INV-ASTRA-S-AUDIT
0101: staged_children:
0102: - parent_id: SG-MODEL
0103:   candidate_ref: SG-MODEL-decomposition-2
0104:   child_ids:
0105:   - A-MODEL
0106: seam_participants:
0107: - node_id: SG-ASSURE
0108:   canonical_path: root/subgoals/sg-assure/design.md
0109:   semantic_digest: 6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410
0110:   snapshot_path: closures/inputs/SI-6ab799a77d85fcc2e0df321c26d173a5bf34319d4b8765747622289d4d001410.md
0111: - node_id: SG-LEARN
0112:   canonical_path: root/subgoals/sg-learn/design.md
0113:   semantic_digest: 2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7
0114:   snapshot_path: closures/inputs/SI-2dde9040f50a76c16083619f191d527f35ad38f3c21fb2bb83f4b473b00f25a7.md
0115: - node_id: SG-MODEL
0116:   canonical_path: root/subgoals/sg-model/design.md
0117:   semantic_digest: ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac
0118:   snapshot_path: closures/inputs/SI-ed192ee595f19670e06a2bdee05ff6e8d14433fb2575418e06814d35cec034ac.md
0119: ---
0120: 
0121: # 固定した設計入力
0122: 
0123: 意味snapshotはfilesとsourcesから参照する。正規化はREADMEの記載に従う。結果は別記録に保存する。
</file>

<file path="docs/v3-design/README.md" sha256="e1aec6e17639de1314742f8a3efd4156ea19d532949846c57237410245b7a712">
0001: # AIDE v3 設計 — 小さく試し、結果から設計を育てる
0002: 
0003: **v2の設計工程で作成した、v3の実装に向けた設計です。重大指摘4件を修正し、Astraで再監査する段階です。** 2026-09-22に4階層・10ノードを正本化しましたが、その後のAstra監査で重大な不足が見つかりました。v3の実行規約・テンプレート一式や製品コードは未実装です。
0004: 
0005: 前回の **Codex CLI / GPT-6 Astraによる独立監査はfail、major 4件**でした。tree revision 49で修正を再公開し、独立再監査を待っています。GPT-5.5の過去のpassを現在の受入判定には使いません。[監査結果と実行記録](checks/independent-audit/README.md) と [修正の変更イベント](changes/events/EV-ASTRA-20260922-01.md) を保存しています。
0006: 
...
0018: | 今回どこまで確認したか | [修正後の文書照合](checks/astra-repair-verification.md)・[初回の検査履歴](checks/completion.md) |
0019: 
...
0102: 
0103: 構造照合は文書検査の補助処理で行い、ノードを正本化した時点の意味レビューは主担当が行いました。続くGPT-5.5の独立監査はpassでしたが、ユーザー指定のAstraによる再監査はfailでした。過去の検査・公開記録はそのまま残し、最新指摘をv2の変更イベントで処理しました。[修正後の文書照合](checks/astra-repair-verification.md)と過去3閉包の訂正検査を保存しています。独立再監査が通るまで最終受入は保留します。
0104: 
0105: - [tree-state.md](tree-state.md): 現在の全体版と引渡し先。現在 `tree_revision: 49`。
...
<file path="docs/v3-design/root/design.md" sha256="061327ff03368893256498744fab69e4d8c8b86a416990d3b07f87c0af6fc893">
0001: ---
0002: id: G-V3
0003: kind: root_goal
...
0008: revision: 12
0009: design_revision: 4
0010: parent_revision: null
0011: updated_at: '2026-09-22T20:55:02+09:00'
0012: children:
0013: - id: SG-MODEL
...
0075:   failure: 対象欠落・競合・取消待ちでは理由と再読先を返す。旧checkedを取消後の進行許可へ流用しない。
0076: - id: S-PROPOSAL
0077:   owner: G-V3
0078:   from: SG-LEARN
0079:   to: SG-MODEL
...
0081:   revision: 2
0082:   contract: operation_id、kind(plan/adoption/withdrawal/cycle_closed)、experiment_id/plan_revision、cycle_id、scopeを渡す。plan/adoptionはbase_bundle、対象ID、仕様差分、subject/subject_hash、条件・契約影響、委任参照を持つ。withdrawalはtarget_operation_id、expected_subject_hash、scopeを持つ。cycle_closedはoutcome、全関連操作IDと確定結果、反映bundle、closed_atを持つ。詳細な版集合・終了・取消の意味は本design
0083:     §5の共通契約を適用する。
0084:   failure: 同内容ID再送は保存済み状態を返し、異内容ID再利用は拒否する。旧版・予算外・取消済みは反映しない。未着取消はpending-target、反映後取消はalready-applied。終了通知は周期要求保存または差分なし記録後にack。
0085: - id: S-AUDIT-INPUT
0086:   owner: G-V3
0087:   from: SG-MODEL
0088:   to: SG-ASSURE
0089:   direction: 設計→監査
0090:   revision: 2
0091:   contract: 新しいaudit_request_idをoperation_idとし、origin_operation_id、kind(plan/adoption/periodic/cancel)、scope、subject/subject_hash、criteria_version、基準版、累積差分、委任、観測時刻を渡す。periodicはtrigger(cycle_closed/activity_due)、対応する通知IDまたは期限を持つ。cancelは新operation_id、target_operation_id（監査要求ID）、expected_subject_hash、scopeを持つ。初回baselineはnull。§5の共通契約を適用する。
0092:   failure: 版集合の欠落・可変refはblocked。対象変更は新要求。同ID異内容は拒否。取消未着はpending-target、完了後はalready-completed、未完了はcancelled。通知と要求の再送は同じ対応を保つ。
0093: - id: S-AUDIT-RESULT
0094:   owner: G-V3
0095:   from: SG-ASSURE
0096:   to: SG-MODEL
0097:   direction: 監査→設計
0098:   revision: 2
0099:   contract: operation_id（応答先監査要求ID）、origin_operation_id、subject_hash（target_hashと同義）、scope、phase、criteria_version、result(daily-pass/require-review/audit-pass/blocked/stale/cancelled/pending-target/already-completed/rejected)、証拠、finding、次の処理、基準版、期限を返す。cancel応答はtarget_operation_idも返す。audit-passの受理条件と基準更新範囲は§5に従う。
0100:   failure: 記録側は監査要求・対象subject・scope・phase・基準を照合し、不一致や取消済みはstale。再送で基準を重複更新しない。重大指摘は影響範囲を保留し、現在版の自動巻戻しや影響外停止をしない。
0101: seam_refs: []
0102: source_refs:
0103: - sources/requirements.md
0104: unit_test_id: null
0105: subgoal_integration_id: null
0106: final_integration_id: FIT-G-V3
0107: ---
0108: 
0109: # 試して学び、意図と現在の状態を説明できる開発
0110: 
0111: 利用者が必要な最小実装を早く試し、結果から設計を更新し、何を作り何を未確認としているかを理解できる。
0112: 
0113: **なぜ必要か:** 小規模実装の学び、現在仕様の理解、更新の信頼は別々に確認できる成果で、三つが揃って目的を満たす。
0114: 
0115: **今回の判断:** 目標の4階層を骨格として保持する。ドメインは責任と言葉の境界として重ねる。実験・反映・定期監査を同じ保存情報から再開する。
0116: 
0117: ## 1. 目的
0118: 
0119: 利用者が必要な最小実装を早く試し、結果から設計を更新し、何を作り何を未確認としているかを理解できる。
0120: 
0121: ## 2. 親から受け取った条件
0122: 
0123: 根のため該当なし。入力の正本は sources/requirements.md。
0124: 
0125: ## 3. 対象と望ましい状態
0126: 
0127: 対象はAIと共同開発する利用者と実装・監査担当。手続きのための停止、理解できない説明、記録の食い違いを減らす。
0128: 
0129: 利用者が必要な最小実装を早く試し、結果から設計を更新し、何を作り何を未確認としているかを理解できる。
0130: 
0131: ## 4. 責任範囲
0132: 
0133: v3の設計・実験・反映・監査の契約を決める。今回の成果は実装可能な設計まで。
0134: 
0135: | 制約ID | 守る条件 |
0136: | --- | --- |
0137: | C-TRACE | 目標→小目標→アプローチ→システムの意味を残し、目的と担当を参照で追える。 |
0138: | C-ONE | 仕様・契約の正本と書込み担当を一つにする。候補、現行、過去版、監査済みを混同しない。 |
0139: | C-SCOPE | 既存の許可と委任を引き継ぐ。目的・予算・外部影響の範囲は暗黙に拡張しない。 |
0140: | C-EVIDENCE | 設計上の判断、実装された事実、テスト結果、人の評価、監査結果を区別する。 |
0141: | C-SMALL | 今回の実験に必要な枝だけを具体化する。全枝の完成を実験開始の条件にしない。 |
0142: | C-READ | 意味と操作結果を先に説明する。用語には具体的意味を与え、短い理由を仕様に添える。 |
0143: | C-REVIEW | 監査指摘は基準・具体的な支障・終了条件を持つ。minorと委任済み内部選択だけで停止しない。 |
0144: | C-PHASE | 本ツリーはv2によるv3の設計成果。v3実行、製品実装、テスト成功を装わない。 |
0145: 
0146: ## 5. 設計
0147: 
0148: 目標の4階層を骨格として保持する。ドメインは責任と言葉の境界として重ねる。実験・反映・定期監査を同じ保存情報から再開する。
0149: 
0150: ### v2を使う今回と、将来のv3を分ける
0151: 今回の設計ツリーの配置・状態遷移・公開判定はv2に従う。v3の周期監査を今回のv2検査の省略理由にしない。v3の実行規約は本設計を元に後続工程で作る。
0152: 
0153: ### v3の正本と実行単位
0154: 設計の所有単位はsystem、モデルの意味が通じる単位はbounded context、試す単位はexperimentとする。一つのexperimentは複数systemを横断できる。これらを一対一に固定しない。
0155: masterはroot_goalの正本で、全体方針、成功条件、目標・domain・contextの参照を持つ。詳細の全文を複製しない。現在の意味が変わった箇所だけを更新する。
0156: 
0157: ### AIDE自身のドメインとモデル境界
0158: 今回の業務領域は「AIと共同で設計を育てること」。その中に、現在仕様と根拠を扱う記録context、仮説と観測を扱う学習context、保証範囲と指摘を扱う監査contextを置く。分割理由はそれぞれが所有する状態と判断の違いであり、実行ロールの数ではない。
0159: 記録contextの「採用」は現在仕様への反映、学習contextの「成功」は固定した評価条件の成立、監査contextの「合格」は対象版の適用基準を満たすことを意味する。成功や合格を採用・実行許可と同義にしない。
0160: 記録はSG-MODEL/S-RECORD、学習はSG-LEARN/S-CYCLE、監査はSG-ASSURE/S-AUDITが担う。境界を通るデータは根が所有する4本のseamで解釈を揃える。記録が現在仕様の提供者、学習が証拠と提案の提供者、監査が判定の提供者になる。配置や実行プロセスを3サービスに分割することは要求しない。
0161: 
0162: ### 公開と許可
0163: v2のpublishedは本設計を正本にしたという意味。v3における現在仕様への採用、監査合格、実験実行の委任、製品の外部公開は別の判断。許可はユーザーの既存指示と範囲を参照し、AIが自己拡張しない。
0164: 
0165: ### 共通識別
0166: v3の操作はoperation_id、対象ID、base_revision、意味のハッシュを持つ。同じoperation_id・同じ内容の再送は同じ結果を返す。内容を変えて同じIDを再利用したら拒否する。送信順や時刻だけで新旧を判断しない。
0167: 意味変更ではsemantic_revisionを、状態・結果追記だけでは通常revisionを進める。監査の対象は以下のsubjectで固定し、結果追記によって自己失効させない。
0168: 書込み担当は対象の通常revisionを直前照合し、競合時は候補を保存したまま再評価する。部分反映をcurrentと表示しない。
0169: 
0170: ### 統合責任
0171: G6は根が統合所有する。記録、実験、監査の各小目標へ回復条件を配り、SITの成立だけでG6達成を推測しない。FIT-G-V3で全体接続を将来確認する。
0172: 
0173: ### 正常・失敗・取消の扱い
0174: 
0175: 正常時は割当条件に沿って下位を具体化する。参照・版の矛盾は影響範囲へ返す。仮説の不成立は実験結果として残し、仕様の成功へ置換しない。取消した候補は現在仕様へ反映せず、既存の有効版を維持する。
0176: 
0177: ### 監査対象を固定する共通契約（AV3-001）
0178: 監査対象subjectはscope、phase、spec意味版と契約版の集合、plan_revisionと評価条件版、implementation_ref、trial_refs、evidence_refsを一組として固定する。各refは不変コミット・内容hash・不変snapshot等で内容を一意に復元できる参照とする。編集可能なファイル名やlatestだけの参照は拒否する。subject_hashはこの版集合全体の識別値であり、仕様だけの意味hashとは別物である。以下で監査対象のtarget_hashと呼ぶ値は常にsubject_hashを指す。
0179: planでは未実装のimplementation_refをnull、未取得の試行・証拠を空として未検証範囲を明記できる。adoptionでは採用実装版とその検証・実使用の結果または理由付き未検証の扱いを固定する。periodicは現行の採用済み版集合を固定する。監査結果自体と状態追記はsubjectに入れず、結果追記による自己失効を防ぐ。
0180: 結果はaudit_request_id、subject_hash、scope、phase、criteria_versionに結び付く。完全一致する対象にだけ適用できる。実装・証拠・評価条件・対象範囲のいずれかが変われば新しいsubjectと新しい要求IDで分類する。古い結果は履歴と比較根拠として残すが、新対象を合格扱いにしない。仕様の意味不変な実装修正も、関連確認を経てdaily-passで採用し得るが、未監査差分に実装・証拠の版変更を加える。
0181: audit_baselineはscope/phaseごとの監査済みsubjectを指す。daily-passは基準を進めない。audit-passも記録側が一致を確認し受理した範囲だけを進める。plan合格はplanの基準にだけ有効で、実装保証へ昇格させない。adoption結果はcurrentの一括反映と同時に受理し、periodic結果は現在の対象版集合が一致する場合だけ受理する。対象外の差分や監査中に生じた新差分は残す。
0182: 
0183: ### サイクル終了と周期確認の共通契約（AV3-002）
0184: cycle_idは一回の実験サイクルを識別する。S-CYCLEがreflected、rejected、cancelled、または終了を決めたinconclusiveを終端として記録する。pausedと修正継続中のinconclusiveは終端ではない。終端を再開して書き換えず、追加実験には新しいcycle_idと元サイクルへの参照を付ける。
0185: 学習側は全plan/adoption要求の確定結果を確認してから、終端状態とcycle_closed通知の未送信記録を同じ論理更新で保存する。通知は独自operation_id、cycle_id、experiment_id/plan_revision、outcome、対象scope、関連する全操作IDと確定結果、反映済みbundle（無ければnull）、closed_atを持つ。取消なら対象取消の確定を先に待ち、取消前に反映済みならその反映結果を通知にも残す。再開時は未確認通知を同じIDで再送する。
0186: S-RECORDが通知の受信・周期確認の起動を所有する。関連操作の確定と反映結果を自分の記録で照合し、未確定ならpendingとして保持し確定後に再開する。採用時はcurrent反映後、不採用・取消時も受信時の現行scopeにある未監査差分を確認する。終了通知の受領と、periodic要求の永続化または差分なしのskip理由を同じ論理更新で保存してからackを返す。再送では新たな要求を増やさない。既存の同じsubject/scopeの要求があれば対応付ける。
0187: 周期要求は保存直後に監査へ渡し、中断時は次の再開で未送信要求を処理する。単に次回の任意作業まで保留しない。もう一つの起点は、最初の未監査変更から7暦日後の次の作業開始であり、S-RECORDが開始時に観測時刻を確認して同じ経路を起動する。実験終了と期限の早い方を採用する。監査中の新差分に対しても期限と終了通知を保持し、旧対象の結果だけで解消済みとしない。自動常駐処理は要求しない。
0188: periodicがblockedならcurrentを自動巻戻しせず影響scopeを修正待ちとして表示し、そのscopeの新しい採用・試作進行を保留する。原因解消の候補作成・限定した修正検証は既存の委任内で可能とし、無関係な枝は継続する。合格済み対象と保留範囲を区別して再開する。
0189: 
0190: ### 取消と反映の順序の共通契約（AV3-003）
0191: withdrawalのoperation_idは取消要求自身の新しいIDとし、target_operation_idで一つのplanまたはadoption要求を指定する。expected_subject_hashとscopeを付け、対象との一致と委任を照合する。同じexperimentの他操作を暗黙に取り消さない。同じID・同じ内容の再送は重複処理せず保存済みの現在の確定結果を返す。異内容でのID再利用は拒否する。
0192: S-RECORDは対象が未着の場合pending-targetとして取消要求を保存し、指定ID・期待hash・scopeの仮tombstoneを置く。一致する対象が後着したら取消を確定し、違えば取消をrejectedにして仮tombstoneを外す。仮状態では対象の反映を行わない。取消要求の権限・範囲が検証できなければblockedとし反映を許可しない。対象が届かない間は取消完了と表示しない。
0193: 記録側はcurrent切替と取消確定を同じ操作台帳で直列化する。取消が先ならcancelledのtombstoneを確定し、旧要求の再送はcancelled、遅延監査結果はstaleとして反映も基準更新もしない。adoptionのcurrent切替が先ならalready-appliedとbundleを返し、巻戻しは新しいadoptionにする。planのchecked後も将来の着手をcancelledにできるが、既に行われた実行を消したり未実行と記録したりしない。S-CYCLEは次の作業境界で停止し結果を保存する。
0194: 対象proposalとaudit_request_idの対応はS-RECORDが保存する。監査へ渡すcancelも新しいoperation_idを持ち、target_operation_idには対応する一つのaudit_request_idを指定し、同じexpected_subject_hash/scopeを渡す。S-AUDITは未着なら仮tombstone、到着後なら取消記録を保持する。先に判定完了していればalready-completedと元結果を返して履歴を残すが、記録側の取消は撤回されない。監査cancel通知の到着を待たず記録側のtombstoneで遅延結果を拒否する。取消通知も永続化して再送し、二重通知で状態を戻さない。
0195: 
0196: ## 6. 入出力と状態
0197: 
0198: | 区分 | 契約 |
0199: | --- | --- |
0200: | 入力 | 親条件、sources/requirements.md、祖先が所有する公開seam契約。 |
0201: | 出力 | 子への条件割当と、上位条件への対応を持つ設計。 |
0202: | 状態 | v3の設計候補・現在版・証拠・監査基準を区別する。今回のnode状態はv2が管理する。 |
0203: 
0204: ## 7. seam と依存
0205: 
0206: seamの項目と方向の正本はfrontmatterのowned_seams、共通の意味・順序の正本は§5。両者で一つの契約を構成する。4本で要求・応答・失敗・取消を扱う。
0207: 
0208: ## 8. 品質条件
0209: 
0210: 保存した仕様と根拠から再開でき、版の食い違いと未確認事項を説明できる。
0211: 
0212: | 観点 | 要求または適用範囲 |
0213: | --- | --- |
0214: | 情報保護 | 外部送信は既存の許可範囲に従う。秘密の値を根拠文書へ転記しない。 |
0215: | 性能・規模 | 初期は小規模なMarkdown運用。応答時間の保証値は今回設定せず、対象実験の予算を守る。 |
0216: | 回復 | 候補の失敗で既存の有効版を消さず、操作IDと対象版から再開する。 |
0217: | 互換性 | v2の正本を変更せず、必要な枝からv3へ移す。旧成果物をv3監査済みと自動認定しない。 |
0218: 
0219: ## 9. 受入条件
0220: 
0221: | 条件ID | 観測できる成立状態 | owner |
0222: | --- | --- | --- |
0223: | G1 | 目標からシステムまでをたどれ、各仕様・契約の正本と現在版が一意に分かる。 | G-V3 |
0224: | G2 | 利用者が冒頭の説明から何が起きるか、なぜ必要か、今回判断することを説明し訂正できる。 | G-V3 |
0225: | G3 | 一つの実験に必要な枝で着手でき、実装・関連検証・実使用・採否・設計反映を通して次を選べる。 | G-V3 |
0226: | G4 | 監査済み範囲の小変更は関連テストで進め、期限または境界変化に応じて差分監査へ進む。 | G-V3 |
0227: | G5 | DDD由来の基準とAIDE運用上の基準を区別し、指摘を閉じる条件が一意に分かる。 | G-V3 |
0228: | G6 | 再開時、古い根拠・競合・取消・監査不合格を識別し、影響外の作業まで一律停止しない。 | G-V3 |
0229: 
0230: ## 10. 子への割り当て
0231: 
0232: | 子ID | 担当条件 | relation | 選択理由 |
0233: | --- | --- | --- | --- |
0234: | SG-MODEL | G1, G2 | all_of / selected | G1・G2の所有。記録の現在性とG6の競合回復を担当する。実験の実行と監査の判定は担当しない。 |
0235: | SG-LEARN | G3 | all_of / selected | G3の所有。G6の失敗・取消・結果の古さへの対応を担う。設計正本への書込み判定は記録側へ依頼する。 |
0236: | SG-ASSURE | G4, G5 | all_of / selected | G4・G5の所有。G6の重大欠陥・監査失効への対処を担う。仕様の起草と実験の実行を所有しない。 |
0237: 
0238: 親に残す統合責任: G6。記録・実験・監査の要求応答と失敗回復の全体整合。
0239: 
0240: 未割当の必須条件: なし。未説明の重複: なし。one_of/optional: 今回の採用枝には該当なし。有力な別方式はrationaleに残す。
0241: 
0242: ## 11. 未解決事項
0243: 
0244: 下位systemに具体化を委任する。ここで定めた目的・条件・公開契約は下位が暗黙に選び直さない。
0245: 
0246: 効率改善と人間の理解は実運用で未検証。検証担当は後続のv3試行担当であり、設計合格を効果実証として扱わない。
0247: 
0248: ## 12. 将来の検証対応
0249: 
0250: | ID種別 | 対応 |
0251: | --- | --- |
0252: | unit_test_id | 該当なし |
0253: | subgoal_integration_id | 該当なし |
0254: | final_integration_id | FIT-G-V3 |
0255: 
0256: 条件ID: G1, G2, G3, G4, G5, G6。ここでは対応IDと受入条件だけを定義し、テストケース・コードは生成しない。
0257: 
0258: ## 13. system 引渡し契約
0259: 
0260: 該当なし。配下systemの閉包へこの設計を含める。
</file>

<file path="docs/v3-design/root/rationale.md" sha256="ebb41288238e511e5220081f49edeecb124896f89630961f4176e0fb54ba2839">
0001: ---
0002: id: G-V3
0003: kind: root_goal
0004: title: 試して学び、意図と現在の状態を説明できる開発
...
0075: base_revision: 11
0076: validation:
0077:   structural:
0078:     result: pass
0079:     closure_id: CL-G-V3-d4-t20-29130abf5b62
0080:     checked_design_revision: 4
...
0105:   semantic:
0106:     result: pass
0107:     closure_id: CL-G-V3-d4-t20-29130abf5b62
0108:     checked_design_revision: 4
...
0153: ## 3. 代替案
0154: 
0155: 現行v2をそのまま利用する案は将来実装への引渡しで終わる。ドメインだけの木に置換する案は目的の追跡が弱くなるため不採用。
0156: 
0157: 選択済み: 目標の4階層を骨格として保持する。ドメインは責任と言葉の境界として重ねる。実験・反映・定期監査を同じ保存情報から再開する。
0158: 
0159: 再検討条件: 初回試行で文書更新負担が減らない、境界を跨ぐ修正が常態化する、意図や未確認事項を説明できない場合。
0160: 
0161: ## 4. 仮定
0162: 
0163: 入力のA1〜A5を継承する。初期はMarkdownと逐次反映で成立するという仮定で、外れたら並行実行・索引方式・監査周期を所有者の判断として改訂する。効率改善は推論であり計測結果ではない。
0164: 
0165: ## 5. 分解候補
0166: 
0167: ```yaml
0168: candidate_ref: G-V3-decomposition-2
0169: parent_id: G-V3
0170: parent_design_revision: 4
0171: next_kind: subgoal
0172: children:
0173: - id: SG-MODEL
0174:   relation: all_of
0175:   group: null
0176:   selected: true
0177:   responsibility: G1・G2の所有。記録の現在性とG6の競合回復を担当する。実験の実行と監査の判定は担当しない。
0178:   expected_outcome: 利用者と実装担当が、同じ保存情報から目的、現在の動作、制約、未確認事項を説明できる。
0179:   acceptance:
0180:   - G1
0181:   - G2
0182:   constraints:
...
0189:   - C-REVIEW
0190:   - C-PHASE
0191:   title: 意図と現在仕様を人が理解して訂正できる
0192:   provides_seams:
0193:   - S-CONTEXT
0194:   - S-AUDIT-INPUT
0195:   uses_seams:
0196:   - S-PROPOSAL
0197:   - S-AUDIT-RESULT
0198:   non_responsibilities:
0199:   - 実験実行の所有、監査結果の判定、利用者の許可範囲の拡大
0200: - id: SG-LEARN
0201:   relation: all_of
0202:   group: null
0203:   selected: true
0204:   responsibility: G3の所有。G6の失敗・取消・結果の古さへの対応を担う。設計正本への書込み判定は記録側へ依頼する。
0205:   expected_outcome: 利用者が全体設計の完成を待たず動く結果を試し、方法の採用・変更・終了を判断できる。
0206:   acceptance:
0207:   - G3
0208:   constraints:
0209:   - C-TRACE
...
0215:   - C-REVIEW
0216:   - C-PHASE
0217:   title: 最小の動作を試し、証拠で次の方法を選べる
0218:   provides_seams:
0219:   - S-PROPOSAL
0220:   uses_seams:
0221:   - S-CONTEXT
0222:   non_responsibilities:
0223:   - 設計正本への直接書込み、監査結果の判定、利用者の許可範囲の拡大
0224: - id: SG-ASSURE
0225:   relation: all_of
0226:   group: null
0227:   selected: true
0228:   responsibility: G4・G5の所有。G6の重大欠陥・監査失効への対処を担う。仕様の起草と実験の実行を所有しない。
0229:   expected_outcome: 利用者が小変更で毎回止まらず、変更の意味と監査の保証範囲を説明できる。
0230:   acceptance:
0231:   - G4
0232:   - G5
0233:   constraints:
...
0240:   - C-REVIEW
0241:   - C-PHASE
0242:   title: 必要な監査だけで意味と整合性を保てる
0243:   provides_seams:
0244:   - S-AUDIT-RESULT
0245:   uses_seams:
0246:   - S-AUDIT-INPUT
0247:   non_responsibilities:
0248:   - 設計正本への直接書込み、実験の実行、利用者の許可範囲の拡大
0249: parent_retains:
0250: - G6の全体整合
0251: seams:
0252: - id: S-CONTEXT
0253:   owner: G-V3
0254:   revision: 2
0255:   canonical_ref: design.md:owned_seams
0256: - id: S-PROPOSAL
0257:   owner: G-V3
0258:   revision: 2
0259:   canonical_ref: design.md:owned_seams
0260: - id: S-AUDIT-INPUT
0261:   owner: G-V3
0262:   revision: 2
0263:   canonical_ref: design.md:owned_seams
0264: - id: S-AUDIT-RESULT
0265:   owner: G-V3
0266:   revision: 2
0267:   canonical_ref: design.md:owned_seams
0268: unassigned_required_acceptance: []
0269: unexplained_overlap: []
0270: ```
0271: 
0272: ## 6. リスクと未解決事項
0273: 
0274: | ID | 内容 | owner | 扱い |
0275: | --- | --- | --- | --- |
0276: | R-G-V3 | 効率と理解の改善は未検証。規約を増やして逆に重くなる可能性。 | G-V3 | constrained: 後続試行で中断回数、最初の実物までの時間、手戻りと理解を評価する。 |
0277: | O-G-V3 | 実行ツール、初期試行の具体的製品、環境ごとの予算。 | 将来の実装・試行担当 | constrained: §11の委任範囲。設計の公開契約を暗黙に変更しない。 |
0278: 
0279: ## 7. finding
0280: 
0281: 現在の版の構造・意味検査で記録する。結果はこの節とfrontmatterのworkflow情報に置き、意味snapshotへ含めない。
0282: 
0283: ## 8. 検査結果
0284: 
0285: 構造検査と意味検査は `CL-G-V3-d4-t20-29130abf5b62` に対してpass。詳細: `checks/CL-G-V3-d4-t20-29130abf5b62-structural.md` と `checks/CL-G-V3-d4-t20-29130abf5b62-semantic.md`（設計ツリールート基準）。独立監査ではなく主担当の自己レビュー。
0286: 
0287: ## 9. 変更影響
0288: 
0289: 条件・責任・契約の変更はv2のchange eventにし、祖先統合、契約両端、条件継承先へ波及させる。意味のない表記変更で新しい意味版を発行しない。
0290: 
0291: EV-ASTRA-20260922-01による再設計。AV3-001〜003の公開契約を改訂し、親版・両端参照を伝播する。AV3-004の旧閉包は訂正検査で補い、歴史を上書きしない。v2実行規約は変更しない。
0292: 
0293: ## 10. 現在の作業状態
0294: 
0295: frontmatterのstatus、revision、validation、next_actionを参照する。公開前はpending、公開後は設計完了として扱う。
0296: 
0297: ## 11. 将来検証の根拠
0298: 
0299: | 対応 | 理由 |
0300: | --- | --- |
0301: | UT | 葉の単独責任を確認する予約ID。system以外はなし。 |
0302: | SIT | 小目標の条件が配下systemで成立することを確認する予約ID。 |
0303: | FIT | G1〜G6と契約の接続を全体として確認する予約ID。 |
0304: 
0305: ## 12. system closure の根拠
0306: 
0307: 該当なし。配下systemの目的チェーンへ含まれる。
</file>

<file path="docs/v3-design/root/subgoals/sg-assure/approaches/a-assure/design.md" sha256="4017d4e40de888bdb41767a4bcab1ba4ec528bbaaaf0006435d1b26ff1dfaa72">
0001: ---
0002: id: A-ASSURE
0003: kind: approach
...
0011: updated_at: '2026-09-22T20:55:15+09:00'
0012: children:
0013: - id: S-AUDIT
0014:   relation: all_of
0015:   group: null
...
<file path="docs/v3-design/root/subgoals/sg-assure/approaches/a-assure/rationale.md" sha256="c73d74a77dd75eec9198477faf772df295c61df3f262f5386c8806024dc8fd34">
0001: ---
0002: id: A-ASSURE
0003: kind: approach
0004: title: 監査基準版からの差分をDDDの観点で判定する
...
0040: base_revision: 12
0041: validation:
0042:   structural:
0043:     result: pass
0044:     closure_id: CL-A-ASSURE-d5-t38-d90cae846f29
0045:     checked_design_revision: 5
0046:     checked_parent_design_revision: 5
0047:     criteria:
0048:     - A-01
0049:     - A-02
0050:     - A-03
...
0070:   semantic:
0071:     result: pass
0072:     closure_id: CL-A-ASSURE-d5-t38-d90cae846f29
0073:     checked_design_revision: 5
0074:     checked_parent_design_revision: 5
0075:     criteria:
0076:     - A-01
0077:     - A-02
0078:     - A-03
...
0118: ## 3. 代替案
0119: 
0120: DDD完全準拠という一語を合格基準にする案は適用範囲が曖昧。全パターンの実装要求は小規模実験の目的に合わない。
0121: 
0122: 選択済み: 最後に監査した意味版と現在候補の差分から、言葉・責任・不変条件・接続の変化を判定する。全項目を形式的に埋めるより、適用理由と証拠を要求する。
0123: 
0124: 再検討条件: 初回試行で文書更新負担が減らない、境界を跨ぐ修正が常態化する、意図や未確認事項を説明できない場合。
0125: 
0126: ## 4. 仮定
0127: 
0128: 入力のA1〜A5を継承する。初期はMarkdownと逐次反映で成立するという仮定で、外れたら並行実行・索引方式・監査周期を所有者の判断として改訂する。効率改善は推論であり計測結果ではない。
0129: 
0130: ## 5. 分解候補
0131: 
0132: ```yaml
0133: candidate_ref: A-ASSURE-decomposition-2
0134: parent_id: A-ASSURE
0135: parent_design_revision: 5
0136: next_kind: system
0137: children:
0138: - id: S-AUDIT
0139:   relation: all_of
0140:   group: null
0141:   selected: true
0142:   responsibility: 監査方針、auditsの正本、指摘と基準版の判定を所有する。設計を書き換えず、S-AUDIT-RESULTで結果を返す。
0143:   expected_outcome: 候補を日常確認で進めるか監査へ回すかを説明し、監査の完了または必要な修正を版付きで返せる。
0144:   acceptance:
0145:   - AQ1
0146:   - AQ2
0147:   constraints:
...
0154:   - C-REVIEW
0155:   - C-PHASE
0156:   title: 変更の振り分けとDDD差分監査を管理する判定機構
0157:   provides_seams: []
0158:   uses_seams: []
0159:   non_responsibilities:
0160:   - 設計正本への直接書込み、実験の実行、利用者の許可範囲の拡大
0161: parent_retains:
0162: - 上位成果との統合確認
0163: seams: []
0164: unassigned_required_acceptance: []
0165: unexplained_overlap: []
0166: ```
0167: 
0168: ## 6. リスクと未解決事項
0169: 
0170: | ID | 内容 | owner | 扱い |
0171: | --- | --- | --- | --- |
0172: | R-A-ASSURE | 効率と理解の改善は未検証。規約を増やして逆に重くなる可能性。 | A-ASSURE | constrained: 後続試行で中断回数、最初の実物までの時間、手戻りと理解を評価する。 |
0173: | O-A-ASSURE | 実行ツール、初期試行の具体的製品、環境ごとの予算。 | 将来の実装・試行担当 | constrained: §11の委任範囲。設計の公開契約を暗黙に変更しない。 |
0174: 
0175: ## 7. finding
0176: 
0177: 現在の版の構造・意味検査で記録する。結果はこの節とfrontmatterのworkflow情報に置き、意味snapshotへ含めない。
0178: 
0179: ## 8. 検査結果
0180: 
0181: 構造検査と意味検査は `CL-A-ASSURE-d5-t38-d90cae846f29` に対してpass。詳細: `checks/CL-A-ASSURE-d5-t38-d90cae846f29-structural.md` と `checks/CL-A-ASSURE-d5-t38-d90cae846f29-semantic.md`（設計ツリールート基準）。独立監査ではなく主担当の自己レビュー。
0182: 
0183: ## 9. 変更影響
0184: 
0185: 条件・責任・契約の変更はv2のchange eventにし、祖先統合、契約両端、条件継承先へ波及させる。意味のない表記変更で新しい意味版を発行しない。
0186: 
0187: EV-ASTRA-20260922-01による再設計。AV3-001〜003の公開契約を改訂し、親版・両端参照を伝播する。AV3-004の旧閉包は訂正検査で補い、歴史を上書きしない。v2実行規約は変更しない。
0188: 
0189: ## 10. 現在の作業状態
0190: 
0191: frontmatterのstatus、revision、validation、next_actionを参照する。公開前はpending、公開後は設計完了として扱う。
0192: 
0193: ## 11. 将来検証の根拠
0194: 
0195: | 対応 | 理由 |
0196: | --- | --- |
0197: | UT | 葉の単独責任を確認する予約ID。system以外はなし。 |
0198: | SIT | 小目標の条件が配下systemで成立することを確認する予約ID。 |
0199: | FIT | G1〜G6と契約の接続を全体として確認する予約ID。 |
0200: 
0201: ## 12. system closure の根拠
0202: 
0203: 該当なし。配下systemの目的チェーンへ含まれる。
</file>

<file path="docs/v3-design/root/subgoals/sg-assure/approaches/a-assure/systems/s-audit/design.md" sha256="51dfbc25c5939b6106fedea8d16a0f1bf6d42ff2454258014a60ccb455c9d526">
0001: ---
0002: id: S-AUDIT
0003: kind: system
...
0009: design_revision: 4
0010: parent_revision: 5
0011: updated_at: '2026-09-22T20:55:21+09:00'
0012: children: []
0013: depends_on: []
0014: owned_seams: []
0015: seam_refs: []
...
0109: | 区分 | 契約 |
0110: | --- | --- |
0111: | 入力 | S-AUDIT-INPUTのplan/adoption/periodic/cancel要求。現在bundle、候補hash、最後のaudit、累積差分、委任、関連テスト・実使用結果、観測時刻。 |
0112: | 出力 | S-AUDIT-RESULT: daily-pass / require-review / audit-pass / blocked / stale / cancelled。理由、対象hash、指摘、次の処理、基準版と次回時期。 |
0113: | 状態 | requested → scoped → reviewing → passed / failed / cancelled / stale。日常確認はdaily-passとして記録し、監査基準版を更新しない。 |
0114: 
0115: ## 7. seam と依存
0116: 
0117: 祖先G-V3が所有するS-CONTEXT、S-PROPOSAL、S-AUDIT-INPUT、S-AUDIT-RESULTを継承する。直接の参加はseam_refsに示す。子孫は小目標の実行責務として契約を実現し、独自の契約を再定義しない。兄弟の内部実装へのdependencyはない。
0118: 
0119: ## 8. 品質条件
0120: 
0121: 監査者は候補を書き換えない。根拠と限界を示す。独立性が必要な意味監査は別のレビュー担当へ渡し、自己点検を独立監査と表示しない。
0122: 
0123: | 観点 | 要求または適用範囲 |
0124: | --- | --- |
0125: | 情報保護 | 外部送信は既存の許可範囲に従う。秘密の値を根拠文書へ転記しない。 |
0126: | 性能・規模 | 初期は小規模なMarkdown運用。応答時間の保証値は今回設定せず、対象実験の予算を守る。 |
0127: | 回復 | 候補の失敗で既存の有効版を消さず、操作IDと対象版から再開する。 |
0128: | 互換性 | v2の正本を変更せず、必要な枝からv3へ移す。旧成果物をv3監査済みと自動認定しない。 |
0129: 
0130: ## 9. 受入条件
0131: 
0132: | 条件ID | 観測できる成立状態 | owner |
0133: | --- | --- | --- |
0134: | SA1 | 初回・境界変更・期限到達・小変更を定義した順序で分類し、無監査のものを監査済みと表示しない。 | S-AUDIT |
0135: | SA2 | DDD-01〜05とAIDE-01〜03の適用可否、根拠、仕様・実装・証拠のsubject_hashを記録する。 | S-AUDIT |
0136: | SA3 | 重大指摘の反例・影響・解消条件と、minor・実験への委任を区別できる。 | S-AUDIT |
0137: | SA4 | 基準を増やすだけの再監査を避け、修正差分と波及先だけで指摘の解消を判定できる。 | S-AUDIT |
0138: | SA5 | 古い結果・取消済み候補・未知の影響・同一IDの異内容を検知し、影響範囲を示して返せる。 | S-AUDIT |
0139: 
0140: ## 10. 子への割り当て
0141: 
0142: 該当なし。systemはこの設計ツリーの葉。実装と検証は後続工程へ渡す。
0143: 
0144: ## 11. 未解決事項
0145: 
0146: プロジェクト担当は周期と予算を変更できる。DDD観点、重大度の意味、候補版固定、許可の尊重は保持する。担当モデルやツールは固定しない。
0147: 
0148: 効率改善と人間の理解は実運用で未検証。検証担当は後続のv3試行担当であり、設計合格を効果実証として扱わない。
0149: 
0150: ## 12. 将来の検証対応
0151: 
0152: | ID種別 | 対応 |
0153: | --- | --- |
0154: | unit_test_id | UT-S-AUDIT |
0155: | subgoal_integration_id | SIT-SG-ASSURE |
0156: | final_integration_id | FIT-G-V3 |
0157: 
0158: 条件ID: SA1, SA2, SA3, SA4, SA5。ここでは対応IDと受入条件だけを定義し、テストケース・コードは生成しない。
0159: 
0160: ## 13. system 引渡し契約
0161: 
0162: 目標チェーン: G-V3 → SG-ASSURE → A-ASSURE → S-AUDIT。
0163: 
0164: §4の責務、§5の手順、§6のI/O・状態、§7の根の契約、§8の品質、§9の条件、§11の委任、§12の3検証IDを引き渡す。主入力はimmutable system closure。実装着手に必要な製品境界の未決はない。選択可能な内部技術と、今後実測する効果は区別する。
</file>

<file path="docs/v3-design/root/subgoals/sg-assure/approaches/a-assure/systems/s-audit/rationale.md" sha256="69a3f0ff5ee304348b52aace519e3feb51d40aee0de955d5d333163adf80c811">
0001: ---
0002: id: S-AUDIT
0003: kind: system
0004: title: 変更の振り分けとDDD差分監査を管理する判定機構
...
0022: base_revision: 12
0023: validation:
0024:   structural:
0025:     result: pass
0026:     closure_id: CL-S-AUDIT-d4-t47-49843fea3a9a
0027:     checked_design_revision: 4
0028:     checked_parent_design_revision: 5
0029:     criteria:
0030:     - A-01
0031:     - A-02
0032:     - A-03
...
0052:   semantic:
0053:     result: pass
0054:     closure_id: CL-S-AUDIT-d4-t47-49843fea3a9a
0055:     checked_design_revision: 4
0056:     checked_parent_design_revision: 5
0057:     criteria:
0058:     - A-01
0059:     - A-02
0060:     - A-03
...
0100: ## 3. 代替案
0101: 
0102: AIの総合評価だけでpass/failを返す方式は再現性が弱い。基準IDと具体的な結果を返す方式を選ぶ。
0103: 
0104: 選択済み: 対象の意味と許可を照合し、即時監査、周期監査、日常確認の順で必要な確認を選ぶ。証拠付きの判定と完了条件を保存する。
0105: 
0106: 再検討条件: 初回試行で文書更新負担が減らない、境界を跨ぐ修正が常態化する、意図や未確認事項を説明できない場合。
0107: 
0108: ## 4. 仮定
0109: 
0110: 入力のA1〜A5を継承する。初期はMarkdownと逐次反映で成立するという仮定で、外れたら並行実行・索引方式・監査周期を所有者の判断として改訂する。効率改善は推論であり計測結果ではない。
0111: 
0112: ## 5. 分解候補
0113: 
0114: 該当なし。systemは葉。
...
0118: | ID | 内容 | owner | 扱い |
0119: | --- | --- | --- | --- |
0120: | R-S-AUDIT | 効率と理解の改善は未検証。規約を増やして逆に重くなる可能性。 | S-AUDIT | constrained: 後続試行で中断回数、最初の実物までの時間、手戻りと理解を評価する。 |
0121: | O-S-AUDIT | 実行ツール、初期試行の具体的製品、環境ごとの予算。 | 将来の実装・試行担当 | constrained: §11の委任範囲。設計の公開契約を暗黙に変更しない。 |
0122: 
0123: ## 7. finding
0124: 
0125: 現在の版の構造・意味検査で記録する。結果はこの節とfrontmatterのworkflow情報に置き、意味snapshotへ含めない。
0126: 
0127: ## 8. 検査結果
0128: 
0129: 構造検査と意味検査は `CL-S-AUDIT-d4-t47-49843fea3a9a` に対してpass。詳細: `checks/CL-S-AUDIT-d4-t47-49843fea3a9a-structural.md` と `checks/CL-S-AUDIT-d4-t47-49843fea3a9a-semantic.md`（設計ツリールート基準）。独立監査ではなく主担当の自己レビュー。
0130: 
0131: ## 9. 変更影響
0132: 
0133: 条件・責任・契約の変更はv2のchange eventにし、祖先統合、契約両端、条件継承先へ波及させる。意味のない表記変更で新しい意味版を発行しない。
0134: 
0135: EV-ASTRA-20260922-01による再設計。AV3-001〜003の公開契約を改訂し、親版・両端参照を伝播する。AV3-004の旧閉包は訂正検査で補い、歴史を上書きしない。v2実行規約は変更しない。
0136: 
0137: ## 10. 現在の作業状態
0138: 
0139: frontmatterのstatus、revision、validation、next_actionを参照する。公開前はpending、公開後は設計完了として扱う。
0140: 
0141: ## 11. 将来検証の根拠
0142: 
0143: | 対応 | 理由 |
0144: | --- | --- |
0145: | UT | 葉の単独責任を確認する予約ID。system以外はなし。 |
0146: | SIT | 小目標の条件が配下systemで成立することを確認する予約ID。 |
0147: | FIT | G1〜G6と契約の接続を全体として確認する予約ID。 |
0148: 
0149: ## 12. system closure の根拠
0150: 
0151: 祖先の目的・公開契約と対象systemの2文書だけで境界、状態、失敗、委任、受入条件が分かる。兄弟の内部設計を補わず引き渡せる。
</file>

<file path="docs/v3-design/root/subgoals/sg-assure/design.md" sha256="b187ae93bf37274601c04ad57e7ee26a16842e5c9a88a11cd5c54a643a35a6ae">
0001: ---
0002: id: SG-ASSURE
0003: kind: subgoal
...
0008: revision: 13
0009: design_revision: 5
0010: parent_revision: 4
0011: updated_at: '2026-09-22T20:55:08+09:00'
0012: children:
0013: - id: A-ASSURE
0014:   relation: all_of
0015:   group: null
...
<file path="docs/v3-design/root/subgoals/sg-assure/rationale.md" sha256="0d4b2896979704caf7b4a592de85dcae78ad24c5e5b7e0810bc83a14a4c67db2">
0001: ---
0002: id: SG-ASSURE
0003: kind: subgoal
0004: title: 必要な監査だけで意味と整合性を保てる
...
0049: base_revision: 12
0050: validation:
0051:   structural:
0052:     result: pass
0053:     closure_id: CL-SG-ASSURE-d5-t29-8778a28db93a
0054:     checked_design_revision: 5
0055:     checked_parent_design_revision: 4
0056:     criteria:
0057:     - A-01
0058:     - A-02
0059:     - A-03
...
0079:   semantic:
0080:     result: pass
0081:     closure_id: CL-SG-ASSURE-d5-t29-8778a28db93a
0082:     checked_design_revision: 5
0083:     checked_parent_design_revision: 4
0084:     criteria:
0085:     - A-01
0086:     - A-02
0087:     - A-03
...
0127: ## 3. 代替案
0128: 
0129: 毎回全体監査は更新負担が高い。固定時期だけの監査は境界変更を次回まで見逃すため、意味に基づく即時確認を併用する。
0130: 
0131: 選択済み: 日常確認、境界変更時の確認、定期差分監査を分け、DDD由来の基準と具体的な反例で判定する。
0132: 
0133: 再検討条件: 初回試行で文書更新負担が減らない、境界を跨ぐ修正が常態化する、意図や未確認事項を説明できない場合。
0134: 
0135: ## 4. 仮定
0136: 
0137: 入力のA1〜A5を継承する。初期はMarkdownと逐次反映で成立するという仮定で、外れたら並行実行・索引方式・監査周期を所有者の判断として改訂する。効率改善は推論であり計測結果ではない。
0138: 
0139: ## 5. 分解候補
0140: 
0141: ```yaml
0142: candidate_ref: SG-ASSURE-decomposition-2
0143: parent_id: SG-ASSURE
0144: parent_design_revision: 5
0145: next_kind: approach
0146: children:
0147: - id: A-ASSURE
0148:   relation: all_of
0149:   group: null
0150:   selected: true
0151:   responsibility: DDD原則の選定、日常確認との分担、監査の終了原理を所有する。具体的なレコードと判定順は配下systemへ渡す。
0152:   expected_outcome: 累積変更の意味に応じて監査時期と適用基準を選び、終了できる判定方法を定める。
0153:   acceptance:
0154:   - Q1
0155:   - Q2
0156:   - Q3
...
0164:   - C-REVIEW
0165:   - C-PHASE
0166:   title: 監査基準版からの差分をDDDの観点で判定する
0167:   provides_seams: []
0168:   uses_seams: []
0169:   non_responsibilities:
0170:   - 設計正本への直接書込み、実験の実行、利用者の許可範囲の拡大
0171: parent_retains:
0172: - 上位成果との統合確認
0173: seams: []
0174: unassigned_required_acceptance: []
0175: unexplained_overlap: []
0176: ```
0177: 
0178: ## 6. リスクと未解決事項
0179: 
0180: | ID | 内容 | owner | 扱い |
0181: | --- | --- | --- | --- |
0182: | R-SG-ASSURE | 効率と理解の改善は未検証。規約を増やして逆に重くなる可能性。 | SG-ASSURE | constrained: 後続試行で中断回数、最初の実物までの時間、手戻りと理解を評価する。 |
0183: | O-SG-ASSURE | 実行ツール、初期試行の具体的製品、環境ごとの予算。 | 将来の実装・試行担当 | constrained: §11の委任範囲。設計の公開契約を暗黙に変更しない。 |
0184: 
0185: ## 7. finding
0186: 
0187: 現在の版の構造・意味検査で記録する。結果はこの節とfrontmatterのworkflow情報に置き、意味snapshotへ含めない。
0188: 
0189: ## 8. 検査結果
0190: 
0191: 構造検査と意味検査は `CL-SG-ASSURE-d5-t29-8778a28db93a` に対してpass。詳細: `checks/CL-SG-ASSURE-d5-t29-8778a28db93a-structural.md` と `checks/CL-SG-ASSURE-d5-t29-8778a28db93a-semantic.md`（設計ツリールート基準）。独立監査ではなく主担当の自己レビュー。
0192: 
0193: ## 9. 変更影響
0194: 
0195: 条件・責任・契約の変更はv2のchange eventにし、祖先統合、契約両端、条件継承先へ波及させる。意味のない表記変更で新しい意味版を発行しない。
0196: 
0197: EV-ASTRA-20260922-01による再設計。AV3-001〜003の公開契約を改訂し、親版・両端参照を伝播する。AV3-004の旧閉包は訂正検査で補い、歴史を上書きしない。v2実行規約は変更しない。
0198: 
0199: ## 10. 現在の作業状態
0200: 
0201: frontmatterのstatus、revision、validation、next_actionを参照する。公開前はpending、公開後は設計完了として扱う。
0202: 
0203: ## 11. 将来検証の根拠
0204: 
0205: | 対応 | 理由 |
0206: | --- | --- |
0207: | UT | 葉の単独責任を確認する予約ID。system以外はなし。 |
0208: | SIT | 小目標の条件が配下systemで成立することを確認する予約ID。 |
0209: | FIT | G1〜G6と契約の接続を全体として確認する予約ID。 |
0210: 
0211: ## 12. system closure の根拠
0212: 
0213: 該当なし。配下systemの目的チェーンへ含まれる。
</file>

<file path="docs/v3-design/root/subgoals/sg-learn/approaches/a-learn/design.md" sha256="23d496c3b5f6c31d831ceb2b1c8177bc3a63a4db027246664f20cf69bc51ab17">
0001: ---
0002: id: A-LEARN
0003: kind: approach
...
0009: design_revision: 5
0010: parent_revision: 5
0011: updated_at: '2026-09-22T20:55:13+09:00'
0012: children:
0013: - id: S-CYCLE
0014:   relation: all_of
0015:   group: null
...
<file path="docs/v3-design/root/subgoals/sg-learn/approaches/a-learn/rationale.md" sha256="637509f03d4e52048f34e9a803beb0980682ed80e794afd06f2188c1b7ec523b">
0001: ---
0002: id: A-LEARN
0003: kind: approach
0004: title: 範囲を固定した実験と証拠付きの反映
...
0042:   structural:
0043:     result: pass
0044:     closure_id: CL-A-LEARN-d5-t35-79fa252445ec
0045:     checked_design_revision: 5
0046:     checked_parent_design_revision: 5
0047:     criteria:
0048:     - A-01
...
0070:   semantic:
0071:     result: pass
0072:     closure_id: CL-A-LEARN-d5-t35-79fa252445ec
0073:     checked_design_revision: 5
0074:     checked_parent_design_revision: 5
0075:     criteria:
0076:     - A-01
...
0118: ## 3. 代替案
0119: 
0120: 常に捨てる試作品と常に本実装へ直結する方式を比較し、成果と品質条件に応じて採用または破棄を選ぶ方式にする。
0121: 
0122: 選択済み: 実験計画・許可範囲・基準版・評価条件を固定し、候補を試す。採用時にだけ設計反映案を返し、失敗と不明も結果として残す。
0123: 
0124: 再検討条件: 初回試行で文書更新負担が減らない、境界を跨ぐ修正が常態化する、意図や未確認事項を説明できない場合。
0125: 
0126: ## 4. 仮定
...
0131: 
0132: ```yaml
0133: candidate_ref: A-LEARN-decomposition-2
0134: parent_id: A-LEARN
0135: parent_design_revision: 5
0136: next_kind: system
0137: children:
0138: - id: S-CYCLE
...
0140:   group: null
0141:   selected: true
0142:   responsibility: experimentsの正本と作業予算を所有する。設計bundleの反映はS-RECORD、監査の判定はS-AUDITへ渡す。
0143:   expected_outcome: 今回作る最小動作とその結果を保存し、再開・修正・採用・破棄を一意に進められる。
0144:   acceptance:
0145:   - AL1
0146:   - AL2
0147:   constraints:
...
0154:   - C-REVIEW
0155:   - C-PHASE
0156:   title: 実験計画・実行結果・採否を管理する学習機構
0157:   provides_seams: []
0158:   uses_seams: []
0159:   non_responsibilities:
0160:   - 設計正本への直接書込み、監査結果の判定、利用者の許可範囲の拡大
0161: parent_retains:
0162: - 上位成果との統合確認
0163: seams: []
0164: unassigned_required_acceptance: []
...
0170: | ID | 内容 | owner | 扱い |
0171: | --- | --- | --- | --- |
0172: | R-A-LEARN | 効率と理解の改善は未検証。規約を増やして逆に重くなる可能性。 | A-LEARN | constrained: 後続試行で中断回数、最初の実物までの時間、手戻りと理解を評価する。 |
0173: | O-A-LEARN | 実行ツール、初期試行の具体的製品、環境ごとの予算。 | 将来の実装・試行担当 | constrained: §11の委任範囲。設計の公開契約を暗黙に変更しない。 |
0174: 
0175: ## 7. finding
0176: 
0177: 現在の版の構造・意味検査で記録する。結果はこの節とfrontmatterのworkflow情報に置き、意味snapshotへ含めない。
...
0179: ## 8. 検査結果
0180: 
0181: 構造検査と意味検査は `CL-A-LEARN-d5-t35-79fa252445ec` に対してpass。詳細: `checks/CL-A-LEARN-d5-t35-79fa252445ec-structural.md` と `checks/CL-A-LEARN-d5-t35-79fa252445ec-semantic.md`（設計ツリールート基準）。独立監査ではなく主担当の自己レビュー。
0182: 
0183: ## 9. 変更影響
0184: 
0185: 条件・責任・契約の変更はv2のchange eventにし、祖先統合、契約両端、条件継承先へ波及させる。意味のない表記変更で新しい意味版を発行しない。
...
<file path="docs/v3-design/root/subgoals/sg-learn/approaches/a-learn/systems/s-cycle/design.md" sha256="c7c8442d59427c60971a27d40f603491b4c290ecb763e6d304fa76478d71e43f">
0001: ---
0002: id: S-CYCLE
0003: kind: system
...
0009: design_revision: 4
0010: parent_revision: 5
0011: updated_at: '2026-09-22T20:55:19+09:00'
0012: children: []
0013: depends_on: []
0014: owned_seams: []
0015: seam_refs: []
...
0095: | 区分 | 契約 |
0096: | --- | --- |
0097: | 入力 | ユーザーの目標・制約・委任、S-CONTEXTのbundleと進行判定、実装担当からの変更箇所・テスト・運用結果。 |
0098: | 出力 | 版付き実験計画、実装担当への作業範囲、結果と推奨、S-PROPOSALのplan/adoption/withdrawal/cycle_closed。 |
0099: | 状態 | planned → running → evaluated → proposed → reflected、または cancelled / inconclusive / rejected。pausedは予算や外部入力待ちで、再開条件を持つ。 |
0100: 
0101: ## 7. seam と依存
0102: 
...
0105: ## 8. 品質条件
0106: 
0107: 条件、版、費用、観測と解釈を分けて保存する。計測不能な費用は不明と記録し、上限が保証できない追加実行をしない。
0108: 
0109: | 観点 | 要求または適用範囲 |
0110: | --- | --- |
...
0119: | --- | --- | --- |
0120: | SC1 | 関係する枝だけの着手条件から試作可否を判定し、不足の理由を示せる。 | S-CYCLE |
0121: | SC2 | 実装担当へ範囲・対象版・期待動作・関連検証を渡し、結果の版が一致しない場合は採用しない。 | S-CYCLE |
0122: | SC3 | 改善・回帰・実使用未確認を区別し、採用・修正・不採用・保留を根拠付きで保存する。 | S-CYCLE |
0123: | SC4 | 予算到達、取消、失敗、再送、途中再開で勝手に追加実行せず、既存の許可範囲を維持する。 | S-CYCLE |
0124: | SC5 | 採用反映が競合・拒否された場合、実験結果を保持し、未反映であることを示す。 | S-CYCLE |
0125: 
0126: ## 10. 子への割り当て
0127: 
0128: 該当なし。systemはこの設計ツリーの葉。実装と検証は後続工程へ渡す。
0129: 
0130: ## 11. 未解決事項
0131: 
0132: 実装担当は言語、内部構造、測定手段を選べる。予算・委任・評価指標・外部契約の変更は委任範囲を再確認する。
0133: 
0134: 効率改善と人間の理解は実運用で未検証。検証担当は後続のv3試行担当であり、設計合格を効果実証として扱わない。
0135: 
0136: ## 12. 将来の検証対応
0137: 
0138: | ID種別 | 対応 |
0139: | --- | --- |
0140: | unit_test_id | UT-S-CYCLE |
0141: | subgoal_integration_id | SIT-SG-LEARN |
0142: | final_integration_id | FIT-G-V3 |
0143: 
0144: 条件ID: SC1, SC2, SC3, SC4, SC5。ここでは対応IDと受入条件だけを定義し、テストケース・コードは生成しない。
0145: 
0146: ## 13. system 引渡し契約
0147: 
0148: 目標チェーン: G-V3 → SG-LEARN → A-LEARN → S-CYCLE。
0149: 
0150: §4の責務、§5の手順、§6のI/O・状態、§7の根の契約、§8の品質、§9の条件、§11の委任、§12の3検証IDを引き渡す。主入力はimmutable system closure。実装着手に必要な製品境界の未決はない。選択可能な内部技術と、今後実測する効果は区別する。
</file>

<file path="docs/v3-design/root/subgoals/sg-learn/approaches/a-learn/systems/s-cycle/rationale.md" sha256="c26926afd2fa29b33fd984203c8a95f6032031e39f639dc76121cfb6fa3b6735">
0001: ---
0002: id: S-CYCLE
0003: kind: system
0004: title: 実験計画・実行結果・採否を管理する学習機構
...
0024:   structural:
0025:     result: pass
0026:     closure_id: CL-S-CYCLE-d4-t44-50f46ca77b3f
0027:     checked_design_revision: 4
0028:     checked_parent_design_revision: 5
0029:     criteria:
0030:     - A-01
...
0052:   semantic:
0053:     result: pass
0054:     closure_id: CL-S-CYCLE-d4-t44-50f46ca77b3f
0055:     checked_design_revision: 4
0056:     checked_parent_design_revision: 5
0057:     criteria:
0058:     - A-01
...
0100: ## 3. 代替案
0101: 
0102: 実験ごとに別の完成設計ツリーを作る案は記録負担が大きい。既存specを参照する一つの実験記録にする。
0103: 
0104: 選択済み: planを固定して実装担当へ渡し、結果を版付きで記録する。結果と受入条件を比較して採用案または終了理由を返す。
0105: 
0106: 再検討条件: 初回試行で文書更新負担が減らない、境界を跨ぐ修正が常態化する、意図や未確認事項を説明できない場合。
0107: 
0108: ## 4. 仮定
...
0118: | ID | 内容 | owner | 扱い |
0119: | --- | --- | --- | --- |
0120: | R-S-CYCLE | 効率と理解の改善は未検証。規約を増やして逆に重くなる可能性。 | S-CYCLE | constrained: 後続試行で中断回数、最初の実物までの時間、手戻りと理解を評価する。 |
0121: | O-S-CYCLE | 実行ツール、初期試行の具体的製品、環境ごとの予算。 | 将来の実装・試行担当 | constrained: §11の委任範囲。設計の公開契約を暗黙に変更しない。 |
0122: 
0123: ## 7. finding
0124: 
0125: 現在の版の構造・意味検査で記録する。結果はこの節とfrontmatterのworkflow情報に置き、意味snapshotへ含めない。
...
0127: ## 8. 検査結果
0128: 
0129: 構造検査と意味検査は `CL-S-CYCLE-d4-t44-50f46ca77b3f` に対してpass。詳細: `checks/CL-S-CYCLE-d4-t44-50f46ca77b3f-structural.md` と `checks/CL-S-CYCLE-d4-t44-50f46ca77b3f-semantic.md`（設計ツリールート基準）。独立監査ではなく主担当の自己レビュー。
0130: 
0131: ## 9. 変更影響
0132: 
0133: 条件・責任・契約の変更はv2のchange eventにし、祖先統合、契約両端、条件継承先へ波及させる。意味のない表記変更で新しい意味版を発行しない。
...
<file path="docs/v3-design/root/subgoals/sg-learn/design.md" sha256="9134463903c0f7a9ad0f59f81c6d79175e1b7e311b8906e479e165af51ca4029">
0001: ---
0002: id: SG-LEARN
0003: kind: subgoal
...
0009: design_revision: 5
0010: parent_revision: 4
0011: updated_at: '2026-09-22T20:55:06+09:00'
0012: children:
0013: - id: A-LEARN
0014:   relation: all_of
0015:   group: null
...
<file path="docs/v3-design/root/subgoals/sg-learn/rationale.md" sha256="369b4a15f0172bcff53509cb3c87ac6103ac907d80a5545739fa6dbeeb2b823e">
0001: ---
0002: id: SG-LEARN
0003: kind: subgoal
0004: title: 最小の動作を試し、証拠で次の方法を選べる
...
0051:   structural:
0052:     result: pass
0053:     closure_id: CL-SG-LEARN-d5-t26-a98c842af2a4
0054:     checked_design_revision: 5
0055:     checked_parent_design_revision: 4
0056:     criteria:
0057:     - A-01
...
0079:   semantic:
0080:     result: pass
0081:     closure_id: CL-SG-LEARN-d5-t26-a98c842af2a4
0082:     checked_design_revision: 5
0083:     checked_parent_design_revision: 4
0084:     criteria:
0085:     - A-01
...
0127: ## 3. 代替案
0128: 
0129: 全systemの設計完了後に実装する案は最初の検証が遅い。無制限に試す案は範囲と費用を守れない。
0130: 
0131: 選択済み: 一つの未確認事項を実験にし、予算内で実装・関連テスト・実使用を行う。結果と限界を根拠に採否を提案する。
0132: 
0133: 再検討条件: 初回試行で文書更新負担が減らない、境界を跨ぐ修正が常態化する、意図や未確認事項を説明できない場合。
0134: 
0135: ## 4. 仮定
...
0140: 
0141: ```yaml
0142: candidate_ref: SG-LEARN-decomposition-2
0143: parent_id: SG-LEARN
0144: parent_design_revision: 5
0145: next_kind: approach
0146: children:
0147: - id: A-LEARN
...
0149:   group: null
0150:   selected: true
0151:   responsibility: 試作着手の条件と学習ループの原理を所有する。コマンド実行方法と測定ツールは将来担当へ委任する。
0152:   expected_outcome: 未確認事項を検証可能な実験へ変え、得られた証拠を現在仕様へ取り込む方法を決める。
0153:   acceptance:
0154:   - L1
0155:   - L2
0156:   - L3
...
0164:   - C-REVIEW
0165:   - C-PHASE
0166:   title: 範囲を固定した実験と証拠付きの反映
0167:   provides_seams: []
0168:   uses_seams: []
0169:   non_responsibilities:
0170:   - 設計正本への直接書込み、監査結果の判定、利用者の許可範囲の拡大
0171: parent_retains:
0172: - 上位成果との統合確認
0173: seams: []
0174: unassigned_required_acceptance: []
...
0180: | ID | 内容 | owner | 扱い |
0181: | --- | --- | --- | --- |
0182: | R-SG-LEARN | 効率と理解の改善は未検証。規約を増やして逆に重くなる可能性。 | SG-LEARN | constrained: 後続試行で中断回数、最初の実物までの時間、手戻りと理解を評価する。 |
0183: | O-SG-LEARN | 実行ツール、初期試行の具体的製品、環境ごとの予算。 | 将来の実装・試行担当 | constrained: §11の委任範囲。設計の公開契約を暗黙に変更しない。 |
0184: 
0185: ## 7. finding
0186: 
0187: 現在の版の構造・意味検査で記録する。結果はこの節とfrontmatterのworkflow情報に置き、意味snapshotへ含めない。
...
0189: ## 8. 検査結果
0190: 
0191: 構造検査と意味検査は `CL-SG-LEARN-d5-t26-a98c842af2a4` に対してpass。詳細: `checks/CL-SG-LEARN-d5-t26-a98c842af2a4-structural.md` と `checks/CL-SG-LEARN-d5-t26-a98c842af2a4-semantic.md`（設計ツリールート基準）。独立監査ではなく主担当の自己レビュー。
0192: 
0193: ## 9. 変更影響
0194: 
0195: 条件・責任・契約の変更はv2のchange eventにし、祖先統合、契約両端、条件継承先へ波及させる。意味のない表記変更で新しい意味版を発行しない。
...
<file path="docs/v3-design/root/subgoals/sg-model/approaches/a-model/design.md" sha256="3de3580586f66caa379f2bc2cf6ab83f55f0e15e864ccd38ca6f317493ed10ae">
0001: ---
0002: id: A-MODEL
0003: kind: approach
...
0009: design_revision: 5
0010: parent_revision: 5
0011: updated_at: '2026-09-22T20:55:11+09:00'
0012: children:
0013: - id: S-RECORD
0014:   relation: all_of
0015:   group: null
...
<file path="docs/v3-design/root/subgoals/sg-model/approaches/a-model/rationale.md" sha256="10a324bbd775ecf3b5e3c3ba0dbd670718013e71623c8044382dadd9f97dd8fe">
0001: ---
0002: id: A-MODEL
0003: kind: approach
0004: title: 正本への参照と同じ文書内の段階的説明
...
0042:   structural:
0043:     result: pass
0044:     closure_id: CL-A-MODEL-d5-t32-802c638670d1
0045:     checked_design_revision: 5
0046:     checked_parent_design_revision: 5
0047:     criteria:
0048:     - A-01
...
0070:   semantic:
0071:     result: pass
0072:     closure_id: CL-A-MODEL-d5-t32-802c638670d1
0073:     checked_design_revision: 5
0074:     checked_parent_design_revision: 5
0075:     criteria:
0076:     - A-01
...
0118: ## 3. 代替案
0119: 
0120: 全てを木の中に複製する案と、4階層を捨てる案を比較し、重複と意図の喪失を避ける参照方式を選ぶ。
0121: 
0122: 選択済み: goal→approach→systemの参照とcontext_idを併存させる。説明と詳細仕様を同じdesign.mdの中に置き、根拠の長い比較だけをrationaleへ分離する。
0123: 
0124: 再検討条件: 初回試行で文書更新負担が減らない、境界を跨ぐ修正が常態化する、意図や未確認事項を説明できない場合。
0125: 
0126: ## 4. 仮定
...
0131: 
0132: ```yaml
0133: candidate_ref: A-MODEL-decomposition-2
0134: parent_id: A-MODEL
0135: parent_design_revision: 5
0136: next_kind: system
0137: children:
0138: - id: S-RECORD
...
0140:   group: null
0141:   selected: true
0142:   responsibility: 設計正本、関係索引、候補反映の書込みを所有する。実験結果の作成は学習側、監査結果の作成は監査側が所有する。
0143:   expected_outcome: 保存された設計、実験結果、監査結果から、現在の仕様とその根拠を矛盾なく読み出せる。
0144:   acceptance:
0145:   - AM1
0146:   - AM2
0147:   constraints:
...
0154:   - C-REVIEW
0155:   - C-PHASE
0156:   title: 現在仕様・参照・反映を管理する記録機構
0157:   provides_seams: []
0158:   uses_seams: []
0159:   non_responsibilities:
0160:   - 実験実行の所有、監査結果の判定、利用者の許可範囲の拡大
0161: parent_retains:
0162: - 上位成果との統合確認
0163: seams: []
0164: unassigned_required_acceptance: []
...
0170: | ID | 内容 | owner | 扱い |
0171: | --- | --- | --- | --- |
0172: | R-A-MODEL | 効率と理解の改善は未検証。規約を増やして逆に重くなる可能性。 | A-MODEL | constrained: 後続試行で中断回数、最初の実物までの時間、手戻りと理解を評価する。 |
0173: | O-A-MODEL | 実行ツール、初期試行の具体的製品、環境ごとの予算。 | 将来の実装・試行担当 | constrained: §11の委任範囲。設計の公開契約を暗黙に変更しない。 |
0174: 
0175: ## 7. finding
0176: 
0177: 現在の版の構造・意味検査で記録する。結果はこの節とfrontmatterのworkflow情報に置き、意味snapshotへ含めない。
...
0179: ## 8. 検査結果
0180: 
0181: 構造検査と意味検査は `CL-A-MODEL-d5-t32-802c638670d1` に対してpass。詳細: `checks/CL-A-MODEL-d5-t32-802c638670d1-structural.md` と `checks/CL-A-MODEL-d5-t32-802c638670d1-semantic.md`（設計ツリールート基準）。独立監査ではなく主担当の自己レビュー。
0182: 
0183: ## 9. 変更影響
0184: 
0185: 条件・責任・契約の変更はv2のchange eventにし、祖先統合、契約両端、条件継承先へ波及させる。意味のない表記変更で新しい意味版を発行しない。
...
<file path="docs/v3-design/root/subgoals/sg-model/approaches/a-model/systems/s-record/design.md" sha256="9cec4783950856ee6212891a9248be7caa36b762bdcc75cab8e8b91897f2d5bf">
0001: ---
0002: id: S-RECORD
0003: kind: system
...
0009: design_revision: 4
0010: parent_revision: 5
0011: updated_at: '2026-09-22T20:55:17+09:00'
0012: children: []
0013: depends_on: []
0014: owned_seams: []
0015: seam_refs: []
...
0112: | 区分 | 契約 |
0113: | --- | --- |
0114: | 入力 | S-CONTEXTの取得要求、S-PROPOSALの反映候補、S-AUDIT-RESULTの判定。base_revisionとoperation_idは必須。 |
0115: | 出力 | S-CONTEXTの設計bundle、S-AUDIT-INPUTの監査依頼、反映結果 applied / already-applied / conflict / rejected / cancelled。 |
0116: | 状態 | candidate → checked → committed、または conflict / rejected / cancelled。現在bundleは完全なcommitted一組だけを指す。 |
0117: 
0118: ## 7. seam と依存
0119: 
...
0122: ## 8. 品質条件
0123: 
0124: ローカルMarkdownと履歴で復元できる。外部送信を必要としない。未監査差分があることを隠さない。
0125: 
0126: | 観点 | 要求または適用範囲 |
0127: | --- | --- |
...
0136: | --- | --- | --- |
0137: | SR1 | systemの主親を一つに保ち、uses_systemsとcontext境界から参照・条件の所在を解決できる。 | S-RECORD |
0138: | SR2 | 文章の冒頭で主体・操作・結果・短い理由・制約・未決が分かり、詳細の条件と食い違わない。 | S-RECORD |
0139: | SR3 | 同じ操作の再送は重複反映せず、古いbase_revisionと部分書込みは現行仕様へ混入しない。 | S-RECORD |
0140: | SR4 | 仕様・実装・証拠のsubject_hashと異なる監査結果を採用せず、小変更後に未監査差分と基準版を読める。 | S-RECORD |
0141: | SR5 | 実験不採用・取消では設計を変更せず、採用時だけ関係する正本と根拠・参照を更新する。 | S-RECORD |
0142: 
0143: ## 10. 子への割り当て
0144: 
...
0147: ## 11. 未解決事項
0148: 
0149: 将来実装担当はJSON/YAMLの表現、索引の生成方法、履歴保存の方法を選べる。一括反映・不変snapshot・参照一意性の保証は変更しない。
0150: 
...
0155: | ID種別 | 対応 |
0156: | --- | --- |
0157: | unit_test_id | UT-S-RECORD |
0158: | subgoal_integration_id | SIT-SG-MODEL |
0159: | final_integration_id | FIT-G-V3 |
0160: 
0161: 条件ID: SR1, SR2, SR3, SR4, SR5。ここでは対応IDと受入条件だけを定義し、テストケース・コードは生成しない。
0162: 
0163: ## 13. system 引渡し契約
0164: 
0165: 目標チェーン: G-V3 → SG-MODEL → A-MODEL → S-RECORD。
0166: 
...
<file path="docs/v3-design/root/subgoals/sg-model/approaches/a-model/systems/s-record/rationale.md" sha256="79d45d4de5ea079e691e8ce2c0cd3a091912eae7f6dc46148bb9c23536503cfe">
0001: ---
0002: id: S-RECORD
0003: kind: system
0004: title: 現在仕様・参照・反映を管理する記録機構
...
0024:   structural:
0025:     result: pass
0026:     closure_id: CL-S-RECORD-d4-t41-f26915a13939
0027:     checked_design_revision: 4
0028:     checked_parent_design_revision: 5
0029:     criteria:
0030:     - A-01
...
0052:   semantic:
0053:     result: pass
0054:     closure_id: CL-S-RECORD-d4-t41-f26915a13939
0055:     checked_design_revision: 4
0056:     checked_parent_design_revision: 5
0057:     criteria:
0058:     - A-01
...
0100: ## 3. 代替案
0101: 
0102: 各担当がmasterと複数詳細へ直接追記する方式は部分反映を起こしやすい。初期版は反映担当一人の逐次運用とする。
0103: 
0104: 選択済み: 現在仕様を版付きbundleとして参照し、反映候補を検証して一括採用する。masterと詳細設計は相互参照で結ぶ。
0105: 
0106: 再検討条件: 初回試行で文書更新負担が減らない、境界を跨ぐ修正が常態化する、意図や未確認事項を説明できない場合。
0107: 
0108: ## 4. 仮定
...
0118: | ID | 内容 | owner | 扱い |
0119: | --- | --- | --- | --- |
0120: | R-S-RECORD | 効率と理解の改善は未検証。規約を増やして逆に重くなる可能性。 | S-RECORD | constrained: 後続試行で中断回数、最初の実物までの時間、手戻りと理解を評価する。 |
0121: | O-S-RECORD | 実行ツール、初期試行の具体的製品、環境ごとの予算。 | 将来の実装・試行担当 | constrained: §11の委任範囲。設計の公開契約を暗黙に変更しない。 |
0122: 
0123: ## 7. finding
0124: 
0125: 現在の版の構造・意味検査で記録する。結果はこの節とfrontmatterのworkflow情報に置き、意味snapshotへ含めない。
...
0127: ## 8. 検査結果
0128: 
0129: 構造検査と意味検査は `CL-S-RECORD-d4-t41-f26915a13939` に対してpass。詳細: `checks/CL-S-RECORD-d4-t41-f26915a13939-structural.md` と `checks/CL-S-RECORD-d4-t41-f26915a13939-semantic.md`（設計ツリールート基準）。独立監査ではなく主担当の自己レビュー。
0130: 
0131: ## 9. 変更影響
0132: 
0133: 条件・責任・契約の変更はv2のchange eventにし、祖先統合、契約両端、条件継承先へ波及させる。意味のない表記変更で新しい意味版を発行しない。
...
<file path="docs/v3-design/root/subgoals/sg-model/design.md" sha256="ac2d68f71beedda9aa915034a8350d0e730fc1eabe3b5ff3a69529231d9ca326">
0001: ---
0002: id: SG-MODEL
0003: kind: subgoal
...
0009: design_revision: 5
0010: parent_revision: 4
0011: updated_at: '2026-09-22T20:55:05+09:00'
0012: children:
0013: - id: A-MODEL
0014:   relation: all_of
0015:   group: null
...
<file path="docs/v3-design/root/subgoals/sg-model/rationale.md" sha256="92515f90ecb887241f5a6ec8a811d497d0a7a7e1900ba500732909c7d3abc18b">
0001: ---
0002: id: SG-MODEL
0003: kind: subgoal
0004: title: 意図と現在仕様を人が理解して訂正できる
...
0057: base_revision: 12
0058: validation:
0059:   structural:
0060:     result: pass
0061:     closure_id: CL-SG-MODEL-d5-t23-dca8e5ace808
0062:     checked_design_revision: 5
0063:     checked_parent_design_revision: 4
0064:     criteria:
0065:     - A-01
0066:     - A-02
0067:     - A-03
...
0087:   semantic:
0088:     result: pass
0089:     closure_id: CL-SG-MODEL-d5-t23-dca8e5ace808
0090:     checked_design_revision: 5
0091:     checked_parent_design_revision: 4
0092:     criteria:
0093:     - A-01
0094:     - A-02
0095:     - A-03
...
0135: ## 3. 代替案
0136: 
0137: 設計と人向け仕様を別の正本にする案は同期漏れを増やすため不採用。
0138: 
0139: 選択済み: 目標階層とドメイン関係を併記し、仕様は一つの正本に置く。冒頭で意味を説明し、詳細契約へ進める。
0140: 
0141: 再検討条件: 初回試行で文書更新負担が減らない、境界を跨ぐ修正が常態化する、意図や未確認事項を説明できない場合。
0142: 
0143: ## 4. 仮定
0144: 
0145: 入力のA1〜A5を継承する。初期はMarkdownと逐次反映で成立するという仮定で、外れたら並行実行・索引方式・監査周期を所有者の判断として改訂する。効率改善は推論であり計測結果ではない。
0146: 
0147: ## 5. 分解候補
0148: 
0149: ```yaml
0150: candidate_ref: SG-MODEL-decomposition-2
0151: parent_id: SG-MODEL
0152: parent_design_revision: 5
0153: next_kind: approach
0154: children:
0155: - id: A-MODEL
0156:   relation: all_of
0157:   group: null
0158:   selected: true
0159:   responsibility: 記録形式、参照方法、読み順を選ぶ。日常の状態更新は配下systemが具体化する。
0160:   expected_outcome: 一つの仕様を複製せず、目的と責任の二つの観点から読める表現を選ぶ。
0161:   acceptance:
0162:   - M1
0163:   - M2
0164:   - M3
...
0172:   - C-REVIEW
0173:   - C-PHASE
0174:   title: 正本への参照と同じ文書内の段階的説明
0175:   provides_seams: []
0176:   uses_seams: []
0177:   non_responsibilities:
0178:   - 実験実行の所有、監査結果の判定、利用者の許可範囲の拡大
0179: parent_retains:
0180: - 上位成果との統合確認
0181: seams: []
0182: unassigned_required_acceptance: []
0183: unexplained_overlap: []
0184: ```
0185: 
0186: ## 6. リスクと未解決事項
0187: 
0188: | ID | 内容 | owner | 扱い |
0189: | --- | --- | --- | --- |
0190: | R-SG-MODEL | 効率と理解の改善は未検証。規約を増やして逆に重くなる可能性。 | SG-MODEL | constrained: 後続試行で中断回数、最初の実物までの時間、手戻りと理解を評価する。 |
0191: | O-SG-MODEL | 実行ツール、初期試行の具体的製品、環境ごとの予算。 | 将来の実装・試行担当 | constrained: §11の委任範囲。設計の公開契約を暗黙に変更しない。 |
0192: 
0193: ## 7. finding
0194: 
0195: 現在の版の構造・意味検査で記録する。結果はこの節とfrontmatterのworkflow情報に置き、意味snapshotへ含めない。
0196: 
0197: ## 8. 検査結果
0198: 
0199: 構造検査と意味検査は `CL-SG-MODEL-d5-t23-dca8e5ace808` に対してpass。詳細: `checks/CL-SG-MODEL-d5-t23-dca8e5ace808-structural.md` と `checks/CL-SG-MODEL-d5-t23-dca8e5ace808-semantic.md`（設計ツリールート基準）。独立監査ではなく主担当の自己レビュー。
0200: 
0201: ## 9. 変更影響
0202: 
0203: 条件・責任・契約の変更はv2のchange eventにし、祖先統合、契約両端、条件継承先へ波及させる。意味のない表記変更で新しい意味版を発行しない。
0204: 
0205: EV-ASTRA-20260922-01による再設計。AV3-001〜003の公開契約を改訂し、親版・両端参照を伝播する。AV3-004の旧閉包は訂正検査で補い、歴史を上書きしない。v2実行規約は変更しない。
0206: 
0207: ## 10. 現在の作業状態
0208: 
0209: frontmatterのstatus、revision、validation、next_actionを参照する。公開前はpending、公開後は設計完了として扱う。
0210: 
0211: ## 11. 将来検証の根拠
0212: 
0213: | 対応 | 理由 |
0214: | --- | --- |
0215: | UT | 葉の単独責任を確認する予約ID。system以外はなし。 |
0216: | SIT | 小目標の条件が配下systemで成立することを確認する予約ID。 |
0217: | FIT | G1〜G6と契約の接続を全体として確認する予約ID。 |
0218: 
0219: ## 12. system closure の根拠
0220: 
0221: 該当なし。配下systemの目的チェーンへ含まれる。
</file>
...
<file path="docs/v3-design/tree-state.md" sha256="70f0752de0ee728f58b0324d8252a349f8739310fae2432535f852c80294c9ce">
0001: ---
0002: revision: 59
0003: tree_revision: 49
0004: root_id: G-V3
...
0008: closures:
0009: - manifest_id: CL-S-RECORD-d4-t49-c65a3a86187d
0010:   target: S-RECORD
0011:   status: current
0012:   handoff_id: HO-CL-S-RECORD-d4-t49-c65a3a86187d
0013: - manifest_id: CL-S-CYCLE-d4-t49-9d46a3ae144b
0014:   target: S-CYCLE
0015:   status: current
0016:   handoff_id: HO-CL-S-CYCLE-d4-t49-9d46a3ae144b
0017: - manifest_id: CL-S-AUDIT-d4-t49-9fc049759e19
0018:   target: S-AUDIT
0019:   status: current
0020:   handoff_id: HO-CL-S-AUDIT-d4-t49-9fc049759e19
0021: updated_at: '2026-09-22T20:55:21+09:00'
0022: ---
0023: 
0024: # v2によるv3設計の進行状態
0025: 
...
<file path="docs/v3-design/checks/independent-audit/astra-bundle-round-1/report.md" sha256="48a5a4a9b04a3dd476190b558378be33a21365f94525bbcfd1b6482cad8616d4">
0001: **判定: fail — open major 4件、blocker 0件。**
0002: 
0003: 4階層、責任分割、初回試作の入口、DDDの適用方針は目的に沿っています。ただし、監査対象の固定、周期監査への受渡し、取消の識別に外部契約の未確定部分があります。また、過去の3件のauthoring閉包では、seam参加側の照合を閉包だけから再現できません。
0004: 
0005: 実装・製品テスト・効果実証が未実施であること自体は指摘にしていません。
0006: 
0007: **監査対象と限界**
0008: 
0009: 次を添付本文から読み、直接照合しました。
0010: 
0011: - v2の `criteria/README.md`、`roles/review.md`、README、全ロール、両テンプレート、前例、書店例。
0012: - G-V3、SG-MODEL、A-MODEL、S-RECORD、SG-LEARN、A-LEARN、S-CYCLE、SG-ASSURE、A-ASSURE、S-AUDITの**全20文書**。
0013: - `tree-state.md`、全15 manifest、添付された全snapshot、5 handoff、構造・意味・公開記録、完了・最終照合記録、要求要約、3件のログ。
0014: - 正常、初回開始、失敗、取消、再送、再開、競合、周期監査の経路。
0015: 
0016: 読めなかったものは、未添付の `docs/harness-v2-design.md`、`docs/harness-v3-draft.md`、DDD原典、ログから参照される原会話・13kgame資料などです。これらについては添付された要約の範囲で扱いました。過去の独立監査結果は参照せず、READMEのpass表示も判定根拠にしていません。
0017: 
0018: ツール、別エージェント、ファイル編集、実装、テスト生成は使用していません。**SHA-256は提示値であり、再計算・機械的照合はしていません。** 以下の整合確認は、本文・識別子・参照・版の読取り照合です。
0019: 
0020: 以下のファイル表記は `docs/v3-design/` 基準です。
0021: 
0022: | 略称 | ファイル |
0023: | --- | --- |
0024: | G | `root/design.md` |
0025: | RECORD | `root/subgoals/sg-model/approaches/a-model/systems/s-record/design.md` |
0026: | CYCLE | `root/subgoals/sg-learn/approaches/a-learn/systems/s-cycle/design.md` |
0027: | AUDIT | `root/subgoals/sg-assure/approaches/a-assure/systems/s-audit/design.md` |
0028: 
0029: **確認できた整合性**
0030: 
0031: - 10ノードの文書対は、id・status・通常revision・design revision・parent revisionが一致します。全ノードの通常revisionは6、非葉の意味版は3、systemは2です。
0032: - 親、depth、配置は4階層と一致し、3systemは葉です。9エッジはすべてselectedなall_ofで、必須条件の割当とG6の根への留保を追えます。
0033: - 記録・学習・監査は異なる状態と判断を所有します。各枝のsubgoal、approach、systemにも成果・方式・外部動作という違いがあり、一子であることを欠陥とはしません。
0034: - 4本のseamはG-V3に正本があり、現在の3subgoalの参照はowner・revision 1・producer/consumerが一致します。systemへの実現責任の継承も明記されています。
0035: - 将来のv3におけるdomain/contextは横断軸であり、第5階層ではありません。`primary_approach_id` と `primary_parent` の保存上の統一もRECORD L83–84で説明されています。
0036: - planはcurrentを変更せず、初回は `base_bundle=null` で開始できます。adoptionだけがcurrentを切り替え、反映済み版の撤回は新しい変更として扱います。
0037: - DDDの観点とAIDE固有の頻度・停止規則が分かれています。集約等の適用条件、理由付きN/A、実装前後の確認範囲も定義されています。
0038: 
0039: tree revision 18の現在の引渡しは次の3件です。**tree-stateの通常revisionは22**です。
0040: 
0041: | system | current closure | manifest・handoffの識別整合 |
0042: | --- | --- | --- |
0043: | S-RECORD | `CL-S-RECORD-d2-t18-6e01a5cbdfd8` | 対象d2、親d3、tree 18、対応handoff一致 |
0044: | S-CYCLE | `CL-S-CYCLE-d2-t18-b7cdb3460c3b` | 同上 |
0045: | S-AUDIT | `CL-S-AUDIT-d2-t18-c95c7c0db2f3` | 同上 |
0046: 
0047: 各閉包には祖先・対象の8文書、4本のseam正本への参照、3参加側snapshot、要求要約、受入条件、UT/SIT/FITが揃っています。dependencies、active invalidations、staged childrenは空で、現在の文書との意味上の食い違いは見つけませんでした。ただし、収録された契約自体には以下の不足があります。
0048: 
0049: **AV3-001 — 監査結果が保証する実装・証拠の版を固定する契約が不足**
0050: 
0051: - **severity:** major／open
0052: - **v2基準:** D-01、D-03、E-01。意味レビュー2・5。
0053: - **場所:** G L82–99、L164–167／RECORD L83–95／CYCLE L67–68／AUDIT L94–108。
0054: - **証拠:** 実験結果は `implementation_ref` を持ちます。一方、監査要求・結果の適用判定は候補の意味hashを中心としており、そのhashに実装版・試行・証拠版を含める規則も、証拠参照を不変にする規則もありません。結果追記は通常revisionだけを進めるとされています。
0055: - **具体的な複数解釈:** 実装Aとその結果を監査した後、同じ実験記録へ実装Bの試行結果を追記する場合です。一方の実装担当は証拠参照を「監査時のAに固定された参照」、他方は「同じ実験ファイルの最新内容」と解釈できます。候補が保持する参照文字列と仕様の意味hashが同じなら、hash一致だけではこの違いを検出できません。
0056: - **影響:** 正しい実装版に対するテスト結果が存在しても、**その版を当該監査が確認したか**が確定しません。SR4、SA2・SA5、G6の保証が不足します。
0057: - **解消条件:** 監査対象が保証する仕様・実装・証拠の版集合を公開契約で固定すること。実装版や証拠版が変わった場合の結果再利用条件と未監査差分への扱いを定義してください。hashへの包含、不変参照などの技術方式は選択可能です。
0058: 
0059: **AV3-002 — 実験サイクル終了から周期監査への受渡しが閉じていない**
0060: 
0061: - **severity:** major／open
0062: - **v2基準:** D-01、D-03、E-01。意味レビュー2・3。
0063: - **場所:** G L74–99／CYCLE L71–94／RECORD L87–95／AUDIT L66–72、L106。
0064: - **証拠:** AUDITは「実験サイクル終了」を周期監査の起点とします。しかし、CYCLEの終了状態から誰がその事実を通知し、RECORDがいつperiodic要求を作るかが定義されていません。seamにもサイクル終了の通知・判定条件がありません。
0065: - **具体的な失敗例:** 小変更がdaily-passを得て反映され、CYCLEが `reflected` になった時点でサイクルが終了する場合です。反映前の分類はdaily-passで完了していますが、反映後にperiodic要求を発生させる規則がないため、別の担当は次の作業開始まで待つ実装にできます。採用なしで終了する場合にも同じ受渡しの不足があります。
0066: - **影響:** 「終了時」と「7暦日後の次の作業開始」の早い方という方針を一意に実現できません。G4、Q1、SA1に影響します。
0067: - **解消条件:** サイクルの終了条件、終了を記録するowner、周期確認を起動するowner、既存seamまたは公開参照による受渡しを定義すること。採用・不採用・取消の終了と、中断・再開を区別してください。新しいサービスや自動スケジューラは不要です。
0068: 
0069: **AV3-003 — 取消要求と取消対象のoperation識別が未確定**
0070: 
0071: - **severity:** major／open
0072: - **v2基準:** D-03、E-01。意味レビュー2・3・5。
0073: - **場所:** G L82–91、L165／RECORD L95、L109–111／CYCLE L93／AUDIT L96。
0074: - **証拠:** 共通規則は「同一operation_idの異内容再利用を拒否」です。S-PROPOSALは `kind=withdrawal` を持ち、S-AUDIT-INPUTはcancel通知で「同じ操作を終了」しますが、取消要求自身のIDと取消対象operationの対応が定義されていません。
0075: - **具体的な複数解釈:** adoption操作Oを取り消すとき、Oのままkindをwithdrawalへ変えると異内容再利用に該当します。別ID Wを発行する場合、WがOを取り消すことを示す項目・対象IDの意味が固定されていません。同じexperiment／plan revisionにplan確認とadoptionがある場合、どちらまで取り消すかも実装側の判断になります。
0076: - **影響:** 有効な取消が拒否される、別の操作まで取り消す、取消後に以前の進行判定が再送される場合の扱いが分かれます。SC4、SR3・SR5、SA5、G6に影響します。
0077: - **解消条件:** 取消要求の識別、対象operationとの関連、同一ID再利用規則との関係、取消後の旧要求・遅延結果の扱いを公開契約で固定すること。反映と取消の前後関係に応じた応答も定義してください。反映済み版を新変更で扱う既存方針は維持できます。
0078: 
0079: **AV3-004 — 3subgoalの過去authoring閉包にseam参加側入力が不足**
0080: 
0081: - **severity:** major／open
0082: - **v2基準:** D-03、意味レビュー6。補足規範: `harness-v2/README.md` L289–295。
0083: - **場所:**
0084:   - `closures/manifests/CL-SG-MODEL-d3-t4-25d6868dd8cc.md` L30–96
0085:   - `closures/manifests/CL-SG-LEARN-d3-t6-0710d62352da.md` L29–95
0086:   - `closures/manifests/CL-SG-ASSURE-d3-t8-36f75939e7a4.md` L30–96
0087:   - `checks/README.md` L43
0088: - **証拠:** 各manifestはroot・対象subgoal・staged approachの6文書を収録しています。他のseam参加subgoalのsnapshotも、これらを含むroot authoring closureへの明示的な参照もありません。root rationaleのsnapshotには分解候補のprovides/usesがありますが、参加ノード自身の保存済み `seam_refs` ではありません。
0089: - **具体的な失敗例:** SG-MODELの閉包だけを受け取った監査者は、G-V3正本のS-CONTEXTに対し、SG-LEARN側が同じowner・revision・consumer参照を持っていたかを確認できません。root authoring closureを別途探して読む必要がありますが、それは当該manifestが固定した入力ではありません。
0090: - **影響:** 当時の両端照合を、記録された同一immutable closureだけから再現できません。**現在のtree 18の3system閉包には参加側snapshotがあるため、この収録不足は解消されています。**
0091: - **解消条件:** 過去manifestは上書きせず、不足を明記した訂正検査記録を作ること。必要な参加側入力を固定した新しい検査単位と旧公開記録との関係を明示し、当時の照合について確認できる範囲を正確に記録してください。
0092: 
0093: **v2公開履歴の判断**
0094: 
0095: 10ノードとも、structuralとsemanticのclosure ID・対象意味版・親意味版は一致し、publicationも同じclosureを参照しています。公開のtree遷移は、根から非葉が `2→3、4→5、…、14→15`、systemが `15→16、16→17、17→18` で整合しています。
0096: 
0097: 後続の子の具体化によって、親の過去authoring snapshotが現在の子と異なることは正常です。旧handoffを残し、最終tree 18の別閉包をcurrentにする扱いにも矛盾はありません。公開後の意味変更を無検査で混入した証拠は見つかりませんでした。ただし、AV3-004により、3subgoalの公開前検査の閉包完全性までは認められません。通常revisionの直前照合が実際に行われたことは、添付された公開記録以上には検証していません。
0098: 
0099: **意味レビュー7観点**
0100: 
0101: | 観点 | 判断 |
0102: | --- | --- |
0103: | 1. 目的適合 | 分解と方針は適合。G4・G6を成立させる契約にはAV3-001〜003の不足。 |
0104: | 2. 十分性 | **fail**。正常・初回開始は読めるが、監査対象更新・周期起動・取消識別が未確定。 |
0105: | 3. 境界 | 状態と最終判断のownerは明確。外部受渡しの十分性は**fail**。 |
0106: | 4. 分解と選択 | **pass**。最小十分な3枝で、一子の各層にも異なる判断責任がある。 |
0107: | 5. 変更耐性 | 競合時の再計算、累積差分、v2変更伝播は定義済み。証拠版と取消の扱いにより**fail**。 |
0108: | 6. 閉包完全性 | 現在3閉包の収録構成は整合。過去3subgoalのauthoring閉包は**fail**。 |
0109: | 7. 将来検証への接続 | UT/SIT/FITと条件の追跡は**pass**。受入条件を実現できる設計の十分性には上記指摘が残る。 |
0110: 
0111: **3systemごとの最終判断**
0112: 
0113: | system | 判断 | 主な理由 |
0114: | --- | --- | --- |
0115: | S-RECORD | **fail** | 監査済み証拠の固定と取消対象の識別、周期要求の起動契約が不足。 |
0116: | S-CYCLE | **fail** | 実験結果の監査対象版への固定、サイクル終了通知、withdrawalの対応が不足。 |
0117: | S-AUDIT | **fail** | 実装・証拠に対する保証対象と、周期起動・取消の受渡しが未確定。 |
0118: 
0119: これは、**将来の実装担当へ追加の境界判断を要求せず引き渡せるか**の判定です。効率、理解しやすさ、監査回数の削減を実運用で達成済みという主張は、設計本文では適切に保留されています。
</file>
