...
構造検査と意味検査は `CL-A-ASSURE-d7-t69-29308d42e2d3` に対してpass。詳細: `checks/CL-A-ASSURE-d7-t69-29308d42e2d3-structural.md` と `checks/CL-A-ASSURE-d7-t69-29308d42e2d3-semantic.md`（設計ツリールート基準）。独立監査ではなく主担当の自己レビュー。
